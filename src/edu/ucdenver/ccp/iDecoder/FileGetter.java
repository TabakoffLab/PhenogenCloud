...
public class FileGetter extends HttpServlet {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File devPropertiesFile = new File("/usr/share/tomcat/webapps/PhenoGen/web/common/dbProperties/Dev.properties");
        Connection dbConn = myFileGetter.getConnection(devPropertiesFile);
        ObjectHandler myObjectHandler = new ObjectHandler();
        List<String[]> files = new ArrayList<String[]>();

        String mainDir = "/s3/iDecoder/InputFiles/";
        ...
        String phenogenFilename2 = mainDir + "PhenoGen/PhenoGen_MergedIDs_rn7.txt";
...
/*
	...
	files.add(new String[] {affyExonMain, mainDir + "Affymetrix/", "RaEx-1_0-st-v1.na31.rn4.probeset.csv.zip"});
*/
       /* files.add(new String[]{flybaseMain, mainDir + "FlyBase/", "fbgn_NAseq_Uniprot_fb_2022_01.tsv.gz"});
        files.add(new String[]{flybaseMain, mainDir + "FlyBase/", "gene_map_table_fb_2022_01.tsv.gz"});
        ...
        new PhenoGenIDs("36,95,99", phenogenFilename, dbConn).run();
        new PhenoGenIDs("194", phenogenFilename2, dbConn).run();
