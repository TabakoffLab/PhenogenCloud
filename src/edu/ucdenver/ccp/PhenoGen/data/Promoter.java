...
public class Promoter {
    ...
    public List<List<String[]>> getAllPromoterResultsForUser(int userID, DataSource pool) throws SQLException {
    ...
    public void deleteAllPromoterResultsForUser(int userID, DataSource pool) throws SQLException {
    ...
    public void deleteAllPromoterResultsForGeneList(int gene_list_id, DataSource pool) throws SQLException {
