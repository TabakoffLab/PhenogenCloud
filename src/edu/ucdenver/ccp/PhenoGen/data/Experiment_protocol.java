...
public class Experiment_protocol {
     ...
     */
    public Experiment_protocol[] getAllExperiment_protocols(DataSource pool) throws SQLException {
        ...
        Experiment_protocol[] myExperiment_protocols = new Experiment_protocol[0];
        try (Connection conn = pool.getConnection()) {
            Results myResults = new Results(query, conn);
            myExperiment_protocols = setupExperiment_protocolValues(myResults);
            myResults.close();
     ...
     * @return an array of Experiment_protocol objects
     */
    public Experiment_protocol[] getExperiment_protocolsForExperiment(int expID, DataSource pool) throws SQLException {
     ...
     * @return an array of Experiment_protocol objects
     */
    public Experiment_protocol[] getExperiment_protocolsByType(String expName, String protocolType, DataSource pool) throws SQLException {
     ...
     */
    public Experiment_protocol getExperiment_protocol(int exp_id, DataSource pool) throws SQLException {
        ...
        String query =
                "select " +
                        ...
                        "from experiment_protocols " +
                        "where exp_id = ?";
        Experiment_protocol myExperiment_protocol = null;
        try (Connection conn = pool.getConnection()) {
            Results myResults = new Results(query, exp_id, conn);
            myExperiment_protocol = setupExperiment_protocolValues(myResults)[0];
            myResults.close();
        } catch (SQLException e) {
            log.debug("SQL Exception:", e);
            throw e;
     ...
     * @throws SQLException
     */
    public Experiment_protocol[] getExperiment_protocolsByProtocolId(int protocol_id, DataSource pool) throws SQLException {
        String query =
                "select " +
                        "exp_id, protocol_id " +
                        "from Experiment_protocols " +
                        "where protocol_id = ?";
        Experiment_protocol[] experimentProtocols = new Experiment_protocol[0];
        try (Connection conn = pool.getConnection()) {
            Results myResults = new Results(query, protocol_id, conn);
            experimentProtocols = setupExperiment_protocolValues(myResults);
            myResults.close();
        } catch (SQLException e) {
            log.debug("SQL Exception:", e);
            throw e;
    ...
    /*public void createExperiment_protocol(User userLoggedIn, Hashtable<String, String> fieldValues,
                                          HashMap<String, String[]> multipleFieldValues, DataSource pool) throws SQLException {

        log.debug("in experiment_protocols create with fieldValues and multipleFieldValues");
        log.debug("fieldValues = ");
        myDebugger.print(fieldValues);
        log.debug("multipleFieldValues = ");
        myDebugger.print(multipleFieldValues);
     ...
     * @throws SQLException if an error occurs while accessing the database
     */
    public void createExperiment_protocol(DataSource pool) throws SQLException {
     ...
     * @throws SQLException if an error occurs while accessing the database
     */
    public void deleteExperiment_protocol(DataSource pool) throws SQLException {
     ...
     * @throws SQLException if an error occurs while accessing the database
     */
    public void deleteAllExperiment_protocolsForExperiment(int exp_id, DataSource pool) throws SQLException {
        ...
        try(Connection conn=pool.getConnection()){
            ...
            while ((dataRow = myResults.getNextRow()) != null) {
                new Experiment_protocol(Integer.parseInt(dataRow[0]), Integer.parseInt(dataRow[1])).deleteExperiment_protocol(pool);
            }
     ...
     * @throws SQLException if an error occurs while accessing the database
     */
    public void deleteAllExperiment_protocolsForProtocol(int protocol_id, DataSource pool) throws SQLException {
