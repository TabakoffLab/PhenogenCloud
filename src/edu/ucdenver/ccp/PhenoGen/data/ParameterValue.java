...
*/
     ...
     */
    public int copyMasterParameters(int dataset_id, int version, DataSource pool) throws SQLException {

        log.info("in copyMasterParameters");
        //
        // first create a new parameter group that is NOT a master
        //
        int parameter_group_id = createParameterGroup(dataset_id, version, 0, pool);
     ...
     * @throws SQLException if a database error occurs
     */
    public int copyParameters(int oldParameterGroupID, DataSource pool) throws SQLException {
        ...
        String query =
                "insert into parameter_groups " +
                        "(dataset_id, version, master, create_date) " +
                        "select  " +
        ...
        try(Connection conn=pool.getConnection()){
            ...
            pstmt.setInt(1, oldParameterGroupID);

            pstmt.executeUpdate();
            ResultSet rs = pstmt.getGeneratedKeys();
            if (rs.next()) {
                newParameterGroupID = rs.getInt(1);
            }
            pstmt.close();

            query =
                    "insert into parameter_values " +
                            "( parameter_group_id, category, parameter, value, create_date) " +
                            "select  " +
                            "?, category, parameter, value, create_date " +
                            "from parameter_values " +
                            "where parameter_group_id = ?";
     ...
     * @throws SQLException if a database error occurs
     */
    public void copyCorrelationParameters(int phenotypeParameterGroupID, int parameterGroupID, DataSource pool) throws SQLException {
     ...
     * @throws SQLException if a database error occurs
     */
    public int createParameterGroup(int dataset_id, int version, int master, DataSource pool) throws SQLException {
     ...
     * @throws SQLException if a database error occurs
     */
    public void deletePhenotypeValues(int parameterGroupID, DataSource pool) throws SQLException {

        deleteParameterValues(parameterGroupID, pool);
     ...
     * @throws SQLException if a database error occurs
     */
    public void deleteParameterValuesByCategory(int parameterGroupID, String category, DataSource pool) throws SQLException {
     ...
     * @throws SQLException if a database error occurs
     */
    public void deleteStatisticsParameterValues(int parameterGroupID, DataSource pool) throws SQLException {
     ...
     * @throws SQLException if a database error occurs
     */
    public void deleteMultipleTestParameterValues(int parameterGroupID, DataSource pool) throws SQLException {
     ...
     * @throws SQLException if a database error occurs
     */
    public void deleteParameterGroupsForDatasetVersion(Dataset.DatasetVersion thisVersion, DataSource pool) throws SQLException {
    ...
    public void createParameterValue(DataSource pool) throws SQLException {
        ...
        try(Connection conn=pool.getConnection()) {
            ...
            pstmt.setString(3, this.getParameter());
            pstmt.setString(4, this.getValue());
     ...
     * @throws SQLException if a database error occurs
     */
    public ParameterValue[] getAllClusterParameterGroups(int userID, int dataset_id, int datasetVersion, DataSource pool) throws SQLException {
     ...
     * @throws SQLException if a database error occurs
     */
    public ParameterValue[] getNormalizationParameters(int dataset_id, int version, DataSource pool) throws SQLException {
     ...
     * @throws SQLException if a database error occurs
     */
    public ParameterValue[] getParameterValuesForAllDatasetsForUser(int user_id, DataSource pool) throws SQLException {
     ...
     * @throws SQLException if a database error occurs
     */
    public Phenotype[] getPhenotypeValuesForGrouping(int userID, Dataset.DatasetVersion version, DataSource pool) throws SQLException {

        log.info("In getPhenotypeValuesForGrouping");

        Phenotype[] phenotypesForVersion = getPhenotypeValuesForDataset(userID, version.getDataset(), version.getGrouping_id(), pool);
     ...
     * @throws SQLException if a database error occurs
     */
    public Phenotype[] getPhenotypeValuesForDataset(int userID, Dataset ds, int groupingID, DataSource pool) throws SQLException {
     ...
     * @throws SQLException if a database error occurs
     */
    public String[] getPhenotypeNames(int userID, Dataset ds, int groupingID, DataSource pool) throws SQLException {

        //log.info("in getPhenotypeNames");
        Phenotype[] allPhenotypeValues = getPhenotypeValuesForDataset(userID, ds, groupingID, pool);
        //log.debug("allPhenotypeValues= "); new Debugger().print(allPhenotypeValues);
     ...
     * @throws SQLException if a database error occurs
     */
    public String getPhenotypeName(int parameterGroupID, DataSource pool) throws SQLException {

        log.debug("in getPhenotypeName");
        ParameterValue[] allPhenotypeValues = getParameterValues(parameterGroupID, pool);
        //log.debug("allPhenotypeValues= "); new Debugger().print(allPhenotypeValues);
     ...
     * @throws SQLException if a database error occurs
     */
    public boolean checkPhenotypeNameExists(String name, int userID, Dataset.DatasetVersion thisVersion, DataSource pool) throws SQLException {
