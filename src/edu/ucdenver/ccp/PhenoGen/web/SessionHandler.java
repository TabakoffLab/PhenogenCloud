...
public class SessionHandler {
    ...
    public String getMailPropertiesFile() {
        return this.getPropertiesDir() + "/" + mailPropertiesFile;
    }

    public void setMailPropertiesFile(String inString) {
        this.mailPropertiesFile = inString;
    }
...
*/
    ...
    public void setSessionVariables(HttpSession session, User userLoggedIn) {
        ...
        session.setAttribute("mailPropertiesFile", this.getMailPropertiesFile());
    ...
    public void createSessionActivity(SessionHandler mySessionHandler, DataSource pool) throws SQLException {
        ...
        try {
            ...
            pstmt.setString(1, mySessionHandler.getSession_id());
            myDbUtils.setToNullIfZero(pstmt, 2, mySessionHandler.getExp_id());
            myDbUtils.setToNullIfZero(pstmt, 3, mySessionHandler.getDataset_id());
            myDbUtils.setToNullIfZero(pstmt, 4, mySessionHandler.getVersion());
            myDbUtils.setToNullIfZero(pstmt, 5, mySessionHandler.getGene_list_id());
            pstmt.setString(6, mySessionHandler.getActivity_name().substring(0, Math.min(mySessionHandler.getActivity_name().length(), 1980)));
