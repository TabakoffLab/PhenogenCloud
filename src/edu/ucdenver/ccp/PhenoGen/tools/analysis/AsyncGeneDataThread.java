...
public class AsyncGeneDataThread extends Thread {
    ...
    public void run() throws RuntimeException {
        doneThread = false;
        pathReady = false;
        outputDir = gdt.getImageRegionData(chromosome, min, max, panel, myOrganism, genomeVer, rnaDatasetID, arrayTypeID, forwardPValueCutoff, true, dataVer);
        pathReady = true;
        //call full version for adding files later
        gdt.getRegionData(chromosome, fullMin, fullMax, panel, myOrganism, genomeVer, rnaDatasetID, arrayTypeID, forwardPValueCutoff, false, false, dataVer);
        doneThread = true;
    }
