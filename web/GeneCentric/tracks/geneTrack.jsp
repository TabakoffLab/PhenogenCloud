...
//String path=applicationRoot+contextRoot+"tmpData/regionData/"+organism+chr+"_"+start+"_"+stop+date+"/Region.xml";
    ...
    try {
        ...
        for (int i = 0; i < geneList.size(); i++) {
            ...
            genejson.put("html", "Ensembl ID:<a href=\"" + LinkGenerator.getEnsemblLinkEnsemblID(gene.getGeneID(), fullOrganism) + "\" target=\"_blank\">" + gene.getGeneID() + "</a><BR>Gene Symbol:" + gene.getGeneSymbol() + "<BR>Location: " + gene.getChromosome() + ":" + gene.getStart() + "-" + gene.getEnd() + "<BR>Strand:" + gene.getStrand() + "<BR>Transcripts:<BR>" + txList);
