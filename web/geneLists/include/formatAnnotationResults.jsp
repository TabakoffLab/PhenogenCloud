	...
	while (sortedIterator.hasNext()) {
		...
		<td> <!-- Commented out for ZZZ-369: Remove currently selected identifiers <strong><%=thisIdentifier.getCurrentIdentifier()%> </strong>
            ...
            <%if (officialSymbolList != null && officialSymbolList.size() > 0) {%>
            	<div class="smallSummary"><a href="/gene.jsp?geneTxt=<%=officialSymbolList.get(0)%>&speciesCB=<%=selectedGeneList.getOrganism()%>&auto=Y&newWindow=Y">Detailed Transcription Information</a></div>
            <%}%>
