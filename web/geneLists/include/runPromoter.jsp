...
<%
    ...
    Date tmpD = (new SimpleDateFormat("MMddyyyy_HHmmss")).parse(now);
    java.sql.Timestamp timeNow = new java.sql.Timestamp(tmpD.getTime());
    ...
    if (type.equals("Upstream")) {
        ...
        if (refseqSet == null) {
            ...
            log.debug("refseqSet from iDecoder = ");
            myDebugger.print(refseqSet);
