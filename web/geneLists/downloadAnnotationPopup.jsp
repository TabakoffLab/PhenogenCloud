...
<%
    ...
    if (userLoggedIn.getUser_name().equals("anon")) {
        ...
        File upDir = new File(fullFileName);
        if (!upDir.exists()) {
            upDir.mkdirs();
        }
        //fullFileName = fullFileName;
    }
    fullFileName = fullFileName + "/" + selectedGeneList.getGene_list_name_no_spaces() + "_AdvancedAnnotation.txt";
    ...
    <table class="list_base">
        ...
        <tr>
            ...
            <td>
                <table border="1" cellspacing="3" cellpadding="10">
                    <tr>
                        <th>Identifier</th>
                        <th>Affymetrix ID(s)</th>
                        <th>Ensembl ID(s)</th>
                    </tr>
                    <tr>
                        <td>NM_145512</td>
                        <td>106189_at///111682_at///1425026_at</td>
                        <td>ENSMU...///ENSMU...</td>
                    </tr>
                    <tr>
                        <td>NM_177129</td>
                        <td>107389_at///114733_at</td>
                        <td>ENSMU...///ENSMU...</td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td class="sideHeading">
                <input type="radio" name="fileFormat" value="separateRows">&nbsp;Each row is a single match and shows the exact target name
            </td>
            <td>
                <table border="1" cellspacing="3" cellpadding="10">
                    <tr>
                    ...
                    <tr>
                        <td>NM_145512</td>
                        <td>Affymetrix ID--Murine Genome U74Cv2 Array</td>
                        <td>106189_at</td>
                    </tr>
                    <tr>
                        <td>NM_145512</td>
                        <td>Affymetrix ID--Mouse Genome 430 2.0 Array</td>
                        <td>111682_at</td>
                    </tr>
                    <tr>
                        <td>NM_145512</td>
