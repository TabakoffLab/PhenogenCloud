...
<div style="text-align:center;overflow: auto;">
    ...
    <div id="circosOption">
        <div style="text-align: center;">
            ...
            <span class="eQTLtooltip"
                  title="eQTLs have been calculated for transcripts in each genome version.  For rat both rn5 and rn6 are supported.  Mouse only has mm10."><img
                    src="<%=imagesDir%>icons/info.gif"></span>
            <%
    ...
    The chromosome where the gene is physically located MUST be included in the Circos plot."><img src="<%=imagesDir%>icons/info.gif"></span>
            ...
            <tr>
                ...
                <td colspan="3" style="text-align:center;">
                    ...
                    <div style="float: right;display:inline-block"><a href="http://genome.cshlp.org/content/early/2009/06/15/gr.092759.109.abstract"
                                                                      target="_blank" style="text-decoration: none">Circos: an Information Aesthetic for
                        Comparative Genomics.</a></div>
                </td>
    ...
    <div id="forIframe"
         style="display:inline-block;text-align:center;/*position:relative;top:-37px;left:50px;*/width:90%;height:950px;max-height: 950px;border-style:solid; border-color:rgb(139,137,137); border-radius:15px; -moz-border-radius: 15px; border-width:1px; padding-bottom:75px;overflow: no-display;">
