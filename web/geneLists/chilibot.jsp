 ...
 *  Created: April, 2019
 *  Description:  Run and save Chilibot searches.
 *  Todo:
 *
--%>
...
<div id="container">
    <div id="toolsAccord" style="text-align:left;">
        <H2>Run New Chilibot Search on Gene List</H2>
    ...
    <div id="topResultData">
        ...
        <div id="goResult" style="width:100%;text-align: left;">
            <H2>Results</H2>
            Select previous results from the Chilibot Results section at the left or enter new parameters on the left or top to run a search.<BR />
        </div>
...
<script type="text/javascript">
    ...
    var goBrwsr=0;
    var idToDelete=-99;
    var analysisPath="include/runChilibot.jsp";
