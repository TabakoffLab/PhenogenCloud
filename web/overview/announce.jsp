...
<div style="overflow:auto;height:92%;margin-left: 10px;" class="announcement">
	<H2 style="font-weight: bold;font-size:20px;">HRDP v7.1 in Phenogen Browser</H2>
            <div style="margin-left:5px;">
                <span style="font-size: larger;">8/23/24 - v3.9.6 - Genome Transcriptome Browser has HRDP v7.1 data</span><BR>
