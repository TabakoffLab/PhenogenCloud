...
<div id="welcome" style="min-height:860px;">
    ...
    <div id="overview-wrap">
        <div id="overview-content-wide">
            ...
            <ul>
                <li>View a region of the mouse or rat genomes that includes information on array expression data and for rats transcripts expressed in brain
                    identified in PhenoGen RNA-Seq data:
                    <BR/>
                    Data Availalbe:<BR/>
                    <ul>
                        <li>
                            <div class="clicker" name="branch1">View an image of region &nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more">
                        </li>
                        ...
                        <li>
                            <div class="clicker" name="branch2">For Rat RNA-Seq transcripts from Brain are included<img src="<%=imagesDir%>icons/next.png"
                                                                                                                        alt="more">
                        </li>
                        ...
                        <li>
                            <div class="clicker" name="branch3">View Heritability and Detection Above Background across tissues availble for genes in the region&nbsp;&nbsp;&nbsp;<img
                                    src="<%=imagesDir%>icons/next.png" alt="more">
                        </li>
                        ...
                        <li>
                            <div class="clicker" name="branch4">View eQTLs for genes in the region&nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png"
                                                                                                                         alt="more">
                        </li>
                        ...
                        <li>
                            <div class="clicker" name="branch5">View bQTLs overlapping the region&nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png"
                                                                                                                        alt="more">
                        </li>
                        ...
                        <li>
                            <div class="clicker" name="branch6">View genes controlled from the region&nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png"
                                                                                                                            alt="more">
                        </li>
                        ...
                        <li>
                            <div class="clicker" name="branch7">View SNPs and short indels across the region&nbsp;&nbsp;&nbsp;<img
                                    src="<%=imagesDir%>icons/next.png" alt="more">
                        </li>
                ...
                <BR/>
                <li>Translate a region from Human/Mouse/Rat to Mouse/Rat and view the new regions(using UCSC liftOver)</li>
                <BR/>
                <li>When you select a specific gene you can view anything listed above as well as:<BR/>
                    Data Availabe:<BR/>
                    <ul>
                        <li>
                            <div class="clicker" name="branch20">View Parental Strain Differential Expression &nbsp;&nbsp;&nbsp;<img
                                    src="<%=imagesDir%>icons/next.png" alt="more">
                        </li>
                        ...
                        <li>
                            <div class="clicker" name="branch21">View Parental Strain(Rat) Transcriptome Reconstruction&nbsp;&nbsp;&nbsp;<img
                                    src="<%=imagesDir%>icons/next.png" alt="more">
                        </li>
                        ...
                        <li>
                            <div class="clicker" name="branch22">View Panel Heritability accross tissues&nbsp;&nbsp;&nbsp;<img
                                    src="<%=imagesDir%>icons/next.png" alt="more">
                        </li>
                        ...
                        <li>
                            <div class="clicker" name="branch23">View Panel Expression accross tissues&nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png"
                                                                                                                             alt="more">
                        </li>
                        ...
                        <li>
                            <div class="clicker" name="branch24">View Exon Correlation Tool&nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more">
                        </li>
                        ...
                        <li>
                            <div class="clicker" name="branch25">View eQTL information&nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more">
                        </li>
    ...
    <div class="demoVideo" style="display:inline-block;float:right;position:relative;top:-600px; padding-right:10px;">
        ...
        <video id="demoVid1" width="375" controls="controls" poster="/web/demo/BrowserNavDemo_350.png" preload="none">
            <source src="/web/demo/BrowserNavDemo.mp4" type="video/mp4">
            <source src="/web/demo/BrowserNavDemo.webm" type="video/webm">

            <object data="/web/demo/BrowserNavDemo.mp4" width="375">
            </object>
        </video>
        <BR/>
        <div id="showOpenLargeVideo" style="display:none;text-align:center; width:100%;"><a href="/web/demo/largerDemo.jsp?demoPath=web/demo/BrowserNavDemo"
                                                                                            class="button" style="width:180px;" target="_blank">View larger
            version</a></div>
        <span style="text-align:center;"><h3>New! Custom Track/View Demo</h3></span>
        <video id="demoVid1" width="375" controls="controls" poster="/web/demo/customTrackDemo_350.png" preload="none">
            <source src="/web/demo/customTrackDemo.mp4" type="video/mp4">
            <source src="/web/demo/customTrackDemo.webm" type="video/webm">

            <object data="/web/demo/customTrackDemo.mp4" width="375">
            </object>
        </video>
        <BR/>
        <div id="showOpenLargeVideo" style="display:none;text-align:center; width:100%;"><a href="/web/demo/largerDemo.jsp?demoPath=web/demo/customTrackDemo"
                                                                                            class="button" style="width:180px;" target="_blank">View larger
            version</a></div>
        ...
        <video id="demoVid" width="375" controls="controls" poster="/web/demo/detailed_transcript_fullv3_350.png" preload="none">
            ...
            <object data="/web/demo/detailed_transcript_fullv3.mp4" width="375">
            </object>
        </video>
        <BR/>
        <div id="showOpenLargeVideo" style="display:none;text-align:center; width:100%;"><a
                href="/web/demo/largerDemo.jsp?demoPath=web/demo/detailed_transcript_fullv3" class="button" style="width:180px;" target="_blank">View larger
            version</a></div>
