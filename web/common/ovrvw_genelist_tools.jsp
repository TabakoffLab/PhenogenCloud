...
<div id="welcome" style="min-height:575px; ">
    ...
    <div id="overview-wrap">
        <div id="overview-content">
            ...
            <ul>
                <li>
                    <div class="clicker" name="branch1"> View multiple sources of annotation
                ...
                <li>
                    <div class="clicker" name="branch2"> Perform a literature search
                        &nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more"></div>
                ...
                <li>
                    <div class="clicker" name="branch3"> Analyze promoter sequences
                        &nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more"></div>
                ...
                <li>
                    <div class="clicker" name="branch11"> Compare gene lists
                        &nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more"></div>
                ...
                <li>
                    <div class="clicker" name="branch4"> View the location of your genes
                        &nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more"></div>
