...
<div id="overview-content">
    ...
    <p class="indent">(2) PhenoGen Website [Internet]. Aurora (CO): University of Colorado Denver Anschutz Medical
        ...
        <p class="indent" style="font-size:large;"> Resource ID: <a href="https://scicrunch.org/scicrunch/Resources/record/nlx_144509-1/SCR_001613/resolver" target="_blank" >RRID:SCR_001613</a></p>
    <BR><BR>
    <H2>Other Tools available through PhenoGen:</H2>
        ...
        <p class="indent">
            ...
            Yuanbin Ru, Katerina J. Kechris, Boris Tabakoff, Paula Hoffman, Richard A. Radcliffe, Russell Bowler, Spencer Mahaffey, Simona Rossi, George A. Calin, Lynne Bemis, and Dan Theodorescu.  Nucleic Acids Research, 2014.<BR>
