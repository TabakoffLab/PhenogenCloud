    ...
    <div id="overview-wrap">
        <div id="overview-content">
            ...
            <ul>
                ...
                <li>
                    <div class="clicker" name="branch6"> Analyze our public expression data
                ...
                <li>
                    <div class="clicker" name="branch7"> Correlate your phenotype data (e.g. blood pressure) with our expression data
                        &nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more"></div>
                ...
                <li>
                    <div class="clicker" name="branch10"> View expression levels of your favorite gene(s)
                        &nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more"></div>
