  ...
  <div id="page_header">
    <div id="header_title"><a href="/">PhenoGen Informatics</a></div>
    ...
    <div id="header_link_container">
      ...
      <div class="header_nav">
          ...
          <%}else{%>
        		<a href="/web/common/startPage.jsp">Home</a> |
          <%}%>
          <a href="/gene.jsp">Gene Summary</a> |
       <%}else{%>
        	<a href="/web/common/startPage.jsp">Home</a> |
    ...
    if ( loggedIn ) {
		if (userLoggedIn !=null && !userLoggedIn.getUser_name().equals("anon")) {
			if (userLoggedIn !=null && !userLoggedIn.getUser_name().equals("guest")) { %>
        		<a href="/web/access/userUpdate.jsp">My Profile</a> |
			<% } %>
			<a href="/web/common/contact.jsp">Contact Us</a> |
        	<a href="/web/access/logout.jsp">Logout</a> |
      <%}%>
	<% }else{ %>
		<!--<a href="/web/common/startPage.jsp">Login</a> |-->
        <a href="#" class="login_btn"><span>Login</span><span class="triangle_down"></span></a> &nbsp; |
	<%}%>
    	
        <a href="/helpdocs/PhenoGen_Overview_CSH.htm#Overview.htm" target="_blank" class="site_help_link"><span>Site Help</span></a>
