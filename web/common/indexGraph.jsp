...
<table class="index" cellspacing="0" cellpadding="0">
    <tr>
        <TD id="imageColumn" class="wide">
                ...
                <div style="width:100%;color:#FFFFFF;margin-left:20px;">
                    ...
                    <ul style="color:#FFFFFF;">
                        ...
                        <UL class="sub" style="margin-left:40px;">
                            ...
                            <li><a href="web/overview/glValues.jsp">Expression Values</a></li>
                            ...
                            <li><a href="web/overview/glWGCNA.jsp">WGCNA</a></li>
                            <li><a href="web/overview/glGO.jsp">Gene Ontology</a></li>
                        ...
                        <UL class="sub" style="margin-left:40px;">
                            ...
                            <li><a href="web/overview/microPublic.jsp">Access Previously Analyzed Data</a></li>
                        </UL>
                        ...
                        <li>QTL Analysis</li>
                        <UL class="sub" style="margin-left:40px;">
                            <li><a href="web/overview/qtlViz.jsp">Visualize eQTLs - Arrays</a></li>
                            <li><a href="web/overview/qtlViz.jsp">Visualize eQTLs - RNA-Seq</a></li>
            ...
            <div id="svgAlternate1" class="svgAlternate" style="color:#FF0000; background-color:#FFFFFF;display:none;"><BR/>Your browser does not seem to
                support SVG(Scalable Vector Graphics). The list below will appear in a graphic when viewed with a browser supporting SVG, as all major current
                browsers support SVG (PhenoGen supports Chrome 25+, FireFox 23+, IE 10+, Safari 6+) please install a different browser or update this browser to
                be able to use PhenoGen. Some features will not work without SVG and more graphics will be migrating to SVG in the future. While it is unlikely,
                please let us know if you receive this message and have a browser that meets the minimum supported version or higher. <BR/><BR/></div>
            <div id="svgAlternate2" class="svgAlternate" style="display:none;">
                ...
                <ul>
                    ...
                    <UL class="sub">
                        ...
                        <li id="glValues">Expression Values</li>
                        ...
                        <li id="glWGCNA">WGCNA</li>
                        <li id="glGO">Gene Ontology</a></li>
                        <li id="glMultiMiR">multiMiR</a></li>
                    </UL>
                    <li>Microarray Data</li>
                    <UL class="sub">
                        ...
                        <li id="microPublic">Access Previously Analyzed Data</li>
                    </UL>
                    <li>Genome/Transcriptome Data Browser</li>
                    <UL class="sub">
                    ...
                    <li>QTL Analysis</li>
                    <UL class="sub">
                        <li id="qtlViz">Visualize eQTLs - Arrays</li>
                        <li id="qtlViz">Visualize eQTLs - RNA-Seq</li>
                    </UL>
                </ul>
            ...
            <div id="indexImage" style="background:#1F344F;">

            </div>

        </TD>
        <TD id="descColumn" class="narrow" style="background: #1F344F;">
            <div id="indexDesc"
                 style="height:90vh;width:32vw;display:none;border-color:#000000; border-style:solid; border-width:1px; background-color:#FFFFFF; color:#000000;">
                <span id="expandBTN" class="expandSect" style=" float:left; position:relative; top:9px; cursor:pointer;"><img
                        src="web/images/icons/expand_section.jpg"></span>
                <div id="indexDescContent" style="height:100%;width:100%;">
                </div>
    ...
    d3.json("top.json", function (error, graph) {
        ...
        node.each(function (d, i) {
            ...
            txt.append("tspan").text(lines2[0])
                .attr("x", function (d) {
                    var len = new String(lines2[0]).length;
                    var x = 0;
                    x = x - (len * charWidth / 2);
                    return x;
                })
            ...
            for (var i = 1; i < lines2.length; i++) {
                txt.append("tspan").text(lines2[i])
                    .attr("x", function (d) {
                        var len = new String(lines2[i]).length;
                        var x = 0;
                        x = x - (len * charWidth / 2);
                        return x;
                    })
                ...
                if (displayOverride == 1 || d3.select(this).style("opacity") == 1) {
                    if (displayOverride == 1 || d.id != curSelectedID) {
                        ...
                        boxLineTop.transition().delay(500).duration(250)
                            .attr("x1", tmpX + radius)
                            .attr("y1", tmpY)
                            .attr("x2", width).attr("y2", (height * 0.025)).style("stroke-width", 2);
                        boxLineBottom.transition().delay(500).duration(250)
                            .attr("x1", tmpX + radius).attr("y1", tmpY)
                            .attr("x2", width).attr("y2", height - (height * 0.025)).style("stroke-width", 2);
                        curSelectedID = d.id;
                        if (displayOverride !== 1) {
                            animationStop();
                        }
        ...
        if (displayClassStr != classStr) {
            ...
            if (displayClassStr != "") {
                ...
                d3.selectAll("line." + displayClassStr).transition().duration(350).style("stroke-width", 0)
                    .attr("x1", function (d) {
                        return graphData.nodes[d.source].x;
                    })
                    .attr("y1", function (d) {
                        return graphData.nodes[d.source].y;
                    })
                    .attr("x2", function (d) {
                        return graphData.nodes[d.target].x;
                    })
                    .attr("y2", function (d) {
                        return graphData.nodes[d.target].y;
                    });
