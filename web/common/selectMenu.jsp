...
<%
    ...
    if (url.startsWith("http")) {
        if (!url.equals("https://github.com/TabakoffLab/PhenogenCloud") && !url.equals("https://github.com/TabakoffLab/PhenoGenRESTAPI") && !url.equals("https://github.com/TabakoffLab/PhenoGenRESTR")) {
