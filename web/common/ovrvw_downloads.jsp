...
<div id="welcome" style="min-height:500px;">
    ...
    <div id="overview-wrap">
        <div id="overview-content">
            ...
            <ul>
                <li>
                    <div class="clicker" name="branch15"> Download expression data from our public data sets
                ...
                <li>
                    <div class="clicker" name="branch16"> Download expression quantitative trait loci information (eQTL) and expression heritability estimate
                        &nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more"></div>
                ...
                <li>
                    <div class="clicker" name="branch17"> Download recently generated RNA-Seq data
                        &nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more"></div>
            ...
            <BR/>
            <BR/>
            <a href="<%=accessDir%>createAnnonymousSession.jsp?url=<%=sysBioDir%>resources.jsp" class="button" style="margin: 0 0 0 40px; width:150px;">View
                Downloads</a>
