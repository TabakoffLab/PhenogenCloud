    ...
    <div id="overview-wrap">
        <div id="overview-content">
            ...
            <ul>
                ...
                <li>
                    <div class="clicker" name="branch8"> Find locations of transcription control (eQTL) for your candidate genes
                        &nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more"></div>
                ...
                <li>
                    <div class="clicker" name="branch9"> Identify candidate genes with an eQTL that overlaps your pQTL
                        &nbsp;&nbsp;&nbsp;<img src="<%=imagesDir%>icons/next.png" alt="more"></div>
