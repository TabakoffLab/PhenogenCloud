    ...
    <div id="emailPassworddiv">
        <form method="post"
            ...
            <table class="list_base">
                <TR>
                    <TD colspan="100%">
                        <div style="text-align:center;font-size:14px;color:#FF0000; font-weight:bold;"><%=errorMsg%>
                        </div>
                    </TD>
                </TR>
                <tr>
                ...
                <tr>
                    <td colspan="100%"><strong>OR</strong></td>
                </tr>
                <tr>
                    <td colspan="100%">&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="hidden" id="action" name="action" value="">
                        ...
                        <button class="g-recaptcha"
                                ...
                                data-action='SendPassword'>Send Password
                        </button>
