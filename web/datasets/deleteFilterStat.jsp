...
<div class="scrollable">
    ...
    <table class="list_base tablesorter" id="filterLists" cellpadding="0" cellspacing="3">
        ...
        <tr>
            <td><%= tmpFSteps[i].getStepNumber()%>
            </td>
            <td><%= tmpFSteps[i].getFilterName()%>
            </td>
            <td><%= tmpFSteps[i].getStepCount() %>
            </td>
        ...
        %>
        <tr>
            <td colspan="3">No Filtering Performed</td>
        </tr>
        <%}%>
        </tbody>
    </table>
    ...
    <table class="list_base" id="statLists" cellpadding="0" cellspacing="3">
        ...
        <tr>
            <td><%= tmpSSteps[i].getStepNumber()%>
            </td>
            <td><%= tmpSSteps[i].getStatsName()%>
            </td>
            <td><%= tmpSSteps[i].getStatsParameter()%>
            </td>
            <td><%= tmpSSteps[i].getStepCount() %>
            </td>
        ...
        %>
        <tr>
            <td colspan="4">No Statistics Performed</td>
        </tr>
        <%}%>
        </tbody>
    </table>
