                ...
                <div style="text-align:left;">
                    <table name="items" class="list_base" style="text-align:left; width:100%;">
                        ...
                        <TR id="<%=curDemo.getFileBase()+":::"+curDemo.getTitle()+" ("+curDemo.getTime()+")"+":::"+curDemo.getDescription()%>">
                            <TD class="<%if(curDemo==defaultVideo){%>selected<%}%>"><%=curDemo.getTitle()%>
                            </TD>
                            <TD class="<%if(curDemo==defaultVideo){%>selected<%}%>"><%=curDemo.getTime()%>
                            </TD>
                            <TD class="<%if(curDemo==defaultVideo){%>selected<%}%>"><%=curDemo.getDescription()%>
                            </TD>
                        </TR>
                        <%}%>
                    </table>
