...
var mmVer='Mouse(<span id="verSelect"></span>) Strain:C57BL/6J',rnVer='Rat(<span id="verSelect"></span>) HRDP version:<span id="hrdpSelect"></span> Strain:BN',siteVer="PhenoGen v3.9.1(2/1/2023)",trackBinCutoff=1E4,customTrackLevel=-1,mouseTTOver=0,ttHideHandle=0,tt=d3.select("body").append("div").attr("class","testToolTip").style("z-index",1001).style("opacity",0);
...
1,"");c.addTrackList(C)}else setTimeout(function(){c.addTrack(e,g,l,11)},5E3);else{z=E.documentElement.getElementsByTagName("Feature");console.log(z);try{C=SpliceJunctionTrack(c,z,e,F+"Splice Junctions",3,""),c.addTrackList(C)}catch(H){console.log(H)}}})}else if("polyASite"==e)d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/polyASite.xml",function(D,E){if(D)if(60>n){var z=1E3;1===n&&(z=2500);setTimeout(function(){c.addTrack(e,g,l,n+1)},z)}else d3.select("#Level"+
c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e);else if(null==E)if(4<=n){z=[];var C=PolyATrack(c,z,e,"Predicted PolyA Sites",l);c.addTrackList(C)}else setTimeout(function(){c.addTrack(e,g,l,4)},5E3);else{z=E.documentElement.getElementsByTagName("Feature");try{C=PolyATrack(c,z,e,"Predicted PolyA Sites",l),c.addTrackList(C)}catch(H){}}});
else if(0===e.indexOf("repeatMask"))$("#"+e+c.levelNumber+"Select").val(),w=c.xScale.domain()[0],A=c.xScale.domain()[1],q=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/"+e+".xml",d3.xml(q,function(D,E){if(D){console.log(D);if(0===n){var z="/"+pathPrefix;pathPrefix||(z="");$.ajax({url:z+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:w,maxCoord:A,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,
track:e,folder:c.folderName},dataType:"json",success:function(H){gtag("event","generateTrack"+e,{event_category:"browser"})},error:function(H,I,J){}})}60>n?(z=1500,1===n&&(z=2500),setTimeout(function(){c.addTrack(e,g,l,n+1)},z)):(d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==E)if(11<=n){z=[];var C=
RepeatMaskTrack(c,z,e,"Repeat Masker",g,l);c.addTrackList(C)}else setTimeout(function(){c.addTrack(e,g,l,11)},5E3);else{z=E.documentElement.getElementsByTagName("Feature");try{C=RepeatMaskTrack(c,z,e,"Repeat Masker",g,l),c.addTrackList(C)}catch(H){console.log(H)}}});else if(0==e.indexOf("custom"))if(q=trackInfo[e],l=l+",Name="+q.Name,l="DataFile="+q.Location+","+l,"bed"==q.Type||"bb"==q.Type)y=[],q=CustomTranscriptTrack(c,y,e,q.Name,3,l),c.addTrackList(q),q.updateFullData(0,0);else{if("bg"==q.Type||
...
new String(d3.select(this).attr("href"));e=e.substr(0,e.lastIndexOf("=")+1);e+=c.currentView.ViewID;d3.select(this).attr("href",e)})};c.changeTrackHeight=function(e,g){0<g?d3.select("#"+e+"Scroll").style("max-height",g+"px").style("overflow","auto"):d3.select("#"+e+"Scroll").style("max-height","none").style("overflow","hidden")};c.removeAllTracks=function(){d3.selectAll("li.draggable"+c.levelNumber).remove();c.trackList=[];setTimeout(function(){DisplayRegionReport()},300);gtag("event",c.levelNumber,
{event_category:"SVGremoveAllTracks"})};c.removeTrack=function(e){d3.select("#Level"+c.levelNumber+e).remove();for(var g=0;g<c.trackList.length;g++)"undefined"!==typeof c.trackList[g]&&c.trackList[g].trackClass==e&&(c.trackList.splice(g,1),c.trackCount--);c.trackListHash[e]=void 0;setTimeout(function(){DisplayRegionReport()},300);gtag("event",c.levelNumber,{event_category:"removeTrack",event_label:e})};c.redrawTrack=function(e){for(var g=0;g<c.trackList.length;g++)"undefined"!==typeof c.trackList[g]&&
c.trackList[g].trackClass==e&&c.trackList[g].redraw();setTimeout(function(){DisplayRegionReport()},300)};c.redraw=function(){for(var e=0;e<c.trackList.length;e++)"undefined"!==typeof c.trackList[e]&&"undefined"!==typeof c.trackList[e].redraw&&c.trackList[e].redraw();c.selectSvg.redraw()};c.update=function(){for(var e=0;e<c.trackList.length;e++)"undefined"!==typeof c.trackList[e].update&&c.trackList[e].update();setTimeout(function(){DisplayRegionReport()},300);gtag("event","genomeSVG.update",{event_category:"gsvgUpdate"})};
c.updateData=function(){for(var e=0;e<c.trackList.length;e++)"undefined"!==typeof c.trackList[e]&&"undefined"!==typeof c.trackList[e].updateData&&c.trackList[e].updateData(0);c.updateFullData();setTimeout(function(){DisplayRegionReport()},300);gtag("event","genomeSVG.updateData",{event_category:"gsvgUpdateData"})};c.updateFullData=function(){-1<(new String(c.folderName)).indexOf("img")&&(c.folderName="/"+chr+"/"+c.xScale.domain()[0]+"_"+c.xScale.domain()[1],0==c.levelNumber&&regionfolderName!=c.folderName&&
(regionfolderName=c.folderName),setTimeout(function(){DisplayRegionReport()},300));for(var e=0;e<c.trackList.length;e++)"undefined"!==typeof c.trackList[e]&&"undefined"!==typeof c.trackList[e].updateFullData&&c.trackList[e].updateFullData(0,1);gtag("event","genomeSVG.updateFullData",{event_category:"gsvgUpdateFullData"})};c.setLoading=function(){for(var e=0;e<c.trackList.length;e++)"undefined"===typeof c.trackList[e]||"undefined"===typeof c.trackList[e].updateData&&"undefined"===typeof c.trackList[e].updateFullData||
c.trackList[e].showLoading()};c.clearSelection=function(){c.selectionStart=-1;c.selectionEnd=-1;c.scaleSVG.selectAll("rect.selectedArea").remove();c.selectSvg.setVis(!1);for(var e=0;e<c.trackList.length;e++)"undefined"!==typeof c.trackList[e]&&"undefined"!==typeof c.trackList[e].clearSelection&&c.trackList[e].clearSelection()};c.mdown=function(){if(0==c.overSettings)if("dragzoom"!==c.defaultMouseFunct&&d3.event.altKey||"dragzoom"===c.defaultMouseFunct&&!d3.event.altKey){var e=d3.mouse(c.vis.node());
c.downZoomx=e[0];c.scaleSVG.append("rect").attr("class","zoomRect").attr("x",e[0]).attr("y",0).attr("height",c.scaleSVG.attr("height")).attr("width",1).attr("fill","#CECECE").attr("opacity",.3);c.scaleSVG.append("text").attr("id","zoomTextStart").attr("x",c.downZoomx).attr("y",15).text(numberWithCommas(Math.round(c.xScale.invert(c.downZoomx))));c.scaleSVG.append("text").attr("id","zoomTextEnd").attr("x",c.downZoomx).attr("y",50).text(numberWithCommas(Math.round(c.xScale.invert(c.downZoomx))))}else 0==
processAjax&&(c.prevMinCoord=c.xScale.domain()[0],c.prevMaxCoord=c.xScale.domain()[1],e=d3.mouse(c.vis.node()),c.downx=c.xScale.invert(e[0]),c.downscalex=c.xScale)};c.forceDrawAs=function(e){for(var g=0;g<c.trackList.length;g++)"undefined"!==typeof c.trackList[g]&&"undefined"!==typeof c.trackList[g].drawAs&&(c.trackList[g].drawAs=e,c.trackList[g].draw(c.trackList[g].data));c.forceDrawAsValue=e};c.resize=function(e){c.width=e;c.xScale.range([0,c.width]);c.xAxis=d3.axisTop(c.xScale).ticks(6).tickSize(8).tickPadding(10);
c.scaleSVG.attr("width",c.width);c.scaleSVG.select(".x.axis").call(c.xAxis);d3.select("#Level"+c.levelNumber).select(".axisLbl").attr("x",(c.width-2*c.margin)/2);c.topLevel.style("width",c.width+18+"px");for(var g=0;g<c.trackList.length;g++)"undefined"!==typeof c.trackList[g]&&"undefined"!==typeof c.trackList[g].redraw&&c.trackList[g].resize();c.selectSvg.width=e;c.selectSvg.draw()};c.updateCountScales=function(e,g){for(var l=0;l<c.trackList.length;l++)"undefined"!==typeof c.trackList[l]&&"undefined"!==
typeof c.trackList[l].updateCountScale&&c.trackList[l].updateCountScale(e,g)};c.resetDefaultMouse=function(e){var g="/web/images/icons/"+e+"_dark.png";d3.select("span#"+e+c.levelNumber+" img").attr("src",g);d3.select("span#"+e+c.levelNumber).style("background","#DCDCDC")};c.changeTrackCursor=function(e){for(var g=0;g<c.trackList.length;g++)"undefined"!==typeof c.trackList[g]&&"undefined"!==typeof c.trackList[g].svg&&c.trackList[g].svg.style("cursor",e)};c.changeScaleCursor=function(e){"undefined"!==
typeof c.scaleSVG&&c.scaleSVG.style("cursor",e)};c.updateTrackSelectedArea=function(e,g){c.selectionStart=e;c.selectionEnd=g;var l=c.xScale(e),n=c.xScale(g)-l;c.scaleSVG.selectAll("rect.selectedArea").remove();if((0<l||0<l+n)&&l<c.width)for(1>n&&(n=1),c.scaleSVG.append("rect").attr("class","selectedArea").attr("x",l).attr("y",15).attr("height",c.scaleSVG.attr("height")-15).attr("width",n).attr("fill","#CECECE").attr("opacity",.3).attr("pointer-events","none"),l=0;l<c.trackList.length;l++)"undefined"!==
typeof c.trackList[l]&&"undefined"!==typeof c.trackList[l].setSelectedArea&&c.trackList[l].setSelectedArea(e,g)};c.getAddMenus=function(){var e="/"+pathPrefix;""==pathPrefix&&(e="");$.ajax({url:e+"trackMenu.jsp",type:"GET",cache:!1,data:{level:c.levelNumber,organism:organism},dataType:"html",success:function(g){$("#trackMenu"+c.levelNumber).remove();d3.select("div#trackMenu").append("div").attr("id","trackMenu"+c.levelNumber);$("#trackMenu"+c.levelNumber).html(g)},error:function(g,l,n){$("#trackMenu"+
c.levelNumber).remove();d3.select("div#trackMenu").append("div").attr("id","trackMenu"+c.levelNumber);$("#trackMenu"+c.levelNumber).append('<div class="viewsLevel'+c.levelNumber+'">An error occurred generating this menu.  Please try back later.</div>')},async:!1});$.ajax({url:e+"viewMenu.jsp",type:"GET",cache:!1,data:{level:c.levelNumber,organism:organism},dataType:"html",success:function(g){$("#viewMenu"+c.levelNumber).remove();d3.select("div#viewMenu").append("div").attr("id","viewMenu"+c.levelNumber);
$("#viewMenu"+c.levelNumber).html(g)},error:function(g,l,n){$("#viewMenu"+c.levelNumber).remove();d3.select("div#viewMenu").append("div").attr("id","viewMenu"+c.levelNumber);$("#viewMenu"+c.levelNumber).append('<div class="viewsLevel'+c.levelNumber+'">An error occurred generating this menu.  Please try back later.</div>')},async:!1})};c.zoomMenuChange=function(e){d3.select("#zoomSelectMenu"+c.levelNumber).selectAll("li").style("background","#FFFFFF");c.zoomFactor=parseFloat(d3.select(e).attr("value"));
...
"blob";w.send();w.onreadystatechange=function(){if(4!=w.readyState||200!=w.status)return!1;var A=document.createElement("a");A.href=window.URL.createObjectURL(w.response);A.download=y;A.style.display="none";document.body.appendChild(A);try{A.click()}catch(B){$("#mouseHelp").html("<span style='color:#FF0000;'>Your browser will not save the image directly. Image will open in a popup, in the new window right click to save image.</span>"),window.open(v)}return!0};gtag("event","saveBrowserImage",{event_category:"browser"})},
error:function(n,q,t){console.log(t)}});gtag("event","",{event_category:"saveImage"})}).on("mouseover",function(){d3.select(this).attr("src","/web/images/icons/savePic_white.png");d3.select("span#savePic"+c.levelNumber).style("background","#DCDCDC");$("#mouseHelp").html("Click to download a PNG image of the current view.")}).on("mouseout",function(){d3.select(this).attr("src","/web/images/icons/savePic_dark.png");d3.select("span#savePic"+c.levelNumber).style("background","#989898");$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")});
...
d3.select("span#verSelect").append("select");if(c.allowSelectGenomeVer)if(e.on("change",function(){displayWorking();!0===isLocalStorage()?localStorage.setItem(organism+"DefGenomeVer",$(this).val()):$.cookie(organism+"DefGenomeVer",$(this).val());changeGenome($(this).val(),c.currentView);setTimeout(function(){$("form#geneCentricForm").submit()},1500)}),"Rn"===organism){console.log("running update org:");var g=e.append("option").attr("value","rn7").html("rn7");console.log("rn7 added");"rn7"===genomeVer&&
g.attr("selected","selected");g=e.append("option").attr("value","rn6").html("rn6");"rn6"===genomeVer&&g.attr("selected","selected");e=e.append("option").attr("value","rn5").html("rn5");"rn5"===genomeVer&&e.attr("selected","selected")}else"Mm"===organism&&(e=e.append("option").attr("value","mm10").html("mm10"),"mm10"===genomeVer&&e.attr("selected","selected"));else e.append("option").attr("value",genomeVer).html(genomeVer)}0<$("span#hrdpSelect").length&&(e=d3.select("span#hrdpSelect").append("select"),
e.on("change",function(){displayWorking();!0===isLocalStorage()?localStorage.setItem(organism+"DefHRDPVer",$(this).val()):$.cookie(organism+"DefHRDPVer",$(this).val());changeHRDPVer($(this).val(),c.currentView);setTimeout(function(){$("form#geneCentricForm").submit()},1500)}),"Rn"===organism?($("span#hrdpSelect").css("display","inline-block"),"rn7"===genomeVer?(g=e.append("option").attr("value","6").html("HRDPv6"),g.attr("selected","selected")):"rn6"===genomverVer&&e.append("option").attr("value",
"5").html("HRDPv5").attr("selected","selected")):"Mm"===organism&&$("span#hrdpSelect").css("display","none"))},500);c.addTrack("genomeSeq",3,"both",0);c.selectSvg=selectionSVG("#Level"+c.levelNumber,c.width,c.levelNumber,c);return c}
...
"mergedTotal"===b.trackClass?c=b.trackClass:"protein_coding"===a.getAttribute("biotype")&&200<=a.getAttribute("stop")-a.getAttribute("start")?c="protein":"protein_coding"!==a.getAttribute("biotype")&&200<=a.getAttribute("stop")-a.getAttribute("start")?c="long":200>a.getAttribute("stop")-a.getAttribute("start")&&(c="small");var h=0,e=0;if("protein"===c||"long"===c||0===c.indexOf("liverTotal")||"heartTotal"===c||0===c.indexOf("brainTotal")||"mergedTotal"===c||"kidneyTotal"===c||"small"===c&&"rn5"!==
genomeVer||"small"===c&&-1<(new String(a.getAttribute("ID"))).indexOf("ENS")){console.log("totalType");h=a.getAttribute("ID");var g="";if(a.getAttribute("geneSymbol")&&0<a.getAttribute("geneSymbol").length)h=h+" ("+a.getAttribute("geneSymbol")+")";else{e=getAllChildrenByName(getFirstChildByName(a,"TranscriptList"),"Transcript");for(var l=0;l<e.length&&""===g;l++)if(""===g)for(var n=getAllChildrenByName(getFirstChildByName(e[l],"annotationList"),"annotation"),q=0;q<n.length&&0===g.length;q++)if("AKA"===
n[q].getAttribute("source")){var t=n[q].getAttribute("annot_value");t=(new String(t)).split(":");1<=t.length?(g=t[0],h=h+" ("+g+")"):2<=t.length&&(g=t[0],t=t[1],h=h+" ("+t+")")}}e=parseInt(a.getAttribute("start"),10);n=parseInt(a.getAttribute("stop"),10);a.getAttribute("extStart")&&a.getAttribute("extStop")&&(e=parseInt(a.getAttribute("extStart"),10),n=parseInt(a.getAttribute("extStop"),10));svgViewIDList[d]||(svgViewIDList[d]=b.gsvg.currentView?b.gsvg.currentView.ViewID:defaultView);l=GenomeSVG("div#selectedImage",
b.gsvg.width,e,n,d,h,"transcript");l.xMin=e-.05*(n-e);l.xMax=n+.05*(n-e);h=l.xMin;e=l.xMax;svgList[d]=l;svgList[d].txType=c;svgList[d].selectedData=a;selectedGeneSymbol=a.getAttribute("geneSymbol");b.gsvg.selectedGeneSymbol=a.getAttribute("geneSymbol");selectedID=new String(a.getAttribute("ID"));-1===selectedID.indexOf("ENS")&&0<g.length&&(selectedID=g);$("div#selectedImage").show();console.log("here");-1<(new String(selectedID)).indexOf("ENS")&&-1<b.trackClass.indexOf("ensembl")?(console.log("geneReport"),
$("div#selectedReport").show(),d=pathPrefix+"geneReport.jsp",a={id:selectedID,geneSymbol:selectedGeneSymbol,chromosome:chr,species:organism,genomeVer:genomeVer},DisplaySelectedDetailReport(d,a)):"small"!==c?$("div#selectedReport").html("<BR><BR>Detailed Gene Reports are not currently provided for RNA-Seq(Cufflinks) generated genes that are novel and have not been matched to an existing annotated gene.  In the future overlapping probesets and SNPs will be summarized in the same manner.  This feature should be added by December 2014.  Please keep checking back or let us know you'd like to see it sooner."):
...
"#Level"+b.gsvg.levelNumber+b.trackClass));else{e=h.documentElement.getElementsByTagName("Snp");for(var g=[],l=[],n=0,q=0;q<e.length;q++)"undefined"!==typeof e[q]&&(g[n]=e[q],l[keySNP(e[q])]=1,n++);for(q=0;q<b.data.length;q++)"undefined"!==typeof b.data[q]&&"undefined"===typeof l[keySNP(b.data[q])]&&(g[n]=b.data[q],n++);b.draw(g);b.hideLoading()}})};b.getDisplayedData=function(){var d=d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).selectAll(".snp");b.counts=[{value:0,perc:0,names:"SNP"},{value:0,
perc:0,names:"Insertion"},{value:0,perc:0,names:"Deletion"}];var c=[],h=0,e=0;d.each(function(g){var l=b.xScale(g.getAttribute("start")),n=b.xScale(g.getAttribute("stop"));if(0<=l&&l<=b.gsvg.width||0<=n&&n<=b.gsvg.width)l=0,"Insertion"==g.getAttribute("type")?l++:"Deletion"==g.getAttribute("type")&&(l+=2),b.counts[l].value++,c[h]=g,h++,e++});return c};b.draw=function(d){b.data=d;b.trackYMax=0;b.yMaxArr=[];b.yArr=[];b.yArr[0]=[];for(var c=0;c<b.gsvg.width;c++)b.yMaxArr[c]=0,b.yArr[0][c]=0;c=b.strain;
...
b.drawLegend(d)};b.strain=p;b.redrawLegend();b.draw(m);return b}
...
c+5));d3.select(a).select("rect").style("fill",f.color(d))}}),f.svg.attr("height",15*f.yCount)):f.svg.attr("height",15);f.redrawSelectedArea()};f.draw(m);f.redraw();return f}
...
"<BR><BR>Zoom in further to see raw data(roughly a region <1000bp). The bin size will decrease as you zoom in thus the resolution of the count data will improve as you zoom in."}return d};b.update=function(a){a=b.xScale.domain()[0];var d=b.xScale.domain()[1];b.loadedDataMin<=a&&d<=b.loadedDataMax?b.redraw():(console.log("Update caused updateFullData()"+this.trackID),b.updateFullData(0,0))};b.updateFullData=function(a,d){var c=b.xScale.domain()[0],h=b.xScale.domain()[1],e=h-c;b.showLoading();if(0===
a||1==d)b.bin=b.calculateBin(e),console.log(b.trackClass+":bin size:"+b.bin);e="Total";2===b.countType&&(e="Norm");var g=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+b.gsvg.folderName+"/tmp/"+c+"_"+h+".count."+b.trackClass+"."+e+".xml";0<b.bin&&(c-=2*b.bin,c-=c%(2*b.bin),h+=2*b.bin,h+=2*b.bin-h%(2*b.bin),g=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+b.gsvg.folderName+"/tmp/"+c+"_"+h+".bincount."+b.bin+"."+b.trackClass+"."+e+".xml");console.log(b.trackClass+":file="+
g);console.log(b.trackClass+":folder="+b.gsvg.folderName);d3.xml(g,function(l,n){if(l){console.log("error:"+b.bin+":"+g);if(0==a||1==d){var q="/"+pathPrefix;pathPrefix||(q="");tmpPanel=panel;-1<b.trackClass.indexOf("-")&&(tmpPanel=b.trackClass.substr(b.trackClass.indexOf("-")+1));$.ajax({url:q+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:c,maxCoord:h,panel:tmpPanel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:b.trackClass,
folder:b.gsvg.folderName,binSize:b.bin,countType:b.countType},dataType:"json",success:function(t){gtag("event","generateTrackCount",{event_category:"browser"})},error:function(t,v,y){}})}8>a?b.fullDataTimeOutHandle=setTimeout(function(){b.updateFullData(a+1,0)},1E3):30>a?b.fullDataTimeOutHandle=setTimeout(function(){b.updateFullData(a+1,0)},2E3):38>a?b.fullDataTimeOutHandle=setTimeout(function(){b.updateFullData(a+1,0)},1E4):(d3.select("#Level"+b.levelNumber+b.trackClass).select("#trkLbl").text("An errror occurred loading Track:"+
b.trackClass),d3.select("#Level"+b.levelNumber+b.trackClass).attr("height",15),b.gsvg.addTrackErrorRemove(b.svg,"#Level"+b.gsvg.levelNumber+b.trackClass),b.hideLoading(),b.fullDataTimeOutHandle=setTimeout(function(){b.updateFullData(a+1,1)},15E3))}else console.log("update data"),null==n?(console.log("is null"),32<=a?(m=[],b.draw(m)):b.fullDataTimeOutHandle=setTimeout(function(){b.updateFullData(a+1,0)},5E3)):(console.log("not null is drawing"),b.fullDataTimeOutHandle=0,b.loadedDataMin=c,b.loadedDataMax=
h,setTimeout(function(){var t=n.documentElement.getElementsByTagName("Count");b.draw(t)},10))})};b.updateCountScale=function(a,d){b.scaleMin=a;b.scaleMax=d;b.colorScale=d3.scaleLinear().domain([b.scaleMin,b.scaleMax]).range(["#EEEEEE","#000000"]);1==b.density&&(b.redrawLegend(),b.redraw())};b.setupToolTipSVG=function(a,d){var c=b.xScale.domain()[0],h=b.xScale.domain()[1],e=parseInt(a.getAttribute("start"),10),g=parseInt(a.getAttribute("stop"),10);h=Math.floor((h-c)*d);20>h&&(h=20);c=e-h;h=g+h;1>c&&
(c=1);"undefined"!==typeof b.ttSVGMinWidth&&h-c<b.ttSVGMinWidth&&(c=e-b.ttSVGMinWidth/2,h=g+b.ttSVGMinWidth/2);e=toolTipSVG("div#ttSVG",450,c,h,99,a.getAttribute("ID"),"transcript");e.addTrack(b.trackClass,3,"",b.data);for(g=0;g<b.ttTrackList.length;g++){var l=b.gsvg.getTrackData(b.ttTrackList[g]),n=[];if("undefined"!==typeof l&&0<l.length){for(var q=0,t=0;t<l.length;t++)if(c<=parseInt(l[t].getAttribute("start"),10)&&parseInt(l[t].getAttribute("start"),10)<=h||parseInt(l[t].getAttribute("start"),
10)<=c&&parseInt(l[t].getAttribute("stop"),10)>=c)n[q]=l[t],q++;0<n.length&&e.addTrack(b.ttTrackList[g],3,"DrawTrx",n)}}};b.draw=function(a){b.hideLoading();b.data=a;console.log("draw:"+b.trackClass+":"+a.length);var d=b.gsvg.xScale.domain()[0],c=b.gsvg.xScale.domain()[1];b.xScale(d+b.bin);b.xScale(d);b.redrawLegend();for(var h=[],e=0,g=0,l=0;l<b.data.length;l++)if("undefined"!==typeof b.data[l]){var n=parseInt(b.data[l].getAttribute("start"),10),q=parseInt(b.data[l].getAttribute("stop"),10),t=parseInt(b.data[l].getAttribute("count"),
10);if(1!=b.density||1==b.density&&n!=q)if(l+1<b.data.length){if(q=parseInt(a[l+1].getAttribute("start"),10),n>=d&&n<=c||q>=d&&q<=c)h[e]=b.data[l],t>g&&(g=t),e++}else n>=d&&n<=c&&(h[e]=b.data[l],t>g&&(g=t),e++)}console.log("newData:"+h.length);ndata=h;console.log("data:"+ndata.length);b.svg.select(".y.axis").remove();b.svg.select("g.grid").remove();b.svg.selectAll(".leftLbl").remove();b.svg.select(".area").remove();b.svg.selectAll(".area").remove();1==b.density?(console.log("draw:den1"),c=b.gsvg.xScale.domain()[1],
b.svg.selectAll("."+b.trackClass).data(ndata,keyStart).enter().append("rect").attr("x",function(v){console.log("x:"+v.getAttribute("start")+":"+b.xScale(v.getAttribute("start")));return b.xScale(v.getAttribute("start"))}).attr("y",15).attr("class",b.trackClass).attr("height",10).attr("width",function(v,y){return b.xScale(v.getAttribute("stop"))-b.xScale(v.getAttribute("start"))}).attr("fill",b.color).on("mouseover",function(v){0==b.gsvg.isToolTip&&(d3.select(this).style("fill","green"),tt.transition().duration(200).style("opacity",
1),tt.html(b.createToolTip(v)).style("left",function(){return b.positionTTLeft(d3.event.pageX)}).style("top",function(){return b.positionTTTop(d3.event.pageY)}),1==b.ttSVG&&b.setupToolTipSVG(v,.005))}).on("mouseout",function(v){d3.select(this).style("fill",b.color);tt.transition().delay(500).duration(200).style("opacity",0)}),b.svg.attr("height",30)):2==b.density&&(console.log("draw:den2"),b.yScale.domain([0,g]),b.yAxis=d3.axisLeft(b.yScale).ticks(5),b.svg.select("g.grid").remove(),b.svg.select(".y.axis").remove(),
...
g=h[0].substr(5),l="";3<h.length&&0==h[3].indexOf("Default=")&&(l=h[3].substr(8));if(0==h[1].toLowerCase().indexOf("select")){e.append("text").text(g+": ");var n=h[1].split(":");h=h[2].split("}");g=b.trackClass+"Dense"+b.level+"Select";"colorSelect"==n[1]?g=b.trackClass+b.level+"colorSelect":"countSelect"==n[1]&&(g=b.trackClass+b.level+"countSelect");e=e.append("select").attr("id",g).attr("name",n[1]);for(n=0;n<h.length;n++){var q=h[n].substr(1).split(":");if(2==q.length){var t=e.append("option").attr("value",
q[1]).text(q[0]);-1<g.indexOf("Dense")?q[1]==b.density&&t.attr("selected","selected"):q[1]==l&&t.attr("selected","selected")}}d3.select("select#"+g).on("change",function(){$(this).attr("id")==b.trackClass+"Dense"+b.level+"Select"&&1==$(this).val()?$("#scaleControl"+b.level).show():$("#scaleControl"+b.level).hide();b.updateSettingsFromUI();b.redraw()})}else 0==h[1].toLowerCase().indexOf("slider")&&(l="none",1==b.density&&(l="inline-block"),e=e.append("div").attr("id","scaleControl"+b.level).style("display",
l),e.append("text").text(g+": "),e.append("input").attr("type","text").attr("id","amount").attr("value",b.scaleMin+"-"+b.scaleMax).style("border",0).style("color","#f6931f").style("font-weight","bold").style("background-color","#EEEEEE"),n=h[1].split(":"),h=h[2].split("}"),e=e.append("div"),e.append("text").text("Min:"),e.append("div").attr("id","min-"+n[1]).style("width","60%").style("display","inline-block").style("float","right"),e.append("br"),e.append("text").text("Max:"),e.append("div").attr("id",
...
contextRoot+'web/images/icons/help.png"> above for a detailed description of each view.').style("margin-left","5px").append("img").attr("src","/web/images/icons/info.gif");that.viewBar.append("br");that.viewBar.append("input").attr("type","radio").attr("id","wgcnaEQTLViewRB").attr("name","wgcnaViewRB").attr("value","eqtl").style("margin-left","7px").style("margin-right","3px").attr("disabled",function(){return"rn7"===genomeVer?!0:!1}).on("click",function(){that.viewType="eqtl";that.createSingleWGCNAImage();
gtag("event","eQTLView",{event_category:"WGCNA"})});that.viewBar.append("text").text("Eigengene eQTL");that.viewBar.append("span").attr("class","wgcnaControltooltip").attr("title",'View Circos plot of the module Eigengene eQTLs.<BR><BR>Have a question about this view click the <img src="'+contextRoot+'web/images/icons/help.png"> above for a detailed description of each view.').style("margin-left","5px").append("img").attr("src","/web/images/icons/info.gif");that.viewBar.append("br");that.viewBar.append("input").attr("type",
"radio").attr("id","wgcnaGOViewRB").attr("name","wgcnaViewRB").attr("value","go").style("margin-left","7px").style("margin-right","3px").attr("disabled",function(){return 10<that.wDSID?!0:!1}).on("click",function(){that.viewType="go";that.createSingleWGCNAImage();gtag("event","goView",{event_category:"WGCNA"})});that.viewBar.append("text").text("Gene Ontology");that.viewBar.append("span").attr("class","wgcnaControltooltip").attr("title",'TEMPORARILY DISABLED PLEASE CHECK BACK. View a summary of Gene Ontology terms assigned to transcripts in the selected module.<BR><BR>Have a question about this view click the <img src="'+
...
d3.select("div#tableExportCtl").append("span").attr("class","button").style("margin-right","10px").on("click",function(){$("#eqtlTable").tableExport({type:"csv",escape:"false"})}).html("Export CSV");$.ajax({url:contextRoot+"tmpData/browserCache/"+genomeVer+"/modules/ds"+that.wDSID+"/"+replaceUnderscore(that.selectedModule.MOD_NAME)+".eQTL.json",type:"GET",async:!0,data:{},dataType:"json",beforeSend:function(){$("div#waitEqtlTable").show()},success:function(a){setTimeout(function(){$.fn.DataTable.isDataTable("table#eqtlTable")&&
$("table#eqtlTable").DataTable().destroy();for(var d=[],c=1*$("#eqtlPval").val(),h="",e=0,g=0;g<a.length;g++)a[g].Pval>=c&&(a[g].Pval>e&&(h=a[g].Snp,e=a[g].Pval),d.push(a[g]));d3.select("#eqtlTable").select("tbody").selectAll("tr").remove();d3.select("#eqtlTable").select("tbody").selectAll("tr").data(d,that.eQTLKey).enter().append("tr").attr("id",function(l){return"tblLink_"+l.Snp}).attr("class",function(l,n){var q="odd";0===n%2&&(q="even");return q}).each(function(l,n){var q=l.Start/1E6;d3.select(this).append("td").html(l.Chr);
d3.select(this).append("td").html(q.toFixed(1));d3.select(this).append("td").html(l.Snp);d3.select(this).append("td").html(l.Pval.toFixed(2))});$("#eqtlTable").DataTable({bPaginate:!1,aaSorting:[[3,"desc"]],sDom:"fiB<t>",buttons:["copy","excel","pdf"]});$("div#waitEqtlTable").hide();d3.select("#circosModule").select("g#Link_"+h).select("path").style("stroke","#FFF450")},20)},error:function(a,d,c){}})};that.singleWGCNAImageMetaView=function(){var a=that.singleWGCNAImage();$(".goCTL").hide();$(".eqtlCtls").hide();
$(".linkCTL").show();$(".mirCTL").hide();a.CorCutoff_min=.01;a.CorCutoff_max=1;a.type=that.viewType;a.truncated=0;a.filterOneDB=1;a.mirGeneCutoff=1;a.mirValid=0;a.mirTargetID="";a.mirID="";a.miRcolor=d3.scaleOrdinal(d3.schemeCategory20b);a.sortMir=0;a.maxCorWidth=5;a.mlinkKey=function(d){return that.removeInvalidIDChars(d.MOD1)+"_"+that.removeInvalidIDChars(d.MOD2)};a.colorCircle=function(d){return d.COLOR};a.colorLink=function(d){var c=a.negColor;0<d.COR&&(c=a.posColor);return c};a.colorLinkHighlight=
function(d){var c=a.negDarkColor;0<d.COR&&(c=a.posDarkColor);return c};a.drawLinks=function(d){a.updateColor("linkColor");a.svg.selectAll(".link").remove();for(var c=a.metaData.LINKS,h=[],e=0,g=0;g<c.length;g++)(c[g].MOD1===d.MODULE||c[g].MOD2===d.MODULE)&&a.CorCutoff_min<=Math.abs(c[g].COR)&&Math.abs(c[g].COR)<=a.CorCutoff_max&&(h[e]=c[g],e++);c=h;1E4>c.length&&(d=a.topG.selectAll(".link").data(c,a.mlinkKey),d.enter().append("line").attr("class","link").attr("pointer-events","none").attr("id",function(l){return"ln_"+
that.removeInvalidIDChars(l.MOD1)+that.removeInvalidIDChars(l.MOD2)}).attr("x1",function(l){return d3.select("#mod_"+that.removeInvalidIDChars(l.MOD1)).attr("cx")}).attr("y1",function(l){return d3.select("#mod_"+that.removeInvalidIDChars(l.MOD1)).attr("cy")}).attr("x2",function(l){return d3.select("#mod_"+that.removeInvalidIDChars(l.MOD2)).attr("cx")}).attr("y2",function(l){return d3.select("#mod_"+that.removeInvalidIDChars(l.MOD2)).attr("cy")}).attr("stroke",a.colorLink).attr("stroke-width",function(l){return Math.abs(l.COR)*
a.maxCorWidth}).merge(d))};a.drawLinksBetween=function(d){a.updateColor("linkColor");for(var c={},h=0;h<d.length;h++)c[d[h]]=1;a.svg.selectAll(".link").remove();d=a.metaData.LINKS;h=[];for(var e=0,g=0;g<d.length;g++)(0===a.showAllFromTarget&&"undefined"!==typeof c[d[g].MOD1]&&"undefined"!==typeof c[d[g].MOD2]||1===a.showAllFromTarget&&("undefined"!==typeof c[d[g].MOD1]||"undefined"!==typeof c[d[g].MOD2]))&&a.CorCutoff_min<=Math.abs(d[g].COR)&&Math.abs(d[g].COR)<=a.CorCutoff_max&&(h[e]=d[g],e++);d=
h;1E4>d.length&&(c=a.topG.selectAll(".link").data(d,a.mlinkKey),c.enter().append("line").attr("class","link").attr("pointer-events","none").attr("id",function(l){return"ln_"+that.removeInvalidIDChars(l.MOD1)+that.removeInvalidIDChars(l.MOD2)}).attr("x1",function(l){return d3.select("#mod_"+that.removeInvalidIDChars(l.MOD1)).attr("cx")}).attr("y1",function(l){return d3.select("#mod_"+that.removeInvalidIDChars(l.MOD1)).attr("cy")}).attr("x2",function(l){return d3.select("#mod_"+that.removeInvalidIDChars(l.MOD2)).attr("cx")}).attr("y2",
function(l){return d3.select("#mod_"+that.removeInvalidIDChars(l.MOD2)).attr("cy")}).attr("stroke",a.colorLink).attr("stroke-width",function(l){return Math.abs(l.COR)*a.maxCorWidth}).merge(c))};a.nodeX=function(d,c){var h=50,e=Math.floor(c/a.maxPerLevel)+1;1<e&&(h=60*e);return a.width/2+(a.r-h)*Math.cos(c%a.maxPerLevel*a.angle-1.57079633)};a.nodeY=function(d,c){var h=50;c>a.maxPerLevel&&(h=60*(Math.floor(c/a.maxPerLevel)+1));return a.height/2+(a.r-h)*Math.sin(c%a.maxPerLevel*a.angle-1.57079633)};
a.nodeXLbl=function(d,c){var h=c%a.maxPerLevel*a.angle-1.57079633,e=1;if(Math.PI/2<h&&h<1.5*Math.PI){var g=0;"undefined"!==typeof d.MODULE&&(g=d.MODULE.length);e+=7.5*g}return a.width/2+(a.r+e)*Math.cos(h)};a.nodeYLbl=function(d,c){var h=c%a.maxPerLevel*a.angle-1.57079633,e=1;if(Math.PI/2<h&&h<1.5*Math.PI){var g=0;"undefined"!==typeof d.MODULE&&(g=d.MODULE.length);e+=7.5*g}return a.height/2+(a.r+e)*Math.sin(h)};a.drawCorLegend=function(d){a.legendDispG.append("text").style("font-size","16").attr("x",
"35").attr("y",d).text("Positive Correlation");a.legendDispG.append("rect").attr("x","0").attr("y",d-10).attr("width","30").attr("height","10").style("fill",a.posColor);a.legendDispG.append("text").style("font-size","16").attr("x","35").attr("y",d+20).text("Negative Correlation");a.legendDispG.append("rect").attr("x","0").attr("y",d+10).attr("width","30").attr("height","10").style("fill",a.negColor);a.legendDispG.append("text").style("font-size","16").attr("x","35").attr("y",d+40).text("Lower Correlation");
...
"30").attr("y2",d+45).style("stroke","#000000").style("stroke-width","2");a.legendDispG.append("line").attr("x1","0").attr("y1",d+55).attr("x2","30").attr("y2",d+55).style("stroke","#000000").style("stroke-width","3");a.legendDispG.append("line").attr("x1","0").attr("y1",d+65).attr("x2","30").attr("y2",d+65).style("stroke","#000000").style("stroke-width","5");a.legendDispG.append("line").attr("x1","0").attr("y1",d+75).attr("x2","30").attr("y2",d+75).style("stroke","#000000").style("stroke-width",
"7");a.legendDispG.append("text").style("font-size","16").attr("x","35").attr("y",d+80).text("Higher Correlation")};a.drawLegend=function(){a.drawCorLegend(20)};a.selectMetaMod=function(d){that.topselectedModule=that.selectedModule;that.selectedModule=that.modules[d];that.topselectedGene=that.selectedGene;that.selectedGene={};for(d=0;d<that.selectedModule.TCList.length;d++)"undefined"===typeof that.selectedGene[that.selectedModule.TCList[d].Gene.ID]&&(that.selectedGene[that.selectedModule.TCList[d].Gene.ID]=
{},that.selectedGene[that.selectedModule.TCList[d].Gene.ID].geneSymbol=that.selectedModule.TCList[d].Gene.geneSymbol,that.selectedGene[that.selectedModule.TCList[d].Gene.ID].tcList=[]),that.selectedGene[that.selectedModule.TCList[d].Gene.ID].tcList.push(that.selectedModule.TCList[d]);that.viewType="gene";d3.select("#wgcnaGeneViewRB").property("checked",!0);that.createSingleWGCNAImage()};a.draw=function(){a.updateColor("linkColor");a.width=$(window).width();a.height=Math.floor(.9*window.innerHeight);
a.r=a.height>a.width?Math.floor(a.width/2*.95):Math.floor(a.height/2*.95);a.svg.attr("height",a.height+"px");a.svg.selectAll("circle").remove();a.svg.selectAll("text").remove();a.svg.selectAll("line").remove();a.svg.selectAll(".mod").remove();"undefined"!==typeof a.panZoom&&(a.panZoom.destroy(),delete a.panZoom);a.svg.selectAll(".svg-pan-zoom_viewport").remove();setTimeout(function(){a.svg.append("text").style("font-size","20").attr("y",22).attr("x",5).text(function(){return that.selectedModule?"Meta Module for "+
replaceUnderscore(that.selectedModule.MOD_NAME):""});a.setupLegend();a.data=a.metaData.MODULES;a.angle=2*Math.PI/a.data.length;a.angleDeg=360/a.data.length;a.data.length>a.maxPerLevel&&(a.angle=2*Math.PI/a.maxPerLevel,a.angleDeg=360/a.maxPerLevel);if(150<a.data.length){a.truncated=1;a.maxNodeR=15;for(var d=[],c=0;150>c;c++)d[c]=a.data[c];a.data=d;a.dataIndex={};for(c=0;c<a.data.length;c++)a.dataIndex[a.data[c].ID]=1;a.CorCutoff_min=.01;$("#linkSliderMin").slider("value",.01);$("span#minLabel").html("0.01");
