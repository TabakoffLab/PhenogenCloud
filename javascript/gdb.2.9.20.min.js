...
var mmVer='Mouse(<span id="verSelect"></span>) Strain:C57BL/6J',rnVer='Rat(<span id="verSelect"></span>) HRDP version:<span id="hrdpSelect"></span> Strain:BN',siteVer="PhenoGen v3.9.3(4/11/2024)",trackBinCutoff=1E4,customTrackLevel=-1,mouseTTOver=0,ttHideHandle=0,tt=d3.select("body").append("div").attr("class","testToolTip").style("z-index",1001).style("opacity",0);
...
genomeVer?D.documentElement.getElementsByTagName("smnc"):D.documentElement.getElementsByTagName("Gene");try{A=GeneTrack(c,z,e,"Small RNA (<200 bp) Genes",l),c.addTrackList(A),""!=selectGene&&A.setSelected(selectGene)}catch(F){}}});else if(0===e.indexOf("liverTotal")||"heartTotal"===e||0===e.indexOf("brainTotal")||"mergedTotal"===e||0===e.indexOf("kidneyTotal")||0===e.indexOf("brainIso")||0===e.indexOf("liverIso")){var v="Liver Reconstructed";"heartTotal"===e?v="Heart Reconstructed":"brainTotal"===
e?v="Whole Brain Reconstructed":"mergedTotal"===e?v="Merged (Brain,Heart,Liver,Kidney) Reconstructed":"kidneyTotal"===e?v="Kidney Reconstructed":"liverIso"===e?v="Liver IsoSeq":"brainIso"===e&&(v="Whole Brain IsoSeq");if((0===e.indexOf("liverTotal")||0===e.indexOf("brainTotal"))&&0<e.indexOf("_")){var y=e.substr(e.indexOf("_")+1);v="LEStm"===y?"LE-Stm "+v:"F344Stm"===y?"F344-Stm "+v:v+" v"+y}d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/"+e+".xml",function(z,D){if(z){if(1===
n&&("mergedTotal"===e||0===e.indexOf("liverTotal")||0===e.indexOf("brainTotal")||0===e.indexOf("kidneyTotal")||0===e.indexOf("brainIso")||0===e.indexOf("liverIso"))){var A=c.xScale.domain()[0];D=c.xScale.domain()[1];z="/"+pathPrefix;pathPrefix||(z="");var F=panel;if((0===e.indexOf("liverTotal")||0===e.indexOf("brainTotal"))&&0<e.indexOf("_"))F=e.substr(e.indexOf("_")+1),"LEStm"===F&&(F="LE-Stm"),"F344Stm"===F&&(F="F344-Stm");else if(0===e.indexOf("brainIso")||0===e.indexOf("liverIso"))F="IsoSeq";
$.ajax({url:z+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:A,maxCoord:D,panel:F,rnaDatasetID,arrayTypeID,myOrganism:organism,genomeVer,track:e,folder:c.folderName},dataType:"json",success:function(H){gtag("event","generateTrack"+e,{event_category:"browser"})},error:function(H,I,J){}})}60>n?(A=1500,1==n&&(A=2500),setTimeout(function(){c.addTrack(e,h,l,n+1)},A)):(d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An error occurred loading Track:"+e),d3.select("#Level"+
c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==D)11<=n?(z=[],A=GeneTrack(c,z,e,v,l),c.addTrackList(A)):setTimeout(function(){c.addTrack(e,h,l,11)},5E3);else{z=D.documentElement.getElementsByTagName("Gene");F=0;D=D.documentElement.getElementsByTagName("GeneList");0<D.length&&"undefined"!==typeof D[0].getAttribute("ver")&&(F=D[0].getAttribute("ver"));try{A=GeneTrack(c,z,e,v,l),A.dataVer=F,c.addTrackList(A),""!=selectGene&&
A.setSelected(selectGene)}catch(H){}}})}else if(0===e.indexOf("refSeq")){$("#"+e+c.levelNumber+"Select").val();var w=c.xScale.domain()[0],C=c.xScale.domain()[1];q=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/"+e+".xml";d3.xml(q,function(z,D){if(z){console.log(z);if(0===n){var A="/"+pathPrefix;pathPrefix||(A="");$.ajax({url:A+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:w,maxCoord:C,panel,rnaDatasetID,arrayTypeID,myOrganism:organism,
genomeVer,track:e,folder:c.folderName},dataType:"json",success:function(F){gtag("event","generateTrack"+e,{event_category:"browser"})},error:function(F,H,I){}})}60>n?(A=1500,1===n&&(A=2500),setTimeout(function(){c.addTrack(e,h,l,n+1)},A)):(d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==D)11<=n?(z=
[],A=RefSeqTrack(c,z,e,"Ref Seq Genes",l),c.addTrackList(A)):setTimeout(function(){c.addTrack(e,h,l,11)},5E3);else{z=D.documentElement.getElementsByTagName("Gene");try{A=RefSeqTrack(c,z,e,"Ref Seq Genes",l),c.addTrackList(A)}catch(F){console.log(F)}}})}else if(0==e.indexOf("snp"))w=c.xScale.domain()[0],C=c.xScale.domain()[1],q=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/"+e+".xml",d3.xml(q,function(z,D){if(z){console.log(z);if(0==n){var A="/"+pathPrefix;pathPrefix||
...
e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==D)11<=n?(z=[],A=SNPTrack(c,z,e,h,l),c.addTrackList(A)):setTimeout(function(){c.addTrack(e,h,l,11)},5E3);else{z=D.documentElement.getElementsByTagName("Snp");try{A=SNPTrack(c,z,e,h,l),c.addTrackList(A)}catch(F){}}});else if("qtl"===e)d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/qtl.xml",function(z,D){if(z)if(60>
n){var A=1500;1===n&&(A=2500);setTimeout(function(){c.addTrack(e,h,l,n+1)},A)}else d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e);else if(null==D)11<=n?(z=[],A=QTLTrack(c,z,e,h),c.addTrackList(A)):setTimeout(function(){c.addTrack(e,h,l,11)},5E3);else{z=D.documentElement.getElementsByTagName("QTL");try{A=QTLTrack(c,
z,e,h),c.addTrackList(A)}catch(F){}}});else if("trx"===e)y=getAllChildrenByName(getFirstChildByName(c.selectedData,"TranscriptList"),"Transcript"),q=TranscriptTrack(c,y,e,h),c.addTrackList(q);else if("probe"===e||"probeMouse"==e)d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/probe.xml",function(z,D){if(z)if(60>n){var A=1500;1===n&&(A=2500);setTimeout(function(){c.addTrack(e,h,l,n+1)},A)}else d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+
e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e);else if(null==D)11<=n?(z=[],A=ProbeTrack(c,z,e,"Affy Exon 1.0 ST Probe Sets",h+","+l),c.addTrackList(A)):setTimeout(function(){c.addTrack(e,h,l,11)},5E3);else{z=D.documentElement.getElementsByTagName("probe");try{A=ProbeTrack(c,z,e,"Affy Exon 1.0 ST Probe Sets",h+","+l),c.addTrackList(A)}catch(F){}}});else if("helicos"===e||-1<e.indexOf("illuminaTotal")||-1<
e.indexOf("illuminaSmall")||"illuminaPolyA"===e){w=c.xScale.domain()[0];C=c.xScale.domain()[1];var B=calculateBin(C-w,c.width);q=[];l&&(0<l.indexOf(",")?q=l.split(","):q[0]=l);y="Total";var E=1;2<q.length&&(g=1*q[1],2===g&&(y="Norm",E=2));q=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/tmp/"+w+"_"+C+".count."+e+"."+y+".xml";0<B&&(w-=w%B,C+=B-C%B,q=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/tmp/"+w+"_"+C+".bincount."+B+"."+e+"."+y+".xml");
d3.xml(q,function(z,D){if(z){if(0===n){var A="/"+pathPrefix;pathPrefix||(A="");tmpPanel=panel;-1<e.indexOf("-")&&(tmpPanel=e.substr(e.indexOf("-")+1));$.ajax({url:A+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:w,maxCoord:C,panel:tmpPanel,rnaDatasetID,arrayTypeID,myOrganism:organism,genomeVer,track:e,folder:c.folderName,binSize:B,countType:E},dataType:"json",success:function(F){gtag("event","generateTrack"+e,{event_category:"browser"})},error:function(F,H,I){}});
A=1E4}60>n?(A=1E3,0===n&&(A=2500),setTimeout(function(){c.addTrack(e,h,l,n+1)},A)):(d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==D)z=[],"helicos"==e?A=HelicosTrack(c,z,e,h):"illuminaTotal"==e?A=IlluminaTotalTrack(c,z,e,h):"illuminaSmall"==e?A=IlluminaSmallTrack(c,z,e,h):"illuminaPolyA"==e?A=IlluminaPolyATrack(c,
z,e,h):"liverilluminaTotalPlus"==e?A=LiverIlluminaTotalPlusTrack(c,z,e,h):"liverilluminaTotalMinus"==e?A=LiverIlluminaTotalMinusTrack(c,z,e,h):"heartilluminaTotalPlus"==e?A=HeartIlluminaTotalPlusTrack(c,z,e,h):"heartilluminaTotalMinus"==e?A=HeartIlluminaTotalMinusTrack(c,z,e,h):"brainilluminaTotalPlus"==e?A=BrainIlluminaTotalPlusTrack(c,z,e,h):"brainilluminaTotalMinus"==e?A=BrainIlluminaTotalMinusTrack(c,z,e,h):"liverilluminaSmall"==e?A=LiverIlluminaSmallTrack(c,z,e,h):"heartilluminaSmall"==e?A=HeartIlluminaSmallTrack(c,
z,e,h):-1<e.indexOf("illuminaTotal")&&(A=StrainSpecificIlluminaTotalTrack(c,z,e,h,l)),c.addTrackList(A);else{z=D.documentElement.getElementsByTagName("Count");try{"helicos"===e?A=HelicosTrack(c,z,e,h):"illuminaTotal"===e?A=IlluminaTotalTrack(c,z,e,h):"illuminaSmall"===e?A=IlluminaSmallTrack(c,z,e,h):"illuminaPolyA"===e?A=IlluminaPolyATrack(c,z,e,h):"liverilluminaTotalPlus"===e?A=LiverIlluminaTotalPlusTrack(c,z,e,h):"liverilluminaTotalMinus"===e?A=LiverIlluminaTotalMinusTrack(c,z,e,h):"heartilluminaTotalPlus"===
e?A=HeartIlluminaTotalPlusTrack(c,z,e,h):"heartilluminaTotalMinus"===e?A=HeartIlluminaTotalMinusTrack(c,z,e,h):"brainilluminaTotalPlus"===e?A=BrainIlluminaTotalPlusTrack(c,z,e,h):"brainilluminaTotalMinus"===e?A=BrainIlluminaTotalMinusTrack(c,z,e,h):"liverilluminaSmall"===e?A=LiverIlluminaSmallTrack(c,z,e,h):"heartilluminaSmall"===e?A=HeartIlluminaSmallTrack(c,z,e,h):-1<e.indexOf("illuminaTotal")&&(A=StrainSpecificIlluminaTotalTrack(c,z,e,h,l)),c.addTrackList(A)}catch(F){}}})}else if(-1<e.indexOf("spliceJnct")){w=
c.xScale.domain()[0];C=c.xScale.domain()[1];q=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/"+e+".xml";var G="Brain ";"liverspliceJnct"==e?G="Liver ":"heartspliceJnct"==e&&(G="Heart ");d3.xml(q,function(z,D){if(z){console.log(z);if(0==n){var A="/"+pathPrefix;pathPrefix||(A="");$.ajax({url:A+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:w,maxCoord:C,panel,rnaDatasetID,arrayTypeID,myOrganism:organism,genomeVer,track:e,folder:c.folderName},
dataType:"json",success:function(F){gtag("event","generateTrack"+e,{event_category:"browser"})},error:function(F,H,I){}})}60>n?(A=1500,1===n&&(A=2500),setTimeout(function(){c.addTrack(e,h,l,n+1)},A)):(d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==D)11<=n?(z=[],A=SpliceJunctionTrack(c,z,e,G+"Splice Junctions",
1,""),c.addTrackList(A)):setTimeout(function(){c.addTrack(e,h,l,11)},5E3);else{z=D.documentElement.getElementsByTagName("Feature");try{A=SpliceJunctionTrack(c,z,e,G+"Splice Junctions",3,""),c.addTrackList(A)}catch(F){console.log(F)}}})}else if("polyASite"==e)d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/polyASite.xml",function(z,D){if(z)if(60>n){var A=1E3;1===n&&(A=2500);setTimeout(function(){c.addTrack(e,h,l,n+1)},A)}else d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+
e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e);else if(null==D)4<=n?(z=[],A=PolyATrack(c,z,e,"Predicted PolyA Sites",l),c.addTrackList(A)):setTimeout(function(){c.addTrack(e,h,l,4)},5E3);else{z=D.documentElement.getElementsByTagName("Feature");try{A=PolyATrack(c,z,e,"Predicted PolyA Sites",l),c.addTrackList(A)}catch(F){}}});else if(0===e.indexOf("repeatMask"))$("#"+e+c.levelNumber+"Select").val(),w=c.xScale.domain()[0],
C=c.xScale.domain()[1],q=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/"+e+".xml",d3.xml(q,function(z,D){if(z){console.log(z);if(0===n){var A="/"+pathPrefix;pathPrefix||(A="");$.ajax({url:A+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:w,maxCoord:C,panel,rnaDatasetID,arrayTypeID,myOrganism:organism,genomeVer,track:e,folder:c.folderName},dataType:"json",success:function(F){gtag("event","generateTrack"+e,{event_category:"browser"})},error:function(F,
H,I){}})}60>n?(A=1500,1===n&&(A=2500),setTimeout(function(){c.addTrack(e,h,l,n+1)},A)):(d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==D)11<=n?(z=[],A=RepeatMaskTrack(c,z,e,"Repeat Masker",h,l),c.addTrackList(A)):setTimeout(function(){c.addTrack(e,h,l,11)},5E3);else{z=D.documentElement.getElementsByTagName("Feature");
try{A=RepeatMaskTrack(c,z,e,"Repeat Masker",h,l),c.addTrackList(A)}catch(F){console.log(F)}}});else if(0==e.indexOf("custom"))if(q=trackInfo[e],l=l+",Name="+q.Name,l="DataFile="+q.Location+","+l,"bed"==q.Type||"bb"==q.Type)y=[],q=CustomTranscriptTrack(c,y,e,q.Name,3,l),c.addTrackList(q),q.updateFullData(0,0);else{if("bg"==q.Type||"bw"==q.Type)y=[],q=CustomCountTrack(c,y,e,3,l),c.addTrackList(q)}else 0<=e.indexOf("cirRNA")&&(q=trackInfo[e],q=CircRNATrack(c,y,e,q.Name,3,l),c.addTrackList(q));$(".sortable"+
c.levelNumber).sortable("refresh");gtag("event",e,{event_category:"trackAdded"})};c.addTrackList=function(e){null!=e&&(c.trackList[c.trackCount]=e,c.trackCount++,c.trackListHash[e.trackClass]=e,setTimeout(function(){DisplayRegionReport()},300))};c.updateLinks=function(){1===c.levelNumber&&d3.select("#probeSetDetailLink1").each(function(){var e=new String(d3.select(this).attr("href"));e=e.substr(0,e.lastIndexOf("=")+1);e+=c.currentView.ViewID;d3.select(this).attr("href",e)})};c.changeTrackHeight=function(e,
h){0<h?d3.select("#"+e+"Scroll").style("max-height",h+"px").style("overflow","auto"):d3.select("#"+e+"Scroll").style("max-height","none").style("overflow","hidden")};c.removeAllTracks=function(){d3.selectAll("li.draggable"+c.levelNumber).remove();c.trackList=[];setTimeout(function(){DisplayRegionReport()},300);gtag("event",c.levelNumber,{event_category:"SVGremoveAllTracks"})};c.removeTrack=function(e){d3.select("#Level"+c.levelNumber+e).remove();for(var h=0;h<c.trackList.length;h++)"undefined"!==
typeof c.trackList[h]&&c.trackList[h].trackClass==e&&(c.trackList.splice(h,1),c.trackCount--);c.trackListHash[e]=void 0;setTimeout(function(){DisplayRegionReport()},300);gtag("event",c.levelNumber,{event_category:"removeTrack",event_label:e})};c.redrawTrack=function(e){for(var h=0;h<c.trackList.length;h++)"undefined"!==typeof c.trackList[h]&&c.trackList[h].trackClass==e&&c.trackList[h].redraw();setTimeout(function(){DisplayRegionReport()},300)};c.redraw=function(){for(var e=0;e<c.trackList.length;e++)"undefined"!==
typeof c.trackList[e]&&"undefined"!==typeof c.trackList[e].redraw&&c.trackList[e].redraw();c.selectSvg.redraw()};c.update=function(){for(var e=0;e<c.trackList.length;e++)"undefined"!==typeof c.trackList[e].update&&c.trackList[e].update();setTimeout(function(){DisplayRegionReport()},300);gtag("event","genomeSVG.update",{event_category:"gsvgUpdate"})};c.updateData=function(){for(var e=0;e<c.trackList.length;e++)"undefined"!==typeof c.trackList[e]&&"undefined"!==typeof c.trackList[e].updateData&&c.trackList[e].updateData(0);
c.updateFullData();setTimeout(function(){DisplayRegionReport()},300);gtag("event","genomeSVG.updateData",{event_category:"gsvgUpdateData"})};c.updateFullData=function(){-1<(new String(c.folderName)).indexOf("img")&&(c.folderName="/"+chr+"/"+c.xScale.domain()[0]+"_"+c.xScale.domain()[1],0==c.levelNumber&&regionfolderName!=c.folderName&&(regionfolderName=c.folderName),setTimeout(function(){DisplayRegionReport()},300));for(var e=0;e<c.trackList.length;e++)"undefined"!==typeof c.trackList[e]&&"undefined"!==
typeof c.trackList[e].updateFullData&&c.trackList[e].updateFullData(0,1);gtag("event","genomeSVG.updateFullData",{event_category:"gsvgUpdateFullData"})};c.setLoading=function(){for(var e=0;e<c.trackList.length;e++)"undefined"===typeof c.trackList[e]||"undefined"===typeof c.trackList[e].updateData&&"undefined"===typeof c.trackList[e].updateFullData||c.trackList[e].showLoading()};c.clearSelection=function(){c.selectionStart=-1;c.selectionEnd=-1;c.scaleSVG.selectAll("rect.selectedArea").remove();c.selectSvg.setVis(!1);
for(var e=0;e<c.trackList.length;e++)"undefined"!==typeof c.trackList[e]&&"undefined"!==typeof c.trackList[e].clearSelection&&c.trackList[e].clearSelection()};c.mdown=function(){if(0==c.overSettings)if("dragzoom"!==c.defaultMouseFunct&&d3.event.altKey||"dragzoom"===c.defaultMouseFunct&&!d3.event.altKey){var e=d3.mouse(c.vis.node());c.downZoomx=e[0];c.scaleSVG.append("rect").attr("class","zoomRect").attr("x",e[0]).attr("y",0).attr("height",c.scaleSVG.attr("height")).attr("width",1).attr("fill","#CECECE").attr("opacity",
.3);c.scaleSVG.append("text").attr("id","zoomTextStart").attr("x",c.downZoomx).attr("y",15).text(numberWithCommas(Math.round(c.xScale.invert(c.downZoomx))));c.scaleSVG.append("text").attr("id","zoomTextEnd").attr("x",c.downZoomx).attr("y",50).text(numberWithCommas(Math.round(c.xScale.invert(c.downZoomx))))}else 0==processAjax&&(c.prevMinCoord=c.xScale.domain()[0],c.prevMaxCoord=c.xScale.domain()[1],e=d3.mouse(c.vis.node()),c.downx=c.xScale.invert(e[0]),c.downscalex=c.xScale)};c.forceDrawAs=function(e){for(var h=
0;h<c.trackList.length;h++)"undefined"!==typeof c.trackList[h]&&"undefined"!==typeof c.trackList[h].drawAs&&(c.trackList[h].drawAs=e,c.trackList[h].draw(c.trackList[h].data));c.forceDrawAsValue=e};c.resize=function(e){c.width=e;c.xScale.range([0,c.width]);c.xAxis=d3.axisTop(c.xScale).ticks(6).tickSize(8).tickPadding(10);c.scaleSVG.attr("width",c.width);c.scaleSVG.select(".x.axis").call(c.xAxis);d3.select("#Level"+c.levelNumber).select(".axisLbl").attr("x",(c.width-2*c.margin)/2);c.topLevel.style("width",
c.width+18+"px");for(var h=0;h<c.trackList.length;h++)"undefined"!==typeof c.trackList[h]&&"undefined"!==typeof c.trackList[h].redraw&&c.trackList[h].resize();c.selectSvg.width=e;c.selectSvg.draw()};c.updateCountScales=function(e,h){for(var l=0;l<c.trackList.length;l++)"undefined"!==typeof c.trackList[l]&&"undefined"!==typeof c.trackList[l].updateCountScale&&c.trackList[l].updateCountScale(e,h)};c.resetDefaultMouse=function(e){var h="/web/images/icons/"+e+"_dark.png";d3.select("span#"+e+c.levelNumber+
" img").attr("src",h);d3.select("span#"+e+c.levelNumber).style("background","#DCDCDC")};c.changeTrackCursor=function(e){for(var h=0;h<c.trackList.length;h++)"undefined"!==typeof c.trackList[h]&&"undefined"!==typeof c.trackList[h].svg&&c.trackList[h].svg.style("cursor",e)};c.changeScaleCursor=function(e){"undefined"!==typeof c.scaleSVG&&c.scaleSVG.style("cursor",e)};c.updateTrackSelectedArea=function(e,h){c.selectionStart=e;c.selectionEnd=h;var l=c.xScale(e),n=c.xScale(h)-l;c.scaleSVG.selectAll("rect.selectedArea").remove();
if((0<l||0<l+n)&&l<c.width)for(1>n&&(n=1),c.scaleSVG.append("rect").attr("class","selectedArea").attr("x",l).attr("y",15).attr("height",c.scaleSVG.attr("height")-15).attr("width",n).attr("fill","#CECECE").attr("opacity",.3).attr("pointer-events","none"),l=0;l<c.trackList.length;l++)"undefined"!==typeof c.trackList[l]&&"undefined"!==typeof c.trackList[l].setSelectedArea&&c.trackList[l].setSelectedArea(e,h)};c.getAddMenus=function(){var e="/"+pathPrefix;""==pathPrefix&&(e="");$.ajax({url:e+"trackMenu.jsp",
type:"GET",cache:!1,data:{level:c.levelNumber,organism},dataType:"html",success:function(h){$("#trackMenu"+c.levelNumber).remove();d3.select("div#trackMenu").append("div").attr("id","trackMenu"+c.levelNumber);$("#trackMenu"+c.levelNumber).html(h)},error:function(h,l,n){$("#trackMenu"+c.levelNumber).remove();d3.select("div#trackMenu").append("div").attr("id","trackMenu"+c.levelNumber);$("#trackMenu"+c.levelNumber).append('<div class="viewsLevel'+c.levelNumber+'">An error occurred generating this menu.  Please try back later.</div>')},
async:!1});$.ajax({url:e+"viewMenu.jsp",type:"GET",cache:!1,data:{level:c.levelNumber,organism},dataType:"html",success:function(h){$("#viewMenu"+c.levelNumber).remove();d3.select("div#viewMenu").append("div").attr("id","viewMenu"+c.levelNumber);$("#viewMenu"+c.levelNumber).html(h)},error:function(h,l,n){$("#viewMenu"+c.levelNumber).remove();d3.select("div#viewMenu").append("div").attr("id","viewMenu"+c.levelNumber);$("#viewMenu"+c.levelNumber).append('<div class="viewsLevel'+c.levelNumber+'">An error occurred generating this menu.  Please try back later.</div>')},
async:!1})};c.zoomMenuChange=function(e){d3.select("#zoomSelectMenu"+c.levelNumber).selectAll("li").style("background","#FFFFFF");c.zoomFactor=parseFloat(d3.select(e).attr("value"));d3.select(e).style("background","#CECECE")};c.setupFunctionBar=function(){d3.selectAll("span.shrt-button").on("click",function(){nameSpan=d3.select(this).attr("name");-1<nameSpan.toLowerCase().indexOf("gene")?""!==selectedID?($("div#selectedDetail").is(":visible")||0!==selectedID.indexOf("ENS")||c.getTrack("ensemblcoding").setSelected(selectedID),
$("span[name='"+nameSpan+"']").click(),$("html, body").animate({scrollTop:$("#selectedReport").offset().top},1E3)):alert("You must select a gene from an Ensembl Track before clicking on the gene shortcut."):($("span.closeDetail").click(),$("span#"+nameSpan).click(),$("html, body").animate({scrollTop:$("#regionDiv").offset().top},1E3))});d3.select(p).select("#functLevel"+c.levelNumber).remove();c.functionBar=c.vis.append("div").attr("class","functionBar").attr("id","functLevel"+c.levelNumber).style("float",
"left");var e=c.functionBar.append("div").attr("class","defaultMouse").attr("id","defaultMouse"+c.levelNumber);e.append("span").attr("id","dragzoom"+c.levelNumber).style("height","24px").style("display","inline-block").style("cursor","pointer").append("img").attr("class","mouseOpt dragzoom").attr("src","/web/images/icons/dragzoom_dark.png").attr("pointer-events","all").on("click",function(){c.resetDefaultMouse(c.defaultMouseFunct);c.defaultMouseFunct="dragzoom";d3.select(this).attr("src","/web/images/icons/dragzoom_white.png");
d3.select("span#dragzoom"+c.levelNumber).style("background","#989898");c.changeTrackCursor("crosshair");c.changeScaleCursor("crosshair");gtag("event","",{event_category:"clickDragZoom"})}).on("mouseout",function(){"dragzoom"!=c.defaultMouseFunct&&(d3.select(this).attr("src","/web/images/icons/dragzoom_dark.png"),d3.select("span#dragzoom"+c.levelNumber).style("background","#DCDCDC"))}).on("mouseover",function(){d3.select(this).attr("src","/web/images/icons/dragzoom_white.png");d3.select("span#dragzoom"+
c.levelNumber).style("background","#989898");$("#mouseHelp").html("Click to set default mouse function to allow click and drag to select a region to zoom in on.")});e.append("span").attr("id","pan"+c.levelNumber).style("height","24px").style("display","inline-block").style("cursor","pointer").append("img").attr("class","mouseOpt pan").attr("src","/web/images/icons/pan_dark.png").attr("pointer-events","all").on("click",function(){c.resetDefaultMouse(c.defaultMouseFunct);c.defaultMouseFunct="pan";d3.select(this).attr("src",
"/web/images/icons/pan_white.png");d3.select("span#pan"+c.levelNumber).style("background","#989898");c.changeTrackCursor("move");c.changeScaleCursor("ew-resize");gtag("event","",{event_category:"clickPan"})}).on("mouseout",function(){"pan"!=c.defaultMouseFunct&&(d3.select(this).attr("src","/web/images/icons/pan_dark.png"),d3.select("span#pan"+c.levelNumber).style("background","#DCDCDC"))}).on("mouseover",function(){d3.select(this).attr("src","/web/images/icons/pan_white.png");d3.select("span#pan"+
c.levelNumber).style("background","#989898");$("#mouseHelp").html("Click to set default mouse function to allow click and drag to navigate along the genome.")});e.append("span").attr("id","reorder"+c.levelNumber).style("height","24px").style("display","inline-block").style("cursor","pointer").append("img").attr("class","mouseOpt pan").attr("src","/web/images/icons/reorder_dark.png").attr("pointer-events","all").on("click",function(){c.resetDefaultMouse(c.defaultMouseFunct);c.defaultMouseFunct="reorder";
d3.select(this).attr("src","/web/images/icons/reorder_white.png");d3.select("span#reorder"+c.levelNumber).style("background","#989898");c.changeTrackCursor("ns-resize");c.changeScaleCursor("ew-resize");gtag("event","",{event_category:"clickReorder"})}).on("mouseout",function(){"reorder"!=c.defaultMouseFunct&&(d3.select(this).attr("src","/web/images/icons/reorder_dark.png"),d3.select("span#reorder"+c.levelNumber).style("background","#DCDCDC"))}).on("mouseover",function(){d3.select(this).attr("src",
"/web/images/icons/reorder_white.png");d3.select("span#reorder"+c.levelNumber).style("background","#989898");$("#mouseHelp").html("Click to set default mouse function to reorder image tracks. <strong>Optionally hold down shift in any mode.</strong>")});$("span#"+c.defaultMouseFunct+c.levelNumber+" img").click();c.functionBar.append("span").attr("class","saveImage control").style("display","inline-block").attr("id","saveLevel"+c.levelNumber).style("cursor","pointer").append("img").attr("src","/web/images/icons/savePic_dark.png").attr("pointer-events",
"all").attr("cursor","pointer").on("click",function(){var h=$(this).parent().attr("id"),l=(new String(h)).substr(9);h=$("div#Level"+l).html();$.ajax({url:pathPrefix+"saveBrowserImage.jsp",type:"POST",contentType:"text/html",data:h+"\n",processData:!1,dataType:"json",success:function(n){var q=new Date;q=q.getMonth()+1+"_"+q.getDate()+"_"+q.getFullYear();var u="http://";"https:"===location.protocol&&(u="https://");var v=u+urlprefix+"/tmpData/download/"+n.imageFile;n=new String($("#geneTxt").val());
n=n.replace(/:/g,"_");n=n.replace(/-/g,"_");n=n.replace(/,/g,"");"Level1"==l&&(n=svgList[1].selectedData.getAttribute("geneSymbol"));var y=n+"_"+q+".png",w=new XMLHttpRequest;w.open("GET",v);w.responseType="blob";w.send();w.onreadystatechange=function(){if(4!=w.readyState||200!=w.status)return!1;var C=document.createElement("a");C.href=window.URL.createObjectURL(w.response);C.download=y;C.style.display="none";document.body.appendChild(C);try{C.click()}catch(B){$("#mouseHelp").html("<span style='color:#FF0000;'>Your browser will not save the image directly. Image will open in a popup, in the new window right click to save image.</span>"),
window.open(v)}return!0};gtag("event","saveBrowserImage",{event_category:"browser"})},error:function(n,q,u){console.log(u)}});gtag("event","",{event_category:"saveImage"})}).on("mouseover",function(){d3.select(this).attr("src","/web/images/icons/savePic_white.png");d3.select("span#savePic"+c.levelNumber).style("background","#DCDCDC");$("#mouseHelp").html("Click to download a PNG image of the current view.")}).on("mouseout",function(){d3.select(this).attr("src","/web/images/icons/savePic_dark.png");
d3.select("span#savePic"+c.levelNumber).style("background","#989898");$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")});c.functionBar.append("span").attr("class","reset control").style("display","inline-block").attr("id","resetImage"+c.levelNumber).style("cursor","pointer").append("img").attr("src","/web/images/icons/reset_dark.png").attr("pointer-events","all").attr("cursor","pointer").on("click",function(){var h=new String($(this).parent().attr("id"));
h=h.substr(h.length-1);0==h?($("#geneTxt").val(chr+":"+initMin+"-"+initMax),svgList[0].xScale.domain([initMin,initMax]),svgList[0].scaleSVG.select(".x.axis").call(svgList[0].xAxis),svgList[0].redraw()):(svgList[h].xScale.domain([svgList[h].initMin,svgList[h].initMax]),svgList[h].scaleSVG.select(".x.axis").call(svgList[h].xAxis),svgList[h].redraw());svgList[0].updateFullData();gtag("event","",{event_category:"clickResetImage"})}).on("mouseover",function(){d3.select(this).attr("src","/web/images/icons/reset_white.png");
d3.select("span#reset"+c.levelNumber).style("background","#DCDCDC");$("#mouseHelp").html("Click to reset image zoom to initial region.")}).on("mouseout",function(){d3.select(this).attr("src","/web/images/icons/reset_dark.png");d3.select("span#reset"+c.levelNumber).style("background","#989898");$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")});c.functionBar.append("span").attr("class","back control").style("display","inline-block").attr("id","backButton"+
c.levelNumber).style("cursor","pointer").append("img").attr("src","/web/images/icons/back_dark2.png").attr("pointer-events","all").attr("cursor","pointer").on("click",function(){back(c.levelNumber);gtag("event","",{event_category:"clickBack"})}).on("mouseover",function(){d3.select(this).attr("src","/web/images/icons/back_white2.png");$("#mouseHelp").html("Click to undo last zoom/pan.")}).on("mouseout",function(){d3.select(this).attr("src","/web/images/icons/back_dark2.png");$("#mouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")});
e=c.functionBar.append("span").style("display","inline-block").style("position","relative").style("top","-9px").attr("id","zoom"+c.levelNumber);e.append("button").attr("id","zoomInButton"+c.levelNumber).attr("class","zoomIn").style("height","2.3em").append("img").style("position","relative").style("top","-5px").attr("src","/web/images/icons/magPlus_dark_32.png").attr("pointer-events","all").attr("cursor","pointer");e.append("button").attr("id","zoomOutButton"+c.levelNumber).attr("class","zoomOut").style("height",
"2.3em").append("img").style("position","relative").style("top","-5px").attr("src","/web/images/icons/magMinus_dark_32.png").attr("pointer-events","all").attr("cursor","pointer");e.append("button").attr("id","zoomMenuSelect"+c.levelNumber).attr("class","zoomSelectMenu");testChrome?d3.select("#zoomSelect"+c.levelNumber).style("height","2.3em"):testSafari&&d3.select("#zoomSelect"+c.levelNumber).style("height","2.3em");e=c.functionBar.append("ul").attr("id","zoomSelectMenu"+c.levelNumber);e.append("li").attr("id",
"zoom1"+c.levelNumber).attr("value","0.025").on("click",function(){c.zoomMenuChange(this)}).text("0.5x");e.append("li").attr("id","zoom2"+c.levelNumber).attr("value","0.05").style("background","#CECECE").on("click",function(){c.zoomMenuChange(this)}).text("1x");e.append("li").attr("id","zoom3"+c.levelNumber).attr("value","0.1").on("click",function(){c.zoomMenuChange(this)}).text("2x");e.append("li").attr("id","zoom4"+c.levelNumber).attr("value","0.25").on("click",function(){c.zoomMenuChange(this)}).text("5x");
e.append("li").attr("id","zoom5"+c.levelNumber).attr("value","0.5").on("click",function(){c.zoomMenuChange(this)}).text("10x");$("#zoomInButton"+c.levelNumber).button().click(function(){zoomIn(c.levelNumber,c.zoomFactor);gtag("event","",{event_category:"clickZoomIn"})}).on("mouseover",function(){$(this).css("background","#989898");$("img",this).attr("src","/web/images/icons/magPlus_light_32.png");$("#mouseHelp").html("Click to zoom in on the center of the region.  Click and drag the scale to zoom in or out more quickly or select the region select tool to highlight a specific region.")}).on("mouseout",
...
localStorage.setItem(organism+"DefHRDPVer",$(this).val()):$.cookie(organism+"DefHRDPVer",$(this).val());changeHRDPVer($(this).val(),c.currentView);setTimeout(function(){$("form#geneCentricForm").submit()},1500)}),"Rn"===organism?($("span#hrdpSelect").css("display","inline-block"),"rn7"===genomeVer?(h=e.append("option").attr("value","6").html("HRDPv6"),h.attr("selected","selected")):"rn6"===genomeVer&&e.append("option").attr("value","5").html("HRDPv5").attr("selected","selected")):"Mm"===organism&&
...
0===b.trackClass.indexOf("kidneyTotal")||"mergedTotal"===b.trackClass||-1<b.trackClass.indexOf("smallnc")||0===b.trackClass.indexOf("brainIso")||0===b.trackClass.indexOf("liverIso"))){d="/"+pathPrefix;pathPrefix||(d="");c=b.trackClass;var g=panel;if((0===b.trackClass.indexOf("liverTotal")||0===b.trackClass.indexOf("brainTotal"))&&0<b.trackClass.indexOf("_"))g=track.substr(track.indexOf("_")+1),"LEStm"===g&&(g="LE-Stm"),"F344Stm"===g&&(g="F344-Stm");else if(0===b.trackClass.indexOf("brainIso")||0===
b.trackClass.indexOf("liverIso"))g="IsoSeq";$.ajax({url:d+"generateTrackXML.jsp",type:"GET",cache:!1,asyn:!0,data:{chromosome:chr,minCoord:b.gsvg.xScale.domain()[0],maxCoord:b.gsvg.xScale.domain()[1],panel:g,rnaDatasetID,arrayTypeID,myOrganism:organism,genomeVer,track:c,folder:b.gsvg.folderName},dataType:"json",success:function(l){gtag("event","generateTrackGene",{event_category:"browser"})},error:function(l,n,q){}})}10>a?(d=2E3,1===a&&(d=5E3),setTimeout(function(){b.updateData(a+1)},d)):(d3.select("#Level"+
b.gsvg.levelNumber+b.trackClass).select("#trkLbl").text("An errror occurred loading Track:"+b.trackClass),d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).attr("height",15),b.gsvg.addTrackErrorRemove(b.svg,"#Level"+b.gsvg.levelNumber+b.trackClass))}else if(c){d=c.documentElement.getElementsByTagName("Gene");c=[];g=[];for(var e=0,h=0;h<d.length;h++)d[h]&&(c[e]=d[h],g[d[h].getAttribute("ID")]=1,e++);for(h=0;h<b.data.length;h++)b.data[h]&&!g[b.data[h].getAttribute("ID")]&&(c[e]=b.data[h],e++);b.draw(c);
b.hideLoading();setTimeout(function(){DisplayRegionReport()},300)}else b.hideLoading()})};b.updateDataVersion=function(a,d){var c=b.trackClass+"_"+a;d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+b.gsvg.folderName+"/"+c+".xml",function(g,e){g?(0===d&&(g="/"+pathPrefix,pathPrefix||(g=""),e=panel,(0===track.indexOf("liverTotal")||0===track.indexOf("brainTotal"))&&0<track.indexOf("_")&&(e=track.substr(track.indexOf("_")+1),"LEStm"===e&&(e="LE-Stm"),"F344Stm"===e&&(e="F344-Stm")),
$.ajax({url:g+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:b.gsvg.xScale.domain()[0],maxCoord:b.gsvg.xScale.domain()[1],panel:e,rnaDatasetID,arrayTypeID,myOrganism:organism,genomeVer,track:c,folder:b.gsvg.folderName},dataType:"json",success:function(h){gtag("event","generateTrackGene",{event_category:"browser"})},error:function(h,l,n){}})),5>d?(g=1E4,0===d&&(g=5E3),setTimeout(function(){b.updateDataVersion(a,d+1)},g)):(d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).select("#trkLbl").text("An errror occurred loading Track:"+
b.trackClass),d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).attr("height",15),b.gsvg.addTrackErrorRemove(b.svg,"#Level"+b.gsvg.levelNumber+b.trackClass))):(g=e.documentElement.getElementsByTagName("Gene"),e=parseInt(a),b.dataVer=e,b.draw(g),b.hideLoading(),setTimeout(function(){DisplayRegionReport()},300))})};b.drawTrx=function(a,d){d=parseInt(a.getAttribute("start"),10);var c=parseInt(a.getAttribute("stop"),10);a.getAttribute("cdsStart")&&a.getAttribute("cdsStop")&&(d=parseInt(a.getAttribute("cdsStart"),
10),c=parseInt(a.getAttribute("cdsStop"),10));var g="";1===b.gsvg.levelNumber?g="tx":99===b.gsvg.levelNumber&&(g="ttTx");g=d3.select("#Level"+b.gsvg.levelNumber+b.trackClass+" #"+g+b.cleanID(a.getAttribute("ID"))+b.gsvg.levelNumber);exList=getAllChildrenByName(getFirstChildByName(a,"exonList"),"exon");for(var e=0;e<exList.length;e++){var h=parseInt(exList[e].getAttribute("start"),10),l=parseInt(exList[e].getAttribute("stop"),10);if(h<d&&d<l||l>c&&c>h){var n=0,q=0,u=0,v=0;h<d?(n=b.xScale(h),q=b.xScale(d)-
b.xScale(h),u=b.xScale(d),v=b.xScale(l)-b.xScale(d)):l>c&&(u=b.xScale(h),v=b.xScale(c)-b.xScale(h),n=b.xScale(c),q=b.xScale(l)-b.xScale(c));g.append("rect").attr("x",n).attr("y",2.5).attr("height",5).attr("width",q).attr("title",function(w){return exList[e].getAttribute("ID")}).attr("id",function(w){return"ExNC"+exList[e].getAttribute("ID")}).style("fill",b.color).style("cursor","pointer");g.append("rect").attr("x",u).attr("height",10).attr("width",v).attr("title",function(w){return exList[e].getAttribute("ID")}).attr("id",
function(w){return"Ex"+exList[e].getAttribute("ID")}).style("fill",b.color).style("cursor","pointer")}else{n=10;q=0;if(h<d&&l<d||l>c&&h>c)n=5,q=2.5;g.append("rect").attr("x",function(w){return b.xScale(exList[e].getAttribute("start"))}).attr("y",q).attr("id",function(w){return"Ex"+exList[e].getAttribute("ID")}).attr("height",n).attr("width",function(w){return b.xScale(exList[e].getAttribute("stop"))-b.xScale(exList[e].getAttribute("start"))}).attr("title",function(w){return exList[e].getAttribute("ID")}).style("fill",
b.color).style("cursor","pointer")}if(0<e&&(g.append("line").attr("x1",function(w){return b.xScale(exList[e-1].getAttribute("stop"))}).attr("x2",function(w){return b.xScale(exList[e].getAttribute("start"))}).attr("y1",5).attr("y2",5).attr("id",function(w){return"Int"+exList[e-1].getAttribute("ID")+"_"+exList[e].getAttribute("ID")}).attr("stroke",b.color).attr("stroke-width","2"),"1"==a.getAttribute("strand")||"-1"==a.getAttribute("strand"))){h=">";if("-1"==a.getAttribute("strand")||"-"==a.getAttribute("strand"))h=
"<";l=h;n=b.xScale(exList[e-1].getAttribute("stop"));q=b.xScale(exList[e].getAttribute("start"))-n;u=0;if(7>q)l="";else for(q-=7;8<q;)0==u?(l+=" ",u=1):(l+=h,u=0),q-=7;g.append("svg:text").attr("id",function(w){return"IntTxt"+exList[e-1].getAttribute("ID")+"_"+exList[e].getAttribute("ID")}).attr("dx",n+1).attr("dy","11").style("pointer-events","none").style("opacity","0.5").style("fill",b.color).style("font-size","16px").text(l)}}if(2==b.density){var y=a.getAttribute("ID");"undefined"!==typeof a.getAttribute("geneSymbol")&&
0<a.getAttribute("geneSymbol").length&&(y=y+" ("+a.getAttribute("geneSymbol")+")");g.append("svg:text").attr("dx",function(){var w=b.xScale(a.getAttribute("start"));return w=w<$(window).width()/2?b.xScale(a.getAttribute("stop"))-b.xScale(a.getAttribute("start"))+5:-9*y.length}).attr("dy",10).attr("id","lblTxt").text(y)}else g.select("text#lblTxt").remove()};b.getSVGID=function(a){return b.getDisplayID(a.getAttribute("ID"))+" ("+a.getAttribute("geneSymbol")+")"};b.setupToolTipSVG=function(a,d){if("undefined"!==
typeof a.getAttribute("extStart")&&null!==a.getAttribute("extStart")){var c=parseInt(a.getAttribute("extStart"),10);var g=parseInt(a.getAttribute("extStop"),10)}else c=parseInt(a.getAttribute("start"),10),g=parseInt(a.getAttribute("stop"),10);d=Math.floor((g-c)*d);10>d&&(d=10);c-=d;g+=d;d=toolTipSVG("div#ttSVG",450,c,g,99,b.getSVGID(a),"transcript");d.xMin=c;d.xMax=g;var e="none";0===b.trackClass.indexOf("brainTotal")||0===b.trackClass.indexOf("liverTotal")||0===b.trackClass.indexOf("kidneyTotal")||
"heartTotal"===b.trackClass||"mergedTotal"==b.trackClass?e=b.trackClass:200>parseInt(a.getAttribute("stop"),10)-parseInt(a.getAttribute("start"),10)?e="small":"protein_coding"==a.getAttribute("biotype")&&200<=parseInt(a.getAttribute("stop"),10)-parseInt(a.getAttribute("start"),10)?e="protein":"protein_coding"!=a.getAttribute("biotype")&&200<=parseInt(a.getAttribute("stop"),10)-parseInt(a.getAttribute("start"),10)&&(e="long");d.txType=e;d.selectedData=a;e=[];e[0]=a;"undefined"!==typeof a.parent&&(e[0]=
a.parent);d.addTrack(b.trackClass,2,"DrawTrx",e);for(a=0;a<b.ttTrackList.length;a++)if(b.trackClass!==b.ttTrackList[a]){e=b.gsvg.getTrackData(b.ttTrackList[a]);var h=[];if("undefined"!==typeof e&&0<e.length){for(var l=0,n=0;n<e.length;n++)if(c<=parseInt(e[n].getAttribute("start"),10)&&parseInt(e[n].getAttribute("start"),10)<=g||c<=parseInt(e[n].getAttribute("stop"),10)&&parseInt(e[n].getAttribute("stop"),10)<=g||parseInt(e[n].getAttribute("start"),10)<=c&&parseInt(e[n].getAttribute("stop"),10)>=c)h[l]=
e[n],l++;0<h.length&&d.addTrack(b.ttTrackList[a],3,"DrawTrx",h)}}};b.draw=function(a){b.data=a;b.trackYMax=0;b.yMaxArr=[];b.yArr=[];b.yArr[0]=[];for(var d=0;d<b.gsvg.width;d++)b.yMaxArr[d]=0,b.yArr[0][d]=0;b.svg.selectAll(".gene").remove();d=b.drawAs;var c=b.xScale.domain()[0];if(b.xScale.domain()[1]-c<b.trxCutoff||$("#forceTrxCBX"+b.gsvg.levelNumber).is(":checked"))b.drawAs="Trx";c="Genes";"Trx"==b.drawAs&&(c="Transcripts");var g="Protein Coding",e=" / PolyA+";-1<b.trackClass.indexOf("noncoding")?
(g="Long Non-Coding",e=" / Non-PolyA+"):-1<b.trackClass.indexOf("smallnc")?(g="Brain",-1<b.trackClass.indexOf("liver")?g="Liver":-1<b.trackClass.indexOf("heart")&&(g="Heart"),g+=" Small RNA",e=""):0===b.trackClass.indexOf("liverTotal")?(g="Liver RNA-Seq  ",e="Total RNA"):"heartTotal"==b.trackClass?(g="Heart RNA-Seq Reconstruction ",e="Total RNA"):0===b.trackClass.indexOf("brainTotal")?(g="Whole Brain RNA-Seq Reconstruction ",e="Total RNA"):0===b.trackClass.indexOf("kidneyTotal")?(g="Kidney RNA-Seq Reconstruction ",
e="Total RNA"):"mergedTotal"==b.trackClass?(g="Merged (Brain,Heart,Liver,Kidney) Reconstructed",e="Total RNA"):"brainIso"==b.trackClass?(g="Whole Brain",e="Iso-Seq"):"liverIso"==b.trackClass&&(g="Liver",e="Iso-Seq");g=-1<b.trackClass.indexOf("ensembl")?"Ensembl "+g+" "+c:-1===b.trackClass.indexOf("brainTotal")&&-1===b.trackClass.indexOf("liverTotal")&&"heartTotal"!=b.trackClass&&"mergedTotal"!=b.trackClass&&-1===b.trackClass.indexOf("kidenyTotal")&&-1===b.trackClass.indexOf("Iso")?"Reconstruction "+
g+e+" "+c:-1<b.trackClass.indexOf("Iso")?g+" "+e:g+e+" "+c;(0===b.trackClass.indexOf("liverTotal")||0===b.trackClass.indexOf("brainTotal"))&&0<b.trackClass.indexOf("_")&&(c=b.trackClass.substr(b.trackClass.indexOf("_")+1),"LEStm"===c&&(c="LE-Stm"),"F344Stm"===c&&(c="F344-Stm"),g=c+" Filtered (>=1.0TPM) "+g);b.updateLabel(g);b.redrawLegend();c=a;if("Trx"===b.drawAs&&-1===b.trackClass.indexOf("smallnc"))for(c=[],e=g=0;e<a.length;e++)if("undefined"!==typeof a[e])for(var h=getAllChildrenByName(getFirstChildByName(a[e],
"TranscriptList"),"Transcript"),l=0;l<h.length;l++)c[g]=h[l],c[g].parent=a[e],g++;0<c.length&&("Gene"===b.drawAs||-1<b.trackClass.indexOf("smallnc")?(b.drawnAs="Gene",b.svg.selectAll(".trx0").each(function(){d3.select(this).remove()}),a=b.svg.selectAll(".gene").data(c,key).attr("transform",function(n,q){return"translate("+b.xScale(n.getAttribute("start"))+","+b.calcY(parseInt(n.getAttribute("start"),10),parseInt(n.getAttribute("stop"),10),q)+")"}),a.enter().append("g").attr("class","gene").attr("transform",
function(n,q){return"translate("+b.xScale(n.getAttribute("start"))+","+b.calcY(parseInt(n.getAttribute("start"),10),parseInt(n.getAttribute("stop"),10),q)+")"}).merge(a).append("rect").attr("height",10).attr("rx",1).attr("ry",1).attr("width",function(n){return b.xScale(n.getAttribute("stop"))-b.xScale(n.getAttribute("start"))}).attr("title",function(n){return n.getAttribute("ID")}).attr("stroke",b.colorStroke).attr("stroke-width","1").attr("id",function(n){return b.cleanID(n.getAttribute("ID"))}).style("fill",
b.color).style("cursor","pointer").on("click",function(n){setTimeout(function(){b.setupDetailedView(n);d3.select(this).attr("class","selected").style("fill","green")}.bind(this),10)}).on("dblclick",b.zoomToFeature).on("mouseover",function(n){0===b.gsvg.isToolTip&&(overSelectable=1,$("#mouseHelp").html("<B>Click</B> to see additional details. <B>Double Click</B> to zoom in on this feature."),d3.select(this).style("fill","green"),tt.transition().duration(200).style("opacity",1).style("top",function(){return b.positionTTTop(d3.event.pageY)}).style("left",
...
b.color);tt.transition().delay(500).duration(200).style("opacity",0);b.clearTableFilter(n)}),a.exit().remove(),d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).selectAll("g.gene").each(function(n){if(n){var q=d3.select(this);if("-1"==n.getAttribute("strand")||"1"==n.getAttribute("strand")){var u=">";"-1"==n.getAttribute("strand")&&(u="<");var v=u,y=q.select("rect").attr("width");if(8.5>y)v="";else for(y-=8.5,v=u;8.7<y;)v+=u,y-=8.5;q.append("svg:text").attr("dx","1").attr("dy","10").attr("id","strandTxt").style("pointer-events",
"none").text(v)}if(2===b.density){var w=n.getAttribute("ID");n.getAttribute("geneSymbol")&&0<n.getAttribute("geneSymbol").length&&(w=w+" ("+n.getAttribute("geneSymbol")+")");q.append("svg:text").attr("dx",function(){var C=b.xScale(n.getAttribute("start"));return C=C<$(window).width()/2?b.xScale(n.getAttribute("stop"))-b.xScale(n.getAttribute("start"))+5:-9*w.length}).attr("dy",10).attr("id","lblTxt").text(w)}else q.select("text#lblTxt").remove()}}),1==b.density?b.svg.attr("height",30):2==b.density?
b.svg.attr("height",15*(d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).selectAll("g.gene").size()+1)):3==b.density&&b.svg.attr("height",15*(b.trackYMax+1))):"Trx"==b.drawAs&&(b.drawnAs="Trx",b.svg.selectAll(".gene").each(function(){d3.select(this).remove()}),b.svg.selectAll(".trx"+b.gsvg.levelNumber).remove(),a=b.svg.selectAll(".trx"+b.gsvg.levelNumber).data(c,key).attr("transform",function(n,q){return"translate("+b.xScale(n.getAttribute("start"))+","+b.calcY(parseInt(n.getAttribute("start"),
10),parseInt(n.getAttribute("stop"),10),q)+")"}),a.enter().append("g").attr("class",function(n){n=new String(n.parent.getAttribute("ID"));return"trx"+b.gsvg.levelNumber+" gene"+n.replace(".","_")}).attr("transform",function(n,q){return"translate(0,"+b.calcY(parseInt(n.getAttribute("start"),10),parseInt(n.getAttribute("stop"),10),q)+")"}).attr("id",function(n){var q="";1==b.gsvg.levelNumber&&(q="tx");99==b.gsvg.levelNumber&&(q="ttTx");return q+b.cleanID(n.getAttribute("ID"))+b.gsvg.levelNumber}).style("cursor",
"pointer").on("click",function(n){setTimeout(function(){if(0==b.gsvg.levelNumber){var q=(new String(n.parent.getAttribute("ID"))).replace(".","_");b.svg.selectAll("g.trx"+b.gsvg.levelNumber+".selected").selectAll("line").style("stroke",b.color);b.svg.selectAll("g.trx"+b.gsvg.levelNumber+".selected").selectAll("rect").style("fill",b.color);b.svg.selectAll("g.trx"+b.gsvg.levelNumber+".selected").selectAll("text").style("opacity","0.6").style("fill",b.color);b.svg.selectAll("g.trx"+b.gsvg.levelNumber+
".selected").each(function(){var u=new String($(this).attr("class"));u=u.replace(" selected","");$(this).attr("class",u)});b.svg.selectAll("g.gene"+q).each(function(){var u=$(this).attr("class")+" selected";$(this).attr("class",u)});b.svg.selectAll("g.gene"+q).selectAll("line").style("stroke","green");b.svg.selectAll("g.gene"+q).selectAll("rect").style("fill","green");b.svg.selectAll("g.gene"+q).selectAll("text").style("opacity","0.3").style("fill","green");b.setupDetailedView(n.parent)}},10)}).on("dblclick",
b.zoomToFeature).on("mouseover",function(n){if(0===b.gsvg.isToolTip){if(0===b.gsvg.levelNumber&&"undefined"!==typeof n.parent){var q=(new String(n.parent.getAttribute("ID"))).replace(".","_");b.svg.selectAll("g.gene"+q).selectAll("line").style("stroke","green");b.svg.selectAll("g.gene"+q).selectAll("rect").style("fill","green");b.svg.selectAll("g.gene"+q).selectAll("text").style("opacity","0.3").style("fill","green")}else d3.select(this).selectAll("line").style("stroke","green"),d3.select(this).selectAll("rect").style("fill",
"green"),d3.select(this).selectAll("text").style("opacity","0.3").style("fill","green");tt.transition().duration(200).style("opacity",1);tt.html(b.createToolTip(n)).style("left",function(){return b.positionTTLeft(d3.event.pageX)}).style("top",function(){return b.positionTTTop(d3.event.pageY)});b.triggerTableFilter(n);if("undefined"!==typeof n){if(-1===b.trackClass.indexOf("smallnc"))b.setupToolTipSVG(n,.05);else{q=toolTipSVG("div#ttSVG",450,parseInt(n.getAttribute("start"),10)-10,parseInt(n.getAttribute("stop"),
10)+10,99,b.getDisplayID(n.getAttribute("ID")),"");q.xMin=parseInt(n.getAttribute("start"),10)-20;q.xMax=parseInt(n.getAttribute("stop"),10)+20;var u=[];u[0]=n;q.addTrack(b.trackClass,2,"",u)}tt.style("top",function(){return b.positionTTTop(d3.event.pageY)})}}}).on("mouseout",function(n){if(-1==(new String(d3.select(this).attr("class"))).indexOf("selected"))if(0==b.gsvg.levelNumber){var q=(new String(n.parent.getAttribute("ID"))).replace(".","_");b.svg.selectAll("g.gene"+q).selectAll("line").style("stroke",
b.color);b.svg.selectAll("g.gene"+q).selectAll("rect").style("fill",b.color);b.svg.selectAll("g.gene"+q).selectAll("text").style("opacity","0.6").style("fill",b.color)}else d3.select(this).selectAll("line").style("stroke",b.color),d3.select(this).selectAll("rect").style("fill",b.color),d3.select(this).selectAll("text").style("opacity","0.6").style("fill",b.color);tt.transition().delay(500).duration(200).style("opacity",0);b.clearTableFilter(n)}).merge(a).each(b.drawTrx),a.exit().remove(),a,1==b.density?
b.svg.attr("height",30):2==b.density?b.svg.attr("height",15*(d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).selectAll("g.trx"+b.gsvg.levelNumber).size()+1)):3==b.density&&b.svg.attr("height",15*(b.trackYMax+1))));""!=selectGene&&b.setSelected(selectGene);b.redrawSelectedArea();b.drawAs=d};b.redrawLegend=function(){var a=[],d=0;"Trx"===b.drawAs&&("braincoding"===b.trackClass?"Rn"===organism&&(a[d]={color:"#7EB5D6",label:"All"},d++,a[d]={color:"#5E95FF",label:"BN-Lx"},d++,a[d]={color:"#BE95B6",
label:"SHR"},d++):"brainnoncoding"===b.trackClass?"Rn"===organism&&(a[d]={color:"#CECFCE",label:"All"},d++,a[d]={color:"#3E75FF",label:"BN-Lx"},d++,a[d]={color:"#FE7596",label:"SHR"},d++):"liverTotal"===b.trackClass?(a[d]={color:"#bbbedd",label:"All"},d++,a[d]={color:"#9b9eFF",label:"BN-Lx"},d++,a[d]={color:"#Fb9eBd",label:"SHR"},d++):"heartTotal"===b.trackClass?(a[d]={color:"#DC7252",label:"All"},d++,a[d]={color:"#BC5292",label:"BN-Lx"},d++,a[d]={color:"#FF5232",label:"SHR"},d++):"mergedTotal"!==
b.trackClass&&"brainTotal"===b.trackClass&&(a[d]={color:"#7EB5D6",label:"All"},d++,a[d]={color:"#5E95FF",label:"BN-Lx"},d++,a[d]={color:"#BE95B6",label:"SHR"},d++));"brainsmallnc"===b.trackClass?(a[d]={color:"#3E7596",label:"All"},d++,a[d]={color:"#1E55D6",label:"BN-Lx"},d++,a[d]={color:"#7E5576",label:"SHR"}):"heartsmallnc"===b.trackClass?(a[d]={color:"#9C3212",label:"All"},d++,a[d]={color:"#7C1252",label:"BN-Lx"},d++,a[d]={color:"#DC1200",label:"SHR"}):"liversmallnc"===b.trackClass&&(a[d]={color:"#7b7e9d",
label:"All"},d++,a[d]={color:"#5b5eDd",label:"BN-Lx"},d++,a[d]={color:"#bb5e7d",label:"SHR"});b.drawLegend(a)};b.triggerTableFilter=function(a){var d=jQuery.Event("keyup");d.which=32;var c="";"undefined"!==typeof a.getAttribute&&"undefined"!==typeof a.getAttribute("ID")&&(c=b.getDisplayID(a.getAttribute("ID")));-1==b.trackClass.indexOf("smallnc")?$("#tblGenes"+b.trackClass+"_filter input").val(c).trigger(d):$("#tblsmGenes_filter input").val(c).trigger(d)};b.clearTableFilter=function(a){a=jQuery.Event("keyup");
a.which=32;"smallnc"!=b.trackClass?$("#tblGenes"+b.trackClass+"_filter input").val("").trigger(a):$("#tblsmGenes_filter input").val("").trigger(a)};b.updateSettingsFromUI=function(){0<$("#"+b.trackClass+"Dense"+b.level+"Select").length&&(b.density=$("#"+b.trackClass+"Dense"+b.level+"Select").val(),"string"===typeof b.density&&(b.density=parseInt(b.density)));0<$("#"+b.trackClass+"Version"+b.level+"Select").length&&(b.reqDataVer=$("#"+b.trackClass+"Version"+b.level+"Select").val())};b.savePrevious=
function(){b.prevSetting={};b.prevSetting.density=b.density;b.prevSetting.dataVer=b.dataVer};b.revertPrevious=function(){b.density=b.prevSetting.density;b.dataVer=b.prevSetting.dataVer};b.updateSettings=function(a){};b.generateTrackSettingString=function(){return b.trackClass+","+b.density+","+b.dataVer+";"};b.redrawLegend();b.draw(m);return b}
...
b.update=function(a){a=b.xScale.domain()[0];var d=b.xScale.domain()[1];b.loadedDataMin<=a&&d<=b.loadedDataMax?b.redraw():b.updateFullData(0,0)};b.updateFullData=function(a,d){var c=b.xScale.domain()[0],g=b.xScale.domain()[1],e=g-c;b.showLoading();if(0===a||1==d)b.bin=b.calculateBin(e);e="Total";2===b.countType&&(e="Norm");var h=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+b.gsvg.folderName+"/tmp/"+c+"_"+g+".count."+b.trackClass+"."+e+".xml";0<b.bin&&(c-=2*b.bin,c-=c%(2*b.bin),g+=2*
b.bin,g+=2*b.bin-g%(2*b.bin),h=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+b.gsvg.folderName+"/tmp/"+c+"_"+g+".bincount."+b.bin+"."+b.trackClass+"."+e+".xml");d3.xml(h,function(l,n){if(l){console.log("error:"+b.bin+":"+h);if(0==a||1==d)l="/"+pathPrefix,pathPrefix||(l=""),tmpPanel=panel,-1<b.trackClass.indexOf("-")&&(tmpPanel=b.trackClass.substr(b.trackClass.indexOf("-")+1)),$.ajax({url:l+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:c,maxCoord:g,
panel:tmpPanel,rnaDatasetID,arrayTypeID,myOrganism:organism,genomeVer,track:b.trackClass,folder:b.gsvg.folderName,binSize:b.bin,countType:b.countType},dataType:"json",success:function(q){gtag("event","generateTrackCount",{event_category:"browser"})},error:function(q,u,v){}});8>a?b.fullDataTimeOutHandle=setTimeout(function(){b.updateFullData(a+1,0)},1E3):30>a?b.fullDataTimeOutHandle=setTimeout(function(){b.updateFullData(a+1,0)},2E3):38>a?b.fullDataTimeOutHandle=setTimeout(function(){b.updateFullData(a+
