...
var mmVer='Mouse(<span id="verSelect"></span>) Strain:C57BL/6J',rnVer='Rat(<span id="verSelect"></span>) Strain:BN',siteVer="PhenoGen v3.7.6(1/12/2020)",trackBinCutoff=1E4,customTrackLevel=-1,mouseTTOver=0,ttHideHandle=0,tt=d3.select("body").append("div").attr("class","testToolTip").style("z-index",1001).style("opacity",0);tt.append("span").style("float","right").append("img").attr("src","web/images/icons/close.png").on("click",function(){tt.style("opacity",0)});
...
g,l,11)},5E3);else{var C=E.documentElement.getElementsByTagName("probe");try{z=ProbeTrack(c,C,e,"Affy Exon 1.0 ST Probe Sets",g+","+l),c.addTrackList(z)}catch(H){}}});else if("helicos"===e||-1<e.indexOf("illuminaTotal")||-1<e.indexOf("illuminaSmall")||"illuminaPolyA"===e){w=c.xScale.domain()[0];A=c.xScale.domain()[1];var B=calculateBin(A-w,c.width);p=l.split(",");y="Total";var G=1;2<p.length?(h=1*p[1],2===h&&(y="Norm",G=2)):y="";p=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+
"/tmp/"+w+"_"+A+".count."+e+"."+y+".xml";0<B&&(w-=w%B,A+=B-A%B,p=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/tmp/"+w+"_"+A+".bincount."+B+"."+e+"."+y+".xml");d3.xml(p,function(D,E){if(D){if(0===m||3===m){var z="/"+pathPrefix;pathPrefix||(z="");tmpPanel=panel;-1<e.indexOf("-")&&(tmpPanel=e.substr(e.indexOf("-")+1));$.ajax({url:z+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:w,maxCoord:A,panel:tmpPanel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,
myOrganism:organism,genomeVer:genomeVer,track:e,folder:c.folderName,binSize:B,countType:G},dataType:"json",success:function(H){gtag("event","generateTrack"+e,{event_category:"browser"})},error:function(H,I,J){}});z=1E4}60>m?(z=1E3,0===m&&(z=2500),setTimeout(function(){c.addTrack(e,g,l,m+1)},z)):(d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+
e),"#Level"+c.levelNumber+e))}else if(null==E)4<=m?(z=[],"helicos"==e?C=HelicosTrack(c,z,e,g):"illuminaTotal"==e?C=IlluminaTotalTrack(c,z,e,g):"illuminaSmall"==e?C=IlluminaSmallTrack(c,z,e,g):"illuminaPolyA"==e?C=IlluminaPolyATrack(c,z,e,g):"liverilluminaTotalPlus"==e?C=LiverIlluminaTotalPlusTrack(c,z,e,g):"liverilluminaTotalMinus"==e?C=LiverIlluminaTotalMinusTrack(c,z,e,g):"heartilluminaTotalPlus"==e?C=HeartIlluminaTotalPlusTrack(c,z,e,g):"heartilluminaTotalMinus"==e?C=HeartIlluminaTotalMinusTrack(c,
...
function CountTrack(q,n,r,u,f){var b=Track(q,n,r,"Generic Counts");b.loadedDataMin=b.xScale.domain()[0];b.loadedDataMax=b.xScale.domain()[1];b.dataFileName=b.trackClass;b.scaleMin=1;b.scaleMax=5E3;b.graphColorText="steelblue";b.colorScale=d3.scaleLinear().domain([b.scaleMin,b.scaleMax]).range(["#EEEEEE","#000000"]);b.ttSVG=1;b.data=n;b.density=u;b.prevDensity=u;b.countType=1;b.displayBreakDown=null;q=b.gsvg.xScale.domain()[0];q=b.gsvg.xScale.domain()[1]-q;console.log(b.trackClass+":"+f);f=f.split(",");
console.log(f);1<f.length&&(tmp=f[0].split(":"),b.scaleMin=1*tmp[0],b.scaleMax=1*tmp[1],console.log("scale:"+b.scaleMin+":"+b.scaleMax));2<f.length&&(b.countType=1*f[1],console.log("countType:"+b.countType));b.fullDataTimeOutHandle=0;b.ttTrackList=[];-1<r.indexOf("illuminaSmall")?(b.ttTrackList.push("ensemblsmallnc"),b.ttTrackList.push("brainsmallnc"),b.ttTrackList.push("liversmallnc"),b.ttTrackList.push("heartsmallnc")):(b.ttTrackList.push("ensemblcoding"),b.ttTrackList.push("braincoding"),b.ttTrackList.push("liverTotal"),
b.ttTrackList.push("heartTotal"),b.ttTrackList.push("mergedTotal"),b.ttTrackList.push("refSeq"),b.ttTrackList.push("ensemblnoncoding"),b.ttTrackList.push("brainnoncoding"),b.ttTrackList.push("probe"),b.ttTrackList.push("polyASite"),b.ttTrackList.push("spliceJnct"),b.ttTrackList.push("liverspliceJnct"),b.ttTrackList.push("heartspliceJnct"));b.ttTrackList.push("repeatMask");b.calculateBin=function(a){a=new String(Math.floor(a/b.gsvg.width));a=a.substr(0,1)*Math.pow(10,a.length-1);a=Math.floor(a/2);
5>a&&(a=0);return a};b.bin=b.calculateBin(q);b.color=function(a){var d="#FFFFFF";a.getAttribute("count")>=b.scaleMin&&(d=d3.rgb(b.colorScale(a.getAttribute("count"))));return d};b.redraw=function(){var a=b.gsvg.xScale.domain()[0],d=b.gsvg.xScale.domain()[1];b.xScale(a+b.bin);b.xScale(a);b.prevMinCoord=a;b.prevMaxCoord=d;a=b.xScale.domain()[0];d=b.xScale.domain()[1];for(var c=[],h=0,e=0,g=0;g<b.data.length;g++)if("undefined"!==typeof b.data[g]){var l=parseInt(b.data[g].getAttribute("start"),10),m=
parseInt(b.data[g].getAttribute("stop"),10),p=parseInt(b.data[g].getAttribute("count"),10);if(1!=b.density||1==b.density&&l!=m)if(g+1<b.data.length){if(m=parseInt(b.data[g+1].getAttribute("start"),10),l>=a&&l<=d||m>=a&&m<=d)c[h]=b.data[g],p>e&&(e=p),h++}else l>=a&&l<=d&&(c[h]=b.data[g],p>e&&(e=p),h++)}1==b.density?(b.density!=b.prevDensity?(b.redrawLegend(),d=b.gsvg.xScale.domain()[1],b.prevDensity=b.density,b.svg.selectAll(".area").remove(),b.svg.selectAll("g.y").remove(),b.svg.selectAll(".grid").remove(),
...
function CircRNATrack(q,n,r,u,f,b){var a=GenericTranscriptTrack(q,n,r,u,f,b);q=b.split(",");a.density=f;0<q.length&&(a.dataFileName=q[0].substr(9));a.colorBy=1<q.length?q[1]:"Score";2<q.length&&(a.minValue=q[2]);3<q.length&&(a.maxValue=q[3]);4<q.length&&(a.minColor=q[4]);5<q.length&&(a.maxColor=q[5]);a.colorValueField="score";a.minFeatureWidth=1;a.updateControl=0;a.xmlTag="Gene";a.xmlTagBlockElem="Block";a.idPrefix="cirRNA";a.xCirLineWidth=4;a.xPadding=7;a.featureHeight=30;"Score"==a.colorBy&&a.createColorScale();
...
c>=a.xScale.domain()[1]){d=Math.round(a.xScale(d));0>d&&(d=0);c=Math.round(a.xScale(c));c>=a.gsvg.width&&(c=a.gsvg.width-1);h=d-a.xPadding;0>h&&(h=0);var e=c+a.xPadding;e>=a.gsvg.width&&(e=a.gsvg.width-1);for(var g=0,l=h;l<=e;l++)a.yMaxArr[l]>g&&(g=a.yMaxArr[l]);g++;var m=g;if(a.yArr.length<=g)for(a.yArr[m]=[],l=0;l<a.gsvg.width;l++)a.yArr[m][l]=0;l=g-a.scanBackYLines;1>l&&(l=1);m=0;for(var p=l;p<g&&0==m;p++){var t=0;for(l=h;l<=e&&0==t;l++)a.yArr[p][l]>t&&(t=1);0==t&&(g=p,m=1)}g>a.trackYMax&&(a.trackYMax=
...
a.xScale(d.getAttribute("start"));h.append("line").attr("x1",g).attr("x2",l).attr("y1",20).attr("y2",20).attr("stroke",a.color).attr("stroke-width","2").attr("id",function(v,y){var w=a.idPrefix+"Int"+exList[e-1].getAttribute("ID")+"_"+exList[e].getAttribute("ID");null==exList[e].getAttribute("ID")&&(w=a.idPrefix+"Int"+v.getAttribute("ID")+"_"+(e-1)+"_"+e);return w});var m=">";"-"===d.getAttribute("strand")&&(m="<");var p=m;l-=g;var t=0;if(7>l)p="";else for(l-=7;8<l;)0==t?(p+=" ",t=1):(p+=m,t=0),l-=
...
{color:"#5D576B",label:"Array"},{color:"#7A9D98",label:"Array/Predicted"}])};return a}window.GenomeSVG=GenomeSVG;var reportSelectedTrack=null,loadedTrackTable=null,regionDetailLoaded={};$(document).on("click","span.detailMenu",function(q){q=$(this).attr("name");var n=$("span.detailMenu.selected").attr("name");$("div#"+n).hide();$("span.detailMenu.selected").removeClass("selected");$("span[name='"+q+"']").addClass("selected");$("div#"+q).show();if("undefined"!==typeof svgList[0]){n=svgList[0].xScale.domain()[0];var r=svgList[0].xScale.domain()[1];loadRegionReport(q,chr,n,r)}});
