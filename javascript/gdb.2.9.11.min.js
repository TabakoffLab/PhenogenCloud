...
var mmVer='Mouse(<span id="verSelect"></span>) Strain:C57BL/6J',rnVer='Rat(<span id="verSelect"></span>) Strain:BN',siteVer="PhenoGen v3.7.8(5/25/2021)",trackBinCutoff=1E4,customTrackLevel=-1,mouseTTOver=0,ttHideHandle=0,tt=d3.select("body").append("div").attr("class","testToolTip").style("z-index",1001).style("opacity",0);tt.append("span").style("float","right").append("img").attr("src","web/images/icons/close.png").on("click",function(){tt.style("opacity",0)});
...
g,l,11)},5E3);else{z="rn5"===genomeVer?E.documentElement.getElementsByTagName("smnc"):E.documentElement.getElementsByTagName("Gene");try{C=GeneTrack(c,z,e,"Small RNA (<200 bp) Genes",l),c.addTrackList(C),""!=selectGene&&C.setSelected(selectGene)}catch(I){}}});else if(0===e.indexOf("liverTotal")||"heartTotal"===e||0===e.indexOf("brainTotal")||"mergedTotal"===e){var v="Liver Reconstructed";"heartTotal"===e?v="Heart Reconstructed":"brainTotal"===e?v="Whole Brain Reconstructed":"mergedTotal"===e&&(v=
"Merged (Brain,Heart,Liver) Reconstructed");if((0===e.indexOf("liverTotal")||0===e.indexOf("brainTotal"))&&0<e.indexOf("_")){var y=e.substr(e.indexOf("_")+1);v="LEStm"===y?"LE-Stm "+v:"F344Stm"===y?"F344-Stm "+v:v+" v"+y}d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/"+e+".xml",function(D,E){if(D){if(1===m&&("mergedTotal"===e||0===e.indexOf("liverTotal")||0===e.indexOf("brainTotal"))){var z=c.xScale.domain()[0],C=c.xScale.domain()[1],H="/"+pathPrefix;pathPrefix||
(H="");var I=panel;(0===e.indexOf("liverTotal")||0===e.indexOf("brainTotal"))&&0<e.indexOf("_")&&(I=e.substr(e.indexOf("_")+1),"LEStm"===I&&(I="LE-Stm"),"F344Stm"===I&&(I="F344-Stm"));$.ajax({url:H+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:z,maxCoord:C,panel:I,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:e,folder:c.folderName},dataType:"json",success:function(J){gtag("event","generateTrack"+e,{event_category:"browser"})},
error:function(J,K,L){}})}60>m?(z=1500,1==m&&(z=2500),setTimeout(function(){c.addTrack(e,g,l,m+1)},z)):(d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==E)11<=m?(z=[],C=GeneTrack(c,z,e,v,l),c.addTrackList(C)):setTimeout(function(){c.addTrack(e,g,l,11)},5E3);else{z=E.documentElement.getElementsByTagName("Gene");
H=0;I=E.documentElement.getElementsByTagName("GeneList");0<I.length&&"undefined"!==typeof I[0].getAttribute("ver")&&(H=I[0].getAttribute("ver"));try{C=GeneTrack(c,z,e,v,l),C.dataVer=H,c.addTrackList(C),""!=selectGene&&C.setSelected(selectGene)}catch(J){}}})}else if(0===e.indexOf("refSeq")){$("#"+e+c.levelNumber+"Select").val();var w=c.xScale.domain()[0],A=c.xScale.domain()[1];p=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/"+e+".xml";d3.xml(p,function(D,E){if(D){console.log(D);
if(0===m){var z="/"+pathPrefix;pathPrefix||(z="");$.ajax({url:z+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:w,maxCoord:A,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:e,folder:c.folderName},dataType:"json",success:function(H){gtag("event","generateTrack"+e,{event_category:"browser"})},error:function(H,I,J){}})}60>m?(z=1500,1===m&&(z=2500),setTimeout(function(){c.addTrack(e,g,l,m+1)},z)):(d3.select("#Level"+
c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==E)if(11<=m){z=[];var C=RefSeqTrack(c,z,e,"Ref Seq Genes",l);c.addTrackList(C)}else setTimeout(function(){c.addTrack(e,g,l,11)},5E3);else{z=E.documentElement.getElementsByTagName("Gene");try{C=RefSeqTrack(c,z,e,"Ref Seq Genes",l),c.addTrackList(C)}catch(H){console.log(H)}}})}else if(0==
e.indexOf("snp"))w=c.xScale.domain()[0],A=c.xScale.domain()[1],p=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/"+e+".xml",d3.xml(p,function(D,E){if(D){console.log(D);if(0==m){var z="/"+pathPrefix;pathPrefix||(z="");$.ajax({url:z+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:w,maxCoord:A,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:e,folder:c.folderName},dataType:"json",success:function(H){gtag("event",
"generateTrack"+e,{event_category:"browser"})},error:function(H,I,J){}})}60>m?(z=1500,1===m&&(z=2500),setTimeout(function(){c.addTrack(e,g,l,m+1)},z)):(d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==E)if(11<=m){z=[];var C=SNPTrack(c,z,e,g,l);c.addTrackList(C)}else setTimeout(function(){c.addTrack(e,
g,l,11)},5E3);else{z=E.documentElement.getElementsByTagName("Snp");try{C=SNPTrack(c,z,e,g,l),c.addTrackList(C)}catch(H){}}});else if("qtl"===e)d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/qtl.xml",function(D,E){if(D)if(60>m){var z=1500;1===m&&(z=2500);setTimeout(function(){c.addTrack(e,g,l,m+1)},z)}else d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+
c.levelNumber+e),"#Level"+c.levelNumber+e);else if(null==E)if(11<=m){z=[];var C=QTLTrack(c,z,e,g);c.addTrackList(C)}else setTimeout(function(){c.addTrack(e,g,l,11)},5E3);else{z=E.documentElement.getElementsByTagName("QTL");try{C=QTLTrack(c,z,e,g),c.addTrackList(C)}catch(H){}}});else if("trx"===e)y=getAllChildrenByName(getFirstChildByName(c.selectedData,"TranscriptList"),"Transcript"),p=TranscriptTrack(c,y,e,g),c.addTrackList(p);else if("probe"===e||"probeMouse"==e)d3.xml(dataPrefix+"tmpData/browserCache/"+
genomeVer+"/regionData/"+c.folderName+"/probe.xml",function(D,E){if(D)if(60>m){var z=1500;1===m&&(z=2500);setTimeout(function(){c.addTrack(e,g,l,m+1)},z)}else d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e);else if(null==E)11<=m?(C=[],z=ProbeTrack(c,C,e,"Affy Exon 1.0 ST Probe Sets",g+","+l),c.addTrackList(z)):setTimeout(function(){c.addTrack(e,
g,l,11)},5E3);else{var C=E.documentElement.getElementsByTagName("probe");try{z=ProbeTrack(c,C,e,"Affy Exon 1.0 ST Probe Sets",g+","+l),c.addTrackList(z)}catch(H){}}});else if("helicos"===e||-1<e.indexOf("illuminaTotal")||-1<e.indexOf("illuminaSmall")||"illuminaPolyA"===e){w=c.xScale.domain()[0];A=c.xScale.domain()[1];var B=calculateBin(A-w,c.width);p=[];l&&(0<l.indexOf(",")?p=l.split(","):p[0]=l);y="Total";var G=1;2<p.length&&(h=1*p[1],2===h&&(y="Norm",G=2));p=dataPrefix+"tmpData/browserCache/"+genomeVer+
"/regionData/"+c.folderName+"/tmp/"+w+"_"+A+".count."+e+"."+y+".xml";0<B&&(w-=w%B,A+=B-A%B,p=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/tmp/"+w+"_"+A+".bincount."+B+"."+e+"."+y+".xml");d3.xml(p,function(D,E){if(D){if(0===m||3===m){var z="/"+pathPrefix;pathPrefix||(z="");tmpPanel=panel;-1<e.indexOf("-")&&(tmpPanel=e.substr(e.indexOf("-")+1));$.ajax({url:z+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:w,maxCoord:A,panel:tmpPanel,rnaDatasetID:rnaDatasetID,
arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:e,folder:c.folderName,binSize:B,countType:G},dataType:"json",success:function(H){gtag("event","generateTrack"+e,{event_category:"browser"})},error:function(H,I,J){}});z=1E4}60>m?(z=1E3,0===m&&(z=2500),setTimeout(function(){c.addTrack(e,g,l,m+1)},z)):(d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+
c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==E)4<=m?(z=[],"helicos"==e?C=HelicosTrack(c,z,e,g):"illuminaTotal"==e?C=IlluminaTotalTrack(c,z,e,g):"illuminaSmall"==e?C=IlluminaSmallTrack(c,z,e,g):"illuminaPolyA"==e?C=IlluminaPolyATrack(c,z,e,g):"liverilluminaTotalPlus"==e?C=LiverIlluminaTotalPlusTrack(c,z,e,g):"liverilluminaTotalMinus"==e?C=LiverIlluminaTotalMinusTrack(c,z,e,g):"heartilluminaTotalPlus"==e?C=HeartIlluminaTotalPlusTrack(c,z,e,g):"heartilluminaTotalMinus"==e?C=HeartIlluminaTotalMinusTrack(c,
z,e,g):"brainilluminaTotalPlus"==e?C=BrainIlluminaTotalPlusTrack(c,z,e,g):"brainilluminaTotalMinus"==e?C=BrainIlluminaTotalMinusTrack(c,z,e,g):"liverilluminaSmall"==e?C=LiverIlluminaSmallTrack(c,z,e,g):"heartilluminaSmall"==e?C=HeartIlluminaSmallTrack(c,z,e,g):-1<e.indexOf("illuminaTotal")&&(C=StrainSpecificIlluminaTotalTrack(c,z,e,g,l)),c.addTrackList(C)):setTimeout(function(){c.addTrack(e,g,l,4)},3E3);else{z=E.documentElement.getElementsByTagName("Count");var C;try{"helicos"===e?C=HelicosTrack(c,
z,e,g):"illuminaTotal"===e?C=IlluminaTotalTrack(c,z,e,g):"illuminaSmall"===e?C=IlluminaSmallTrack(c,z,e,g):"illuminaPolyA"===e?C=IlluminaPolyATrack(c,z,e,g):"liverilluminaTotalPlus"===e?C=LiverIlluminaTotalPlusTrack(c,z,e,g):"liverilluminaTotalMinus"===e?C=LiverIlluminaTotalMinusTrack(c,z,e,g):"heartilluminaTotalPlus"===e?C=HeartIlluminaTotalPlusTrack(c,z,e,g):"heartilluminaTotalMinus"===e?C=HeartIlluminaTotalMinusTrack(c,z,e,g):"brainilluminaTotalPlus"===e?C=BrainIlluminaTotalPlusTrack(c,z,e,g):
"brainilluminaTotalMinus"===e?C=BrainIlluminaTotalMinusTrack(c,z,e,g):"liverilluminaSmall"===e?C=LiverIlluminaSmallTrack(c,z,e,g):"heartilluminaSmall"===e?C=HeartIlluminaSmallTrack(c,z,e,g):-1<e.indexOf("illuminaTotal")&&(C=StrainSpecificIlluminaTotalTrack(c,z,e,g,l)),c.addTrackList(C)}catch(H){}}})}else if(-1<e.indexOf("spliceJnct")){w=c.xScale.domain()[0];A=c.xScale.domain()[1];p=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/"+e+".xml";var F="Brain ";"liverspliceJnct"==
e?F="Liver ":"heartspliceJnct"==e&&(F="Heart ");d3.xml(p,function(D,E){if(D){console.log(D);if(0==m){var z="/"+pathPrefix;pathPrefix||(z="");$.ajax({url:z+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:w,maxCoord:A,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:e,folder:c.folderName},dataType:"json",success:function(H){gtag("event","generateTrack"+e,{event_category:"browser"})},error:function(H,I,J){}})}60>
m?(z=1500,1===m&&(z=2500),setTimeout(function(){c.addTrack(e,g,l,m+1)},z)):(d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==E)if(11<=m){z=[];var C=SpliceJunctionTrack(c,z,e,F+"Splice Junctions",1,"");c.addTrackList(C)}else setTimeout(function(){c.addTrack(e,g,l,11)},5E3);else{z=E.documentElement.getElementsByTagName("Feature");
console.log(z);try{C=SpliceJunctionTrack(c,z,e,F+"Splice Junctions",3,""),c.addTrackList(C)}catch(H){console.log(H)}}})}else if("polyASite"==e)d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+"/polyASite.xml",function(D,E){if(D)if(60>m){var z=1E3;1===m&&(z=2500);setTimeout(function(){c.addTrack(e,g,l,m+1)},z)}else d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+
c.levelNumber+e),"#Level"+c.levelNumber+e);else if(null==E)if(4<=m){z=[];var C=PolyATrack(c,z,e,"Predicted PolyA Sites",l);c.addTrackList(C)}else setTimeout(function(){c.addTrack(e,g,l,4)},5E3);else{z=E.documentElement.getElementsByTagName("Feature");try{C=PolyATrack(c,z,e,"Predicted PolyA Sites",l),c.addTrackList(C)}catch(H){}}});else if(0===e.indexOf("repeatMask"))$("#"+e+c.levelNumber+"Select").val(),w=c.xScale.domain()[0],A=c.xScale.domain()[1],p=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+
...
(z=2500),setTimeout(function(){c.addTrack(e,g,l,m+1)},z)):(d3.select("#Level"+c.levelNumber+e).select("#trkLbl").text("An errror occurred loading Track:"+e),d3.select("#Level"+c.levelNumber+e).attr("height",15),c.addTrackErrorRemove(d3.select("#Level"+c.levelNumber+e),"#Level"+c.levelNumber+e))}else if(null==E)if(11<=m){z=[];var C=RepeatMaskTrack(c,z,e,"Repeat Masker",g,l);c.addTrackList(C)}else setTimeout(function(){c.addTrack(e,g,l,11)},5E3);else{z=E.documentElement.getElementsByTagName("Feature");
try{C=RepeatMaskTrack(c,z,e,"Repeat Masker",g,l),c.addTrackList(C)}catch(H){console.log(H)}}});else if(0==e.indexOf("custom"))if(p=trackInfo[e],l=l+",Name="+p.Name,l="DataFile="+p.Location+","+l,"bed"==p.Type||"bb"==p.Type)y=[],p=CustomTranscriptTrack(c,y,e,p.Name,3,l),c.addTrackList(p),p.updateFullData(0,0);else{if("bg"==p.Type||"bw"==p.Type)y=[],p=CustomCountTrack(c,y,e,3,l),c.addTrackList(p)}else 0<=e.indexOf("cirRNA")&&(p=trackInfo[e],p=CircRNATrack(c,y,e,p.Name,3,l),c.addTrackList(p));$(".sortable"+
...
g){0<g?d3.select("#"+e+"Scroll").style("max-height",g+"px").style("overflow","auto"):d3.select("#"+e+"Scroll").style("max-height","none").style("overflow","hidden")};c.removeAllTracks=function(){d3.selectAll("li.draggable"+c.levelNumber).remove();c.trackList=[];setTimeout(function(){DisplayRegionReport()},300);gtag("event",c.levelNumber,{event_category:"SVGremoveAllTracks"})};c.removeTrack=function(e){d3.select("#Level"+c.levelNumber+e).remove();for(var g=0;g<c.trackList.length;g++)"undefined"!==
typeof c.trackList[g]&&c.trackList[g].trackClass==e&&(c.trackList.splice(g,1),c.trackCount--);c.trackListHash[e]=void 0;setTimeout(function(){DisplayRegionReport()},300);gtag("event",c.levelNumber,{event_category:"removeTrack",event_label:e})};c.redrawTrack=function(e){for(var g=0;g<c.trackList.length;g++)"undefined"!==typeof c.trackList[g]&&c.trackList[g].trackClass==e&&c.trackList[g].redraw();setTimeout(function(){DisplayRegionReport()},300)};c.redraw=function(){for(var e=0;e<c.trackList.length;e++)"undefined"!==
...
.3);c.scaleSVG.append("text").attr("id","zoomTextStart").attr("x",c.downZoomx).attr("y",15).text(numberWithCommas(Math.round(c.xScale.invert(c.downZoomx))));c.scaleSVG.append("text").attr("id","zoomTextEnd").attr("x",c.downZoomx).attr("y",50).text(numberWithCommas(Math.round(c.xScale.invert(c.downZoomx))))}else 0==processAjax&&(c.prevMinCoord=c.xScale.domain()[0],c.prevMaxCoord=c.xScale.domain()[1],e=d3.mouse(c.vis.node()),c.downx=c.xScale.invert(e[0]),c.downscalex=c.xScale)};c.forceDrawAs=function(e){for(var g=
0;g<c.trackList.length;g++)"undefined"!==typeof c.trackList[g]&&"undefined"!==typeof c.trackList[g].drawAs&&(c.trackList[g].drawAs=e,c.trackList[g].draw(c.trackList[g].data));c.forceDrawAsValue=e};c.resize=function(e){c.width=e;c.xScale.range([0,c.width]);c.xAxis=d3.axisTop(c.xScale).ticks(6).tickSize(8).tickPadding(10);c.scaleSVG.attr("width",c.width);c.scaleSVG.select(".x.axis").call(c.xAxis);d3.select("#Level"+c.levelNumber).select(".axisLbl").attr("x",(c.width-2*c.margin)/2);c.topLevel.style("width",
c.width+18+"px");for(var g=0;g<c.trackList.length;g++)"undefined"!==typeof c.trackList[g]&&"undefined"!==typeof c.trackList[g].redraw&&c.trackList[g].resize();c.selectSvg.width=e;c.selectSvg.draw()};c.updateCountScales=function(e,g){for(var l=0;l<c.trackList.length;l++)"undefined"!==typeof c.trackList[l]&&"undefined"!==typeof c.trackList[l].updateCountScale&&c.trackList[l].updateCountScale(e,g)};c.resetDefaultMouse=function(e){var g="/web/images/icons/"+e+"_dark.png";d3.select("span#"+e+c.levelNumber+
" img").attr("src",g);d3.select("span#"+e+c.levelNumber).style("background","#DCDCDC")};c.changeTrackCursor=function(e){for(var g=0;g<c.trackList.length;g++)"undefined"!==typeof c.trackList[g]&&"undefined"!==typeof c.trackList[g].svg&&c.trackList[g].svg.style("cursor",e)};c.changeScaleCursor=function(e){"undefined"!==typeof c.scaleSVG&&c.scaleSVG.style("cursor",e)};c.updateTrackSelectedArea=function(e,g){c.selectionStart=e;c.selectionEnd=g;var l=c.xScale(e),m=c.xScale(g)-l;c.scaleSVG.selectAll("rect.selectedArea").remove();
if((0<l||0<l+m)&&l<c.width)for(1>m&&(m=1),c.scaleSVG.append("rect").attr("class","selectedArea").attr("x",l).attr("y",15).attr("height",c.scaleSVG.attr("height")-15).attr("width",m).attr("fill","#CECECE").attr("opacity",.3).attr("pointer-events","none"),l=0;l<c.trackList.length;l++)"undefined"!==typeof c.trackList[l]&&"undefined"!==typeof c.trackList[l].setSelectedArea&&c.trackList[l].setSelectedArea(e,g)};c.getAddMenus=function(){var e="/"+pathPrefix;""==pathPrefix&&(e="");$.ajax({url:e+"trackMenu.jsp",
type:"GET",cache:!1,data:{level:c.levelNumber,organism:organism},dataType:"html",success:function(g){$("#trackMenu"+c.levelNumber).remove();d3.select("div#trackMenu").append("div").attr("id","trackMenu"+c.levelNumber);$("#trackMenu"+c.levelNumber).html(g)},error:function(g,l,m){$("#trackMenu"+c.levelNumber).remove();d3.select("div#trackMenu").append("div").attr("id","trackMenu"+c.levelNumber);$("#trackMenu"+c.levelNumber).append('<div class="viewsLevel'+c.levelNumber+'">An error occurred generating this menu.  Please try back later.</div>')},
async:!1});$.ajax({url:e+"viewMenu.jsp",type:"GET",cache:!1,data:{level:c.levelNumber,organism:organism},dataType:"html",success:function(g){$("#viewMenu"+c.levelNumber).remove();d3.select("div#viewMenu").append("div").attr("id","viewMenu"+c.levelNumber);$("#viewMenu"+c.levelNumber).html(g)},error:function(g,l,m){$("#viewMenu"+c.levelNumber).remove();d3.select("div#viewMenu").append("div").attr("id","viewMenu"+c.levelNumber);$("#viewMenu"+c.levelNumber).append('<div class="viewsLevel'+c.levelNumber+
'">An error occurred generating this menu.  Please try back later.</div>')},async:!1})};c.zoomMenuChange=function(e){d3.select("#zoomSelectMenu"+c.levelNumber).selectAll("li").style("background","#FFFFFF");c.zoomFactor=parseFloat(d3.select(e).attr("value"));d3.select(e).style("background","#CECECE")};c.setupFunctionBar=function(){d3.selectAll("span.shrt-button").on("click",function(){nameSpan=d3.select(this).attr("name");-1<nameSpan.toLowerCase().indexOf("gene")?(console.log(":"+selectedID+":"),""!==
selectedID?($("div#selectedDetail").is(":visible")||0!==selectedID.indexOf("ENS")||c.getTrack("ensemblcoding").setSelected(selectedID),$("span[name='"+nameSpan+"']").click(),$("html, body").animate({scrollTop:$("#selectedReport").offset().top},1E3)):alert("You must select a gene from an Ensembl Track before clicking on the gene shortcut.")):($("span.closeDetail").click(),$("span#"+nameSpan).click(),$("html, body").animate({scrollTop:$("#regionDiv").offset().top},1E3))});d3.select(q).select("#functLevel"+
c.levelNumber).remove();c.functionBar=c.vis.append("div").attr("class","functionBar").attr("id","functLevel"+c.levelNumber).style("float","left");var e=c.functionBar.append("div").attr("class","defaultMouse").attr("id","defaultMouse"+c.levelNumber);e.append("span").attr("id","dragzoom"+c.levelNumber).style("height","24px").style("display","inline-block").style("cursor","pointer").append("img").attr("class","mouseOpt dragzoom").attr("src","/web/images/icons/dragzoom_dark.png").attr("pointer-events",
...
e=l=l.substr(l.indexOf(",")+1));if("genomeSeq"===c){var p=SequenceTrack(d,c,"Reference Genomic Sequence",e);p.seqRegionSize=10;d.addTrackList(p)}else if(-1<c.indexOf("noncoding"))p=GeneTrack(d,g,c,"Non-Coding/Non-PolyA+ Transcripts",e),d.addTrackList(p);else if(-1<c.indexOf("coding"))p=GeneTrack(d,g,c,"Protein Coding/PolyA+ Transcripts",e),d.addTrackList(p);else if(0===c.indexOf("liverTotal")||"heartTotal"===c||0===c.indexOf("brainTotal")||"mergedTotal"===c)h="Liver Total RNA Transcripts","heartTotal"===
c?h="Heart Total RNA Transcripts":"brainTotal"===c?h="Brain Total RNA Transcripts":"mergedTotal"===c&&(h="Merged (Brain,Heart,Liver) Reconstructed"),p=GeneTrack(d,g,c,h,e),d.addTrackList(p);else if(-1<c.indexOf("smallnc"))p=GeneTrack(d,g,c,"Small RNA (<200 bp) Genes",e),d.addTrackList(p);else if(0===c.indexOf("refSeq"))99===d.levelNumber&&(e+="DrawTrx,"),p=RefSeqTrack(d,g,c,"Ref Seq Genes",e),p.density=99===d.levelNumber?2:h,d.addTrackList(p);else if(0===c.indexOf("snp"))p=SNPTrack(d,g,c,1,"4"),d.addTrackList(p);
else if("qtl"===c)p=QTLTrack(d,g,c,1),d.addTrackList(p);else if("trx"===c)g=getAllChildrenByName(getFirstChildByName(d.selectedData,"TranscriptList"),"Transcript"),p=TranscriptTrack(d,g,c,h),d.addTrackList(p);else if("probe"===c||"probeMouse"===c)99!==d.levelNumber&&(e=h+","+e),p=ProbeTrack(d,g,c,"Affy Exon 1.0 ST Probe Sets",e),d.addTrackList(p);else if(-1<c.indexOf("spliceJnct"))e="Brain ","liverspliceJnct"===c?e="Liver ":"heartspliceJnct"===c&&(e="Heart "),p=SpliceJunctionTrack(d,g,c,e+"Splice Junctions",
3,""),100===d.levelNumber&&(p.density=h),d.addTrackList(p);else if("polyASite"===c)p=PolyATrack(d,g,c,"Predicted PolyA Sites",e),d.addTrackList(p);else if("helicos"===c||-1<c.indexOf("illuminaTotal")||-1<c.indexOf("illuminaSmall")||"illuminaPolyA"===c){d.updateTimeoutHandle[c]&&(d.updateTimeoutHandle[c]=-1);h=2;l=l.split(",");1<l.length&&(1===l[1]||2===l[1])&&(h=l[1]);"helicos"===c?p=HelicosTrack(d,g,c,h):"illuminaTotal"===c?p=IlluminaTotalTrack(d,g,c,h):"illuminaSmall"===c?p=IlluminaSmallTrack(d,
g,c,h):"illuminaPolyA"===c?p=IlluminaPolyATrack(d,g,c,h):"liverilluminaTotalPlus"===c?p=LiverIlluminaTotalPlusTrack(d,g,c,h):"liverilluminaTotalMinus"===c?p=LiverIlluminaTotalMinusTrack(d,g,c,h):"heartilluminaTotalPlus"===c?p=HeartIlluminaTotalPlusTrack(d,g,c,h):"heartilluminaTotalMinus"===c?p=HeartIlluminaTotalMinusTrack(d,g,c,h):"brainilluminaTotalPlus"===c?p=BrainIlluminaTotalPlusTrack(d,g,c,h):"brainilluminaTotalMinus"===c?p=BrainIlluminaTotalMinusTrack(d,g,c,h):"liverilluminaSmall"===c?p=LiverIlluminaSmallTrack(d,
g,c,h):"heartilluminaSmall"===c?p=HeartIlluminaSmallTrack(d,g,c,h):-1<c.indexOf("illuminaTotal")&&(p=StrainSpecificIlluminaTotalTrack(d,g,c,h,e));if(99===d.levelNumber){if(0!==d.updateTimeoutHandle[c]){clearTimeout(d.updateTimeoutHandle[c]);try{clearTimeout(d.timeoutTrack[c].fullDataTimeOutHandle)}catch(t){}d.updateTimeoutHandle[c]=0}d.updateTimeoutHandle[c]=setTimeout(function(){p.updateFullData(0,1);d.timeoutTrack[c]=p;d.updateTimeoutHandle[c]=0},300)}d.addTrackList(p)}else if(0===c.indexOf("repeatMask"))p=
RepeatMaskTrack(d,g,c,"Repeat Masker",1,e),d.addTrackList(p);else if(-1<c.indexOf("custom"))if(h=trackInfo[c],e="DataFile="+h.Location+","+e,"bed"===h.Type||"bb"===h.Type)g=[],p=CustomTranscriptTrack(d,g,c,h.Name,3,e),d.addTrackList(p);else{if("bg"===h.Type||"bw"===h.Type)g=[],p=CustomCountTrack(d,g,c,3,e),d.addTrackList(p)}else 0<=c.indexOf("cirRNA")&&(h=trackInfo[c],g=[],p=CircRNATrack(d,g,c,h.Name,3,e),d.addTrackList(p));$(".sortable"+d.levelNumber).sortable("refresh")};d.addTrackList=function(c){null!=
...
(m=getFirstChildByName(getFirstChildByName(h[l],"annotationList"),"annotation"),null!=m&&(d+=" - "+m.getAttribute("reason")))),d+="<br>",0===g.length)for(m=getAllChildrenByName(getFirstChildByName(h[l],"annotationList"),"annotation"),p=0;p<m.length&&0===g.length;p++)"AKA"===m[p].getAttribute("source")&&(g=m[p].getAttribute("annot_value"),g=(new String(g)).split(":"),g=0!==(new String(g[g.length-1])).indexOf("ENS")?g[g.length-1]:g[0]);h='<BR><div id="ttSVG" style="background:#FFFFFF;overflow:scroll;max-height:400px;"></div>Gene ID: '+
...
"annotationList"),"annotation"),p=0;p<m.length&&0===g.length;p++)if("AKA"===m[p].getAttribute("source")){var t=m[p].getAttribute("annot_value");t=(new String(t)).split(":");1<=t.length?(g=t[0],h=h+" ("+g+")"):2<=t.length&&(g=t[0],t=t[1],h=h+" ("+t+")")}}e=parseInt(a.getAttribute("start"),10);m=parseInt(a.getAttribute("stop"),10);a.getAttribute("extStart")&&a.getAttribute("extStop")&&(e=parseInt(a.getAttribute("extStart"),10),m=parseInt(a.getAttribute("extStop"),10));svgViewIDList[d]||(svgViewIDList[d]=
...
rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:e,folder:b.gsvg.folderName},dataType:"json",success:function(p){gtag("event","generateTrackGene",{event_category:"browser"})},error:function(p,t,v){}})}10>a?(h=2E3,1===a&&(h=5E3),setTimeout(function(){b.updateData(a+1)},h)):(d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).select("#trkLbl").text("An errror occurred loading Track:"+b.trackClass),d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).attr("height",
...
panel:l,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:c,folder:b.gsvg.folderName},dataType:"json",success:function(m){gtag("event","generateTrackGene",{event_category:"browser"})},error:function(m,p,t){}})}5>d?(g=1E4,0===d&&(g=5E3),setTimeout(function(){b.updateDataVersion(a,d+1)},g)):(d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).select("#trkLbl").text("An errror occurred loading Track:"+b.trackClass),d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).attr("height",
...
function(A){return b.xScale(exList[g-1].getAttribute("stop"))}).attr("x2",function(A){return b.xScale(exList[g].getAttribute("start"))}).attr("y1",5).attr("y2",5).attr("id",function(A){return"Int"+exList[g-1].getAttribute("ID")+"_"+exList[g].getAttribute("ID")}).attr("stroke",b.color).attr("stroke-width","2"),"1"==a.getAttribute("strand")||"-1"==a.getAttribute("strand"))){l=">";if("-1"==a.getAttribute("strand")||"-"==a.getAttribute("strand"))l="<";m=l;p=b.xScale(exList[g-1].getAttribute("stop"));
t=b.xScale(exList[g].getAttribute("start"))-p;v=0;if(7>t)m="";else for(t-=7;8<t;)0==v?(m+=" ",v=1):(m+=l,v=0),t-=7;e.append("svg:text").attr("id",function(A){return"IntTxt"+exList[g-1].getAttribute("ID")+"_"+exList[g].getAttribute("ID")}).attr("dx",p+1).attr("dy","11").style("pointer-events","none").style("opacity","0.5").style("fill",b.color).style("font-size","16px").text(m)}}if(2==b.density){var w=a.getAttribute("ID");"undefined"!==typeof a.getAttribute("geneSymbol")&&0<a.getAttribute("geneSymbol").length&&
...
2,"DrawTrx",g);for(g=0;g<b.ttTrackList.length;g++)if(b.trackClass!==b.ttTrackList[g]){var l=b.gsvg.getTrackData(b.ttTrackList[g]),m=[];if("undefined"!==typeof l&&0<l.length){for(var p=0,t=0;t<l.length;t++)if(c<=parseInt(l[t].getAttribute("start"),10)&&parseInt(l[t].getAttribute("start"),10)<=h||c<=parseInt(l[t].getAttribute("stop"),10)&&parseInt(l[t].getAttribute("stop"),10)<=h||parseInt(l[t].getAttribute("start"),10)<=c&&parseInt(l[t].getAttribute("stop"),10)>=c)m[p]=l[t],p++;0<m.length&&e.addTrack(b.ttTrackList[g],
...
"selected"!==d3.select(this).attr("class")&&d3.select(this).style("fill",b.color);tt.transition().delay(500).duration(200).style("opacity",0);b.clearTableFilter(m)}),a.exit().remove(),d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).selectAll("g.gene").each(function(m){if(m){var p=d3.select(this);if("-1"==m.getAttribute("strand")||"1"==m.getAttribute("strand")){var t=">";"-1"==m.getAttribute("strand")&&(t="<");var v=t,y=p.select("rect").attr("width");if(8.5>y)v="";else for(y-=8.5,v=t;8.7<y;)v+=
...
p){return"translate("+b.xScale(m.getAttribute("start"))+","+b.calcY(parseInt(m.getAttribute("start"),10),parseInt(m.getAttribute("stop"),10),p)+")"}),a.enter().append("g").attr("class",function(m){m=new String(m.parent.getAttribute("ID"));return"trx"+b.gsvg.levelNumber+" gene"+m.replace(".","_")}).attr("transform",function(m,p){return"translate(0,"+b.calcY(parseInt(m.getAttribute("start"),10),parseInt(m.getAttribute("stop"),10),p)+")"}).attr("id",function(m){var p="";1==b.gsvg.levelNumber&&(p="tx");
99==b.gsvg.levelNumber&&(p="ttTx");return p+b.cleanID(m.getAttribute("ID"))+b.gsvg.levelNumber}).style("cursor","pointer").on("click",function(m){setTimeout(function(){if(0==b.gsvg.levelNumber){var p=(new String(m.parent.getAttribute("ID"))).replace(".","_");b.svg.selectAll("g.trx"+b.gsvg.levelNumber+".selected").selectAll("line").style("stroke",b.color);b.svg.selectAll("g.trx"+b.gsvg.levelNumber+".selected").selectAll("rect").style("fill",b.color);b.svg.selectAll("g.trx"+b.gsvg.levelNumber+".selected").selectAll("text").style("opacity",
...
10)-parseInt(c[e].getAttribute("start"),10))+" bp)";return d=d+"<BR>Intron: "+numberWithCommas(parseInt(c[1].getAttribute("start"),10)-parseInt(c[0].getAttribute("stop"),10))+" bp<BR>"};q.drawScaleLegend("1","1000+","Read Counts","#E6E6E6","#000000",0);q.draw(n);return q}
...
function displayDetailedView(q){reportSelectedTrack=q;$("li.report").removeClass("selected");$("li."+q.trackClass).addClass("selected");q.displayBreakDown&&setTimeout(function(){$("div#trackGraph").html("");q.displayBreakDown("div#collapsableReport div#trackGraph")},50);var n=new String(q.trackClass);-1<n.indexOf("coding")||-1<n.indexOf("noncoding")||-1<n.indexOf("smallnc")||-1<n.indexOf("liverTotal")||-1<n.indexOf("heartTotal")||-1<n.indexOf("brainTotal")||-1<n.indexOf("mergedTotal")||"qtl"==n?($("#regionTableSubHeader").show(),
