...
g,l,11)},5E3);else{var C=E.documentElement.getElementsByTagName("probe");try{z=ProbeTrack(c,C,e,"Affy Exon 1.0 ST Probe Sets",g+","+l),c.addTrackList(z)}catch(H){}}});else if("helicos"===e||-1<e.indexOf("illuminaTotal")||-1<e.indexOf("illuminaSmall")||"illuminaPolyA"===e){w=c.xScale.domain()[0];A=c.xScale.domain()[1];var B=calculateBin(A-w,c.width);p=l.split(",");y="Total";var G=1;2<p.length&&(h=1*p[1],2===h&&(y="Norm",G=2));p=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+c.folderName+
