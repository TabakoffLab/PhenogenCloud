...
var mmVer='Mouse(<span id="verSelect"></span>) Strain:C57BL/6J',rnVer='Rat(<span id="verSelect"></span>) Strain:BN',siteVer="PhenoGen v3.7.1(1/17/2020)",trackBinCutoff=1E4,customTrackLevel=-1,mouseTTOver=0,ttHideHandle=0,tt=d3.select("body").append("div").attr("class","testToolTip").style("z-index",1001).style("opacity",0);tt.append("span").style("float","right").append("img").attr("src","web/images/icons/close.png").on("click",function(){tt.style("opacity",0)});
...
function back(f){if(history&&history[f]){var e=1<history[f].length?history[f].pop():history[f][0];chr==e.chr&&(e.start==svgList[f].xScale.domain()[0]&&e.stop==svgList[f].xScale.domain()[1]&&(e=1<history[f].length?history[f].pop():history[f][0]),0==f&&$("#geneTxt").val(e.chr+":"+e.start+"-"+e.stop),svgList[f].xScale.domain([e.start,e.stop]),svgList[f].scaleSVG.select(".x.axis").call(svgList[f].xAxis),svgList[f].redraw(),0===f&&updatePage(svgList[f]),svgList[f].updateFullData())}ga&&ga("send","event",
"stepBackSVGNaviation","navigateBack")}
...
f&&updatePage(svgList[f]);svgList[f].updateFullData();0===f&&setTimeout(function(){DisplayRegionReport()},100)},300);0===f&&$("#geneTxt").val(chr+":"+l.start+"-"+l.stop);ga&&ga("send","event","calledZoomIn",f)}
...
svgList[f].updateFullData();0===f&&setTimeout(function(){DisplayRegionReport()},100)},300);0===f&&$("#geneTxt").val(chr+":"+l.start+"-"+l.stop);ga&&ga("send","event","calledZoomOut",f)}
...
(c=","===c.substr(c.length-1)?c+"DrawTrx,":c+",DrawTrx,");var m=new String(d.folderName);if(0>m.indexOf(chr)||0>m.indexOf(d.xScale.domain()[0]+"_")||0>m.indexOf("_"+d.xScale.domain()[1]))d.folderName="/"+chr+"/"+d.xScale.domain()[0]+"_"+d.xScale.domain()[1],0==d.levelNumber&&regionfolderName!=d.folderName&&(regionfolderName=d.folderName),$.ajax({url:pathPrefix+"getFullPath.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:d.xScale.domain()[0],maxCoord:d.xScale.domain()[1],panel:panel,
...
else if(-1<a.indexOf("smallnc"))d3.xml(dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+d.folderName+"/"+a+".xml",function(m,p){if(m){if(0===g){var h=d.xScale.domain()[0],q=d.xScale.domain()[1],e="/"+pathPrefix;pathPrefix||(e="");$.ajax({url:e+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:h,maxCoord:q,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:a,folder:d.folderName},dataType:"json",success:function(a){ga&&
ga("send","event","browser","generateTrackRefseq")},error:function(a,b,d){}})}60>g?(h=1500,1==g&&(h=2500),setTimeout(function(){d.addTrack(a,b,c,g+1)},h)):(d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+a),"#Level"+d.levelNumber+a))}else if(null==p)11<=g?(h=[],q=GeneTrack(d,h,a,"Small RNA (<200 bp) Genes",c),d.addTrackList(q)):setTimeout(function(){d.addTrack(a,
...
if(0===g){var h="/"+pathPrefix;pathPrefix||(h="");$.ajax({url:h+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:e,maxCoord:t,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:a,folder:d.folderName},dataType:"json",success:function(a){ga&&ga("send","event","browser","generateTrackRefseq")},error:function(a,b,d){}})}60>g?(h=1500,1===g&&(h=2500),setTimeout(function(){d.addTrack(a,b,c,g+1)},h)):(d3.select("#Level"+
...
a.indexOf("snp"))e=d.xScale.domain()[0],t=d.xScale.domain()[1],q=dataPrefix+"tmpData/browserCache/"+genomeVer+"/regionData/"+d.folderName+"/"+a+".xml",d3.xml(q,function(m,p){if(m){console.log(m);if(0==g){var h="/"+pathPrefix;pathPrefix||(h="");$.ajax({url:h+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:e,maxCoord:t,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:a,folder:d.folderName},dataType:"json",success:function(a){ga&&
ga("send","event","browser","generateTrackSNP")},error:function(a,b,d){}})}60>g?(h=1500,1===g&&(h=2500),setTimeout(function(){d.addTrack(a,b,c,g+1)},h)):(d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+a),"#Level"+d.levelNumber+a))}else if(null==p)if(11<=g){h=[];var q=SNPTrack(d,h,a,b,c);d.addTrackList(q)}else setTimeout(function(){d.addTrack(a,
...
success:function(a){ga&&ga("send","event","browser","generateTrackCounts")},error:function(a,b,d){}});h=1E4}60>g?(h=1E3,0===g&&(h=2500),setTimeout(function(){d.addTrack(a,b,c,g+1)},h)):(d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+a),d3.select("#Level"+d.levelNumber+a).attr("height",15),d.addTrackErrorRemove(d3.select("#Level"+d.levelNumber+a),"#Level"+d.levelNumber+a))}else if(null==p)4<=g?(h=[],"helicos"==a?q=HelicosTrack(d,h,a,b):"illuminaTotal"==
...
"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:e,maxCoord:t,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:a,folder:d.folderName},dataType:"json",success:function(a){ga&&ga("send","event","browser","generateTrackSpliceJnct")},error:function(a,b,d){}})}60>g?(p=1500,1===g&&(p=2500),setTimeout(function(){d.addTrack(a,b,c,g+1)},p)):(d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+
...
(p="");$.ajax({url:p+"generateTrackXML.jsp",type:"GET",cache:!1,async:!0,data:{chromosome:chr,minCoord:e,maxCoord:t,panel:panel,rnaDatasetID:rnaDatasetID,arrayTypeID:arrayTypeID,myOrganism:organism,genomeVer:genomeVer,track:a,folder:d.folderName},dataType:"json",success:function(a){ga&&ga("send","event","browser","generateTrackRepeatMask")},error:function(a,b,d){}})}60>g?(p=1500,1===g&&(p=2500),setTimeout(function(){d.addTrack(a,b,c,g+1)},p)):(d3.select("#Level"+d.levelNumber+a).select("#trkLbl").text("An errror occurred loading Track:"+
...
"hidden")};d.removeAllTracks=function(){d3.selectAll("li.draggable"+d.levelNumber).remove();d.trackList=[];setTimeout(function(){DisplayRegionReport()},300);ga&&ga("send","event","SVGremoveAllTracks",d.levelNumber)};d.removeTrack=function(a){d3.select("#Level"+d.levelNumber+a).remove();for(var b=0;b<d.trackList.length;b++)"undefined"!==typeof d.trackList[b]&&d.trackList[b].trackClass==a&&(d.trackList.splice(b,1),d.trackCount--);d.trackListHash[a]=void 0;setTimeout(function(){DisplayRegionReport()},
300);ga&&ga("send","event","removeTrack",d.levelNumber,a)};d.redrawTrack=function(a){for(var b=0;b<d.trackList.length;b++)"undefined"!==typeof d.trackList[b]&&d.trackList[b].trackClass==a&&d.trackList[b].redraw();setTimeout(function(){DisplayRegionReport()},300)};d.redraw=function(){for(var a=0;a<d.trackList.length;a++)"undefined"!==typeof d.trackList[a]&&"undefined"!==typeof d.trackList[a].redraw&&d.trackList[a].redraw();d.selectSvg.redraw()};d.update=function(){for(var a=0;a<d.trackList.length;a++)"undefined"!==
typeof d.trackList[a].update&&d.trackList[a].update();setTimeout(function(){DisplayRegionReport()},300);ga&&ga("send","event","gsvgUpdate","genomeSVG.update")};d.updateData=function(){for(var a=0;a<d.trackList.length;a++)"undefined"!==typeof d.trackList[a]&&"undefined"!==typeof d.trackList[a].updateData&&d.trackList[a].updateData(0);d.updateFullData();setTimeout(function(){DisplayRegionReport()},300);ga&&ga("send","event","gsvgUpdateData","genomeSVG.updateData")};d.updateFullData=function(){-1<(new String(d.folderName)).indexOf("img")&&
(d.folderName="/"+chr+"/"+d.xScale.domain()[0]+"_"+d.xScale.domain()[1],0==d.levelNumber&&regionfolderName!=d.folderName&&(regionfolderName=d.folderName),setTimeout(function(){DisplayRegionReport()},300));for(var a=0;a<d.trackList.length;a++)"undefined"!==typeof d.trackList[a]&&"undefined"!==typeof d.trackList[a].updateFullData&&d.trackList[a].updateFullData(0,1);ga&&ga("send","event","gsvgUpdateFullData","genomeSVG.updateFullData")};d.setLoading=function(){for(var a=0;a<d.trackList.length;a++)"undefined"===
typeof d.trackList[a]||"undefined"===typeof d.trackList[a].updateData&&"undefined"===typeof d.trackList[a].updateFullData||d.trackList[a].showLoading()};d.clearSelection=function(){d.selectionStart=-1;d.selectionEnd=-1;d.scaleSVG.selectAll("rect.selectedArea").remove();d.selectSvg.setVis(!1);for(var a=0;a<d.trackList.length;a++)"undefined"!==typeof d.trackList[a]&&"undefined"!==typeof d.trackList[a].clearSelection&&d.trackList[a].clearSelection()};d.mdown=function(){if(0==d.overSettings)if("dragzoom"!==
d.defaultMouseFunct&&d3.event.altKey||"dragzoom"===d.defaultMouseFunct&&!d3.event.altKey){var a=d3.mouse(d.vis.node());d.downZoomx=a[0];d.scaleSVG.append("rect").attr("class","zoomRect").attr("x",a[0]).attr("y",0).attr("height",d.scaleSVG.attr("height")).attr("width",1).attr("fill","#CECECE").attr("opacity",.3);d.scaleSVG.append("text").attr("id","zoomTextStart").attr("x",d.downZoomx).attr("y",15).text(numberWithCommas(Math.round(d.xScale.invert(d.downZoomx))));d.scaleSVG.append("text").attr("id",
"zoomTextEnd").attr("x",d.downZoomx).attr("y",50).text(numberWithCommas(Math.round(d.xScale.invert(d.downZoomx))))}else 0==processAjax&&(d.prevMinCoord=d.xScale.domain()[0],d.prevMaxCoord=d.xScale.domain()[1],a=d3.mouse(d.vis.node()),d.downx=d.xScale.invert(a[0]),d.downscalex=d.xScale)};d.forceDrawAs=function(a){for(var b=0;b<d.trackList.length;b++)"undefined"!==typeof d.trackList[b]&&"undefined"!==typeof d.trackList[b].drawAs&&(d.trackList[b].drawAs=a,d.trackList[b].draw(d.trackList[b].data));d.forceDrawAsValue=
a};d.resize=function(a){d.width=a;d.xScale.range([0,d.width]);d.xAxis=d3.axisTop(d.xScale).ticks(6).tickSize(8).tickPadding(10);d.scaleSVG.attr("width",d.width);d.scaleSVG.select(".x.axis").call(d.xAxis);d3.select("#Level"+d.levelNumber).select(".axisLbl").attr("x",(d.width-2*d.margin)/2);d.topLevel.style("width",d.width+18+"px");for(var b=0;b<d.trackList.length;b++)"undefined"!==typeof d.trackList[b]&&"undefined"!==typeof d.trackList[b].redraw&&d.trackList[b].resize();d.selectSvg.width=a;d.selectSvg.draw()};
...
1)):3==b.density&&b.svg.attr("height",15*(b.trackYMax+1));else if(1==c||"Trx"==b.drawAs)b.svg.selectAll("g.trx"+b.gsvg.levelNumber).attr("transform",function(a,c){return"translate(0,"+b.calcY(parseInt(a.getAttribute("start"),10),parseInt(a.getAttribute("stop"),10),c)+")"}).each(function(a,c){var d=parseInt(a.getAttribute("cdsStart"),10),g=parseInt(a.getAttribute("cdsStop"),10);exList=getAllChildrenByName(getFirstChildByName(a,"exonList"),"exon");var m="";1==b.gsvg.levelNumber&&(m="tx");for(var p=
0;p<exList.length;p++){var e=parseInt(exList[p].getAttribute("start"),10),f=parseInt(exList[p].getAttribute("stop"),10);if(e<d&&d<f||f>g&&g>e){var l=e,n=d;f>g?(l=g,n=f,f=g):e=d;d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).select("g#"+m+b.cleanID(a.getAttribute("ID"))+" rect#ExNC"+exList[p].getAttribute("ID")).attr("x",function(a){return b.xScale(l)}).attr("width",function(a){return b.xScale(n)-b.xScale(l)})}d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).select("g#"+m+b.cleanID(a.getAttribute("ID"))+
" rect#Ex"+exList[p].getAttribute("ID")).attr("x",function(a){return b.xScale(e)}).attr("width",function(a){return b.xScale(f)-b.xScale(e)});if(0<p){var y=b.xScale(exList[p-1].getAttribute("stop")),E=b.xScale(exList[p].getAttribute("start"));if("1"==a.getAttribute("strand")||"-1"==a.getAttribute("strand")||"-"==a.getAttribute("strand")||"+"==a.getAttribute("strand")){var F=">";"-1"==a.getAttribute("strand")&&(F="<");var B=F,D=E-y,C=0;if(7>D)B="";else for(D-=7;8<D;)0==C?(B+=" ",C=1):(B+=F,C=0),D-=
7;d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).select("g#"+m+b.cleanID(a.getAttribute("ID"))+" #IntTxt"+exList[p-1].getAttribute("ID")+"_"+exList[p].getAttribute("ID")).attr("dx",y+1).text(B)}d3.select("#Level"+b.gsvg.levelNumber+b.trackClass).select("g#"+m+b.cleanID(a.getAttribute("ID"))+" line#Int"+exList[p-1].getAttribute("ID")+"_"+exList[p].getAttribute("ID")).attr("x1",y).attr("x2",E)}}}),1==b.density?b.svg.attr("height",30):2==b.density?b.svg.attr("height",15*(d3.select("#Level"+b.gsvg.levelNumber+
...
b.trackClass))}else if(m){h=m.documentElement.getElementsByTagName("Gene");for(var p=[],e=[],f=0,l=0;l<h.length;l++)h[l]&&(p[f]=h[l],p[f].setAttribute("ID",f),e[h[l].getAttribute("geneSymbol")]=1,f++);for(l=0;l<b.data.length;l++)b.data[l]&&!e[b.data[l].getAttribute("geneSymbol")]&&(p[f]=b.data[l],p[f].setAttribute("ID",f),f++);b.draw(p);b.hideLoading();b.getDisplayedData();setTimeout(function(){DisplayRegionReport()},300)}else b.updateData(a+1),b.hideLoading()})};b.drawTrx=function(a,c){var d=parseInt(a.getAttribute("cdsStart"),
...
1E4):(d3.select("#Level"+b.levelNumber+b.trackClass).select("#trkLbl").text("An errror occurred loading Track:"+b.trackClass),d3.select("#Level"+b.levelNumber+b.trackClass).attr("height",15),b.gsvg.addTrackErrorRemove(b.svg,"#Level"+b.gsvg.levelNumber+b.trackClass),b.hideLoading(),b.fullDataTimeOutHandle=setTimeout(function(){b.updateFullData(a+1,0)},15E3))}else null==m?32<=a?(p=[],b.draw(p)):b.fullDataTimeOutHandle=setTimeout(function(){b.updateFullData(a+1,0)},5E3):(b.fullDataTimeOutHandle=0,b.loadedDataMin=
d,b.loadedDataMax=g,p=m.documentElement.getElementsByTagName("Count"),b.draw(p),b.updateControl=0)})}};b.updateLabel(f);b.redrawLegend();b.redraw();return b}
...
e.trackList[b].Organism.toUpperCase()!==organism.toUpperCase()||0!==$("table#trackListTbl"+e.level+" tr#trk"+e.trackList[b].TrackID).length||(n[c]=e.trackList[b],c++);try{$.fn.DataTable.isDataTable("table#trkSelList"+e.level)&&e.trackDataTable.destroy()}catch(a){}"custom"===f&&0===n.length?($("#noCustomTracks").show(),0===uid?$("#notSignedIn1").show():$("#notSignedIn1").hide()):($("#noCustomTracks").hide(),$("#notSignedIn1").hide());d3.select("table#trkSelList"+e.level).select("tbody").selectAll("tr").remove();
d3.select("table#trkSelList"+e.level).select("tbody").selectAll("tr").data(n).enter().append("tr").attr("id",function(a){return"trk"+a.TrackID}).attr("class",function(a,b){var c="odd";0===b%2&&(c="even");return c}).each(function(a,b){var c="",g="";"local"===a.Source&&(g=" (Local)");0!==a.UserID&&(c=new String(a.SetupDate),c=c.substr(0,c.indexOf(":",c.indexOf(":")+1)),c="<BR><BR>File:"+a.OriginalFile+"<BR><BR>Setup Date:"+c+"<BR><BR>Type:"+a.Type,"local"===a.Source&&(c+="<BR><BR>Local Track only available on this computer."));
c='  <span class="trlisttooltip'+e.level+'" title= "'+a.Description+c+'"><img src="'+iconPath+'info.gif"></span>';d3.select(this).append("td").html(a.Name+g+c);g="";"RN"===a.Organism?g="Rat":"MM"===a.Organism&&(g="Mouse");c="Public";0!==a.UserID&&(c="Custom");d3.select(this).append("td").html(g);d3.select(this).append("td").html(a.GenericCategory);d3.select(this).append("td").html(a.Category);d3.select(this).append("td").html(c)});$.fn.DataTable.isDataTable("table#trkSelList"+e.level)||(f=e.getInitTrackTableHeight(n),
e.trackDataTable=$("table#trkSelList"+e.level).DataTable({bPaginate:!1,aaSorting:[[3,"asc"]],sScrollY:f,sDom:'<"rightSearch"fr><t>',columnDefs:[{width:"45%",targets:0}]}));e.trackDataTable.draw();$("td#selectedTrack"+e.level).hide();$("table#trkSelList"+e.level+" tbody").on("click","tr",function(){if(!$(this).hasClass("selected")){$("table#trkSelList"+e.level+" tbody tr.selected").removeClass("selected");$(this).addClass("selected");$(this).attr("id");var a=e.findSelectedTrack(),b="Selected Track Name: "+
a.Name+'  <span class="trInfotooltip'+e.level+'" title= "'+a.Description+'"><img src="'+iconPath+'info.gif"></span>';$("div#trackHeaderOuter"+e.level+" #trackHeaderContent").html(b);b=e.getTrackTableHeight(n);e.trackDataTable.settings()[0].oScroll.sy=b;try{e.trackDataTable.columns.adjust().draw()}catch(d){}$("#trkSelList"+e.level+"_wrapper div.dataTables_scroll div.dataTables_scrollBody").css("height",b);$("td#selectedTrack"+e.level).show();$(".trInfotooltip"+e.level).tooltipster({position:"top-right",
maxWidth:250,offsetX:10,offsetY:5,contentAsHTML:!0,interactive:!0,interactiveTolerance:350});e.generatePreview(a);(b=e.previewSVG.getTrack(a.TrackClass))&&b.generateSettingsDiv&&b.generateSettingsDiv("td#selectedTrack"+e.level);$("td#selectedTrack"+e.level+" #trackListTbl"+e.level+" tbody tr:first").remove();$("td#selectedTrack"+e.level+" #trackListTbl"+e.level+" tbody tr:last").remove();0!==a.UserID?$("span#deleteCustomTrack"+e.level).show():$("span#deleteCustomTrack"+e.level).hide();b.updateSettingsFromUI()}});
$(".trlisttooltip"+e.level).tooltipster({position:"top-right",maxWidth:250,offsetX:10,offsetY:5,contentAsHTML:!0,interactive:!0,interactiveTolerance:350})};e.getInitTrackTableHeight=function(e){var f="750px";0===e.length?f="30px":15>e.length&&(f=30*e.length+"px");return f};e.getTrackTableHeight=function(e){var f="300px";0===e.length?f="20px":10>e.length&&(f=30*e.length+"px");return f};e.getTrackData=function(){var f="/"+pathPrefix;""===pathPrefix&&(f="");$.ajax({url:f+"getBrowserTracks.jsp",type:"GET",
data:{genomeVer:genomeVer},dataType:"json",success:function(f){e.trackList=f;if(0===e.level)for(trackInfo=[],f=0;f<e.trackList.length;f++)trackInfo[e.trackList[f].TrackClass]=e.trackList[f];e.readCookieTracks();e.dataInitialized=1;e.generateTrackTable();trackMenu[e.level]&&trackMenu[e.level].readCookieViews&&(trackMenu[e.level].readCookieViews(),trackMenu[e.level].generateViewList())},error:function(e,c,b){}})};e.readCookieTracks=function(){var f="";if(!0===isLocalStorage()){var n=localStorage.getItem("phenogenCustomTracks");
n&&(f=n)}else $.cookie("phenogenCustomTracks")&&(f=$.cookie("phenogenCustomTracks"));if(f&&-1<f.indexOf("<;>"))for(f=f.split("<;>"),n=0;n<f.length;n++){var c=f[n].split("<->"),b={};for(k=0;k<c.length;k++){var a=c[k].split("=");if(2>=a.length)b[a[0]]=a[1];else if(2<a.length){a=c[k].substr(0,c[k].indexOf("="));var g=c[k].substr(c[k].indexOf("=")+1);b[a]=g}}b.Source="local";3<c.length&&(e.trackList.push(b),0===e.level&&(trackInfo[b.TrackClass]=b))}};e.findSelectedTrack=function(){var f=NaN;if(0<$("table#trkSelList"+
e.level+" tbody tr.selected").length){var n=$("table#trkSelList"+e.level+" tbody tr.selected").attr("id");n=n.substr(3);for(var c=0;c<e.trackList.length&&isNaN(f);c++)e.trackList[c].TrackID===n&&(f=e.trackList[c])}return f};e.generateSettingsString=function(e){return e.TrackClass+","+e.Settings+";"};e.generatePreview=function(f){$("div#trackPreviewOuter"+e.level+" div#trackPreviewContent").html("");var l=(new String(organism)).toUpperCase();if("AA"===f.Organism||f.Organism===l){l=svgList[e.level].xScale.domain()[0];
var c=svgList[e.level].xScale.domain()[1];e.previewSVG=toolTipSVG("div#trackPreviewOuter"+e.level+" div#trackPreviewContent",565,l,c,e.previewLevel,chr,svgList[e.level].type);e.previewSVG.folderName=svgList[e.level].folderName;f=e.generateSettingsString(f);loadStateFromString(f,"",e.previewLevel,e.previewSVG);e.previewSVG.updateData();e.previewSVG.updateFullData();$("div#trackPreviewContent div#ScrollLevel"+e.previewLevel).css("max-height","250px").css("overflow","auto")}else $("div#previewOuter"+
e.level+" div#previewContent").html("No Preview Available: The current organism doesn't match the tracks included in this view.")};e.removeTrack=function(f){e.generateTrackTable()};e.confirmdeleteCustomTrack=function(){var f=e.findSelectedTrack();$("#deleteUsrTrack"+e.level).show();$("#selectTrack"+e.level).hide();f="Name: <B>"+f.Name+"</B><BR>Description: <B>"+f.Description+"</B><BR>Original File: <B>"+f.OriginalFile+"</B><BR>Setup Date: <B>"+f.SetupDate+"</b>";$("span#customTrackInfo"+e.level).html(f);
ga&&ga("send","event","BrowserTracks","deleteCustomTrack")};e.cancelDeleteTrack=function(){$("#deleteUsrTrack"+e.level).hide();$("#selectTrack"+e.level).show()};e.deleteTrack=function(){var f=e.findSelectedTrack();if("local"===f.Source){var n="TrackClass="+f.TrackClass+"<->",c="";if(!0===isLocalStorage()){var b=localStorage.getItem("phenogenCustomTracks");b&&(c=b)}else $.cookie("phenogenCustomTracks")&&(c=$.cookie("phenogenCustomTracks"));if(c&&-1<c.indexOf("<;>")){var a="";c=c.split("<;>");for(b=
0;b<c.length;b++)-1===c[b].indexOf(n)&&(a=a+c[b]+"<;>");n="/"+pathPrefix;pathPrefix||(n="");$.ajax({url:n+"removeCustomTrack.jsp",type:"GET",data:{trackID:f.TrackID},dataType:"json",success:function(b){!0===isLocalStorage()?localStorage.setItem("phenogenCustomTracks",a):$.cookie("phenogenCustomTracks",a)},error:function(a,b,c){console.log(c)},async:!1})}}else"db"===f.Source&&(n="/"+pathPrefix,pathPrefix||(n=""),$.ajax({url:n+"deleteTrack.jsp",type:"GET",data:{trackID:f.TrackID},dataType:"json",success:function(a){"true"===
a.success?$(".uploadStatus").html("<B>Track Setup Successfully</B>"):$(".uploadStatus").html("<B>Track Setup Failed</B>")},error:function(a,b,c){console.log(c)},async:!1}));e.getTrackData();$("#deleteUsrTrack"+e.level).hide();$("#selectTrack"+e.level).show();e.generateTrackTable();ga&&ga("send","event","BrowserTracks","deleteTrack")};e.confirmUpload=function(){$("div#confirmUpload"+e.level).show();$("div#uploadBtn"+e.level).hide()};e.confirmBed=function(){$("input#hasconfirmBed"+e.level).val(1);e.createCustomTrack(e.level)};
e.cancelUpload=function(){$("div#confirmUpload"+e.level).hide();$("div#confirmBed"+e.level).hide();$("div#uploadBtn"+e.level).show()};e.createCustomTrack=function(){$("div#confirmUpload"+e.level).hide();customTrackLevel=e.level;var f=$("#usrtrkFileTypeSelect"+e.level).val();"bed"===f||"bg"===f?e.createUploadedCustomTrack():("bb"===f||"bw"===f)&&e.createRemoteCustomTrack();ga&&ga("send","event","BrowserTracks","createCustomTrack")};e.createUploadedCustomTrack=function(){var f=$("input#customUploadFile"+
e.level)[0].files[0],n=$("#usrtrkFileTypeSelect"+e.level).val(),c=f.name,b=f.size/1024/1024;$(".uploadStatus").show();var a="";if(0<c.indexOf(".")){for(var g=c;-1<g.indexOf(".");)g=g.substr(g.indexOf(".")+1);""!==g&&g!==c&&(a=g)}20>b?a!==n?"gz"===a||"tar"===a||"zip"===a||"exe"===a||"bin"===a?(setTimeout(function(){$("div#uploadBtn"+customTrackLevel).show();$(".progressInd").hide()},5E3),$(".uploadStatus").html("Error: Selected File Type is not supported.")):0===$("input#hasconfirmBed"+e.level).val()?
$("div#confirmBed"+customTrackLevel).show():1===$("input#hasconfirmBed"+e.level).val()&&($("div#confirmBed"+customTrackLevel).hide(),e.createTrack(f)):e.createTrack(f):($("div#uploadBtn"+customTrackLevel).show(),$(".progressInd").hide(),$(".uploadStatus").html("File is too large.  20MB is the current limit."))};e.createTrack=function(f){e.readFile(f)};e.createRemoteCustomTrack=function(){$(".uploadStatus").html("Setting up track...");$(".uploadStatus").show();var f=$("#customFileURL"+e.level).val(),
n="",c=new Date;$.cookie("JSESSIONID")&&(n=$.cookie("JSESSIONID"),n=n+"_"+c.getTime());e.saveTrack(n,f)};e.saveTrack=function(f,n){var c=$("#usrtrkNameTxt"+e.level).val(),b=$("#usrtrkDescTxt"+e.level).val(),a=$("#usrtrkOrgSelect"+e.level).val(),g=$("#usrtrkGenCatSelect"+e.level).val(),d=$("#usrtrkCatTxt"+e.level).val(),p="",m=$("#usrtrkFileTypeSelect"+e.level).val(),h="";if("bed"===m||"bg"===m)h=$("input#customUploadFile"+e.level)[0].files[0].name;var l="Color";0<$("#usrtrkColorSelect"+e.level).length&&
(l=$("#usrtrkColorSelect"+e.level).val());if("Score"===l){var t="000000",z="FFFFFF",r=1,w=1E3;testIE||testSafari?(t=$("#usrtrkColorMin"+e.level).spectrum("get").toHexString(),z=$("#usrtrkColorMax"+e.level).spectrum("get").toHexString()):(t=$("#usrtrkColorMin"+e.level).val(),z=$("#usrtrkColorMax"+e.level).val(),console.log(t),console.log(z));t=t.substr(1);z=z.substr(1);r=$("#usrtrkScoreMinTxt"+e.level).val();w=$("#usrtrkScoreMaxTxt"+e.level).val()}"bed"===m?p="Name=View Density;Select:trackSelect:Dense:Select;{Dense:1}{Pack:3}{Full:2};Default=3,Name=Color by;Select:colorSelect::colorSelect;{Feature Defined:Color}{Score based scale:Score};Default="+
l+",Name=Scale Range;Txt:tissuecbx;{min:1}{max:1000};Default="+r+":"+w+",Name=Color Range;Txt:color;{min:FFFFFF}{max:000000};Default="+t+":"+z:"bg"===m?p="Name=View Density;Select:trackSelect:Dense:Select;{Dense:1}{Full:2};Default=1,Name=Scale Range;Slider:rangeslider;{min:1-1000}{max:1000-20000};Default=1:5000":"bw"===m?p="Name=View Density;Select:trackSelect:Dense:Select;{Dense:1}{Full:2};Default=1,Name=Scale Range;Slider:rangeslider;{min:1-1000}{max:1000-20000};Default=1:5000":"bb"===m&&(p="Name=View Density;Select:trackSelect:Dense:Select;{Dense:1}{Pack:3}{Full:2};Default=3,Name=Color by;Select:colorSelect::colorSelect;{Feature Defined:Color}{Score based scale:Score};Default="+
...
(-1<a.indexOf("*")&&(a=a.replace(/\*/g,"star")),-1<a.indexOf(" ")&&(a=a.replace(/\s/g,"_")),-1<a.indexOf(".")&&(a=a.replace(/\./g,"_")));return a};that.setup=function(){that.requestModuleList();that.createImageControls();that.createViewControls();that.createDataControls();$(".wgcnaControltooltip").tooltipster({position:"top-right",maxWidth:250,offsetX:5,offsetY:5,contentAsHTML:!0,interactive:!0,interactiveTolerance:350});ga&&ga("send","event","setupWGCNA","setupWGCNA")};that.requestModuleList=function(){that.moduleGenes=
{};that.moduleList=[];that.modules={};$.ajax({url:pathPrefix+"getWGCNAModules.jsp",type:"GET",async:!0,data:{source:that.selSource,modFileType:that.viewtype,id:that.singleID,organism:organism,panel:that.panel,tissue:that.tissue,region:that.region,geneList:that.geneList,genomeVer:genomeVer,version:that.version},dataType:"json",beforeSend:function(){$("#waitCircos").show();for(var a=0;a<that.moduleRequestList.length;a++)that.moduleRequestList[a].abort();that.moduleRequestList=[];console.log("request mod list:"+
that.wDSID+":"+that.selSource)},success:function(a){$("#wgcnaGeneImage #message").hide();that.moduleList=[];0<a.length&&(1!==a.length||"grey"!==a[0].ModuleID)?setTimeout(function(){for(var b=0;b<a.length;b++)console.log("Mod:"+a[b].ModuleID),"grey"!==a[b].ModuleID&&(that.moduleList.push(a[b].ModuleID),that.requests++,that.requestModule(a[b].ModuleID),"undefined"!==typeof a[b].GeneList&&(that.moduleGenes[a[b].ModuleID]=a[b].GeneList),console.log("after calling:"+that.requests+":"+a[b].ModuleID));that.refreshRegion(1E3);
setTimeout(function(){$("html, body").animate({scrollTop:$("#multiWGCNAScroll").offset().top},100)},1200)},1):0===a.length?that.displayMessage("There are no transcripts with Affymetrix Probesets that represent this gene."):1===a.length&&"grey"===a[0].ModuleID&&that.displayMessage("Only the Grey module contains transcripts for this gene.  The Grey module contains all transcripts that did not have a high enough correlation with any other transcripts to be included in another module.");ga&&ga("send",
"event","requestModuleList","requestModuleList")},error:function(a,b,c){}})};that.displayMessage=function(a){$("#waitCircos").hide();$("#wgcnaGeneImage #message").html("<BR><BR><h2>"+a+"</h2><BR><BR>").show()};that.refreshRegion=function(a){setTimeout(function(){that.createMultiWGCNAImage();0<that.requests?that.refreshRegion(2E3):1!==a&&(that.refreshRegion(1),$("#waitCircos").hide())},a)};that.requestModule=function(a,b){xhr=$.ajax({url:contextRoot+"tmpData/browserCache/"+genomeVer+"/modules/ds"+
that.wDSID+"/"+a+".json",type:"GET",async:!0,data:{},dataType:"json",success:function(c){console.log("success:"+contextRoot+"tmpData/browserCache/"+genomeVer+"/modules/ds"+that.wDSID+"/"+a+".json");if(0<that.singleID.length)that.countGeneInstance(that.singleID,c);else{var d=that.moduleGenes[a].split(",");c.GroupedGenes=d.length;that.countGeneInstance(that.moduleGenes[a],c)}that.modules[a]=c;that.requests--;b&&b(a);ga&&ga("send","event","requestModule",a)},error:function(a,b,c){that.requests--}});
...
(a=$("div#viewGene").html());var b=$(window).width();a=a.replace('width="100%"','width="'+b+'px"');$.ajax({url:pathPrefix+"saveBrowserImage.jsp",type:"POST",contentType:"text/html",data:a+"\n",processData:!1,dataType:"json",success:function(a){var b=new Date;b=b.getMonth()+1+"_"+b.getDate()+"_"+b.getFullYear();var c="http://";"https:"===location.protocol&&(c="https://");var d=c+urlprefix+"/tmpData/download/"+a.imageFile;a="";that.selectedModule&&(a=new String(that.selectedModule.MOD_NAME));a=a+"_"+
that.viewType;var e=a+"_"+b+".png",f=new XMLHttpRequest;f.open("GET",d);f.responseType="blob";f.send();f.onreadystatechange=function(){if(4!=f.readyState||200!=f.status)return!1;var a=document.createElement("a");a.href=window.URL.createObjectURL(f.response);a.download=e;a.style.display="none";document.body.appendChild(a);try{a.click()}catch(r){$("#wgcnaMouseHelp").html("<span style='color:#FF0000;'>Your browser will not save the image directly. Image will open in a popup, in the new window right click to save image.</span>"),
window.open(d)}return!0}},error:function(a,b,c){console.log(c)}});ga&&ga("send","event","saveWGCNAView","saveWGCNAView")}}).on("mouseover",function(){d3.select(this).attr("src",contextRoot+"web/images/icons/savePic_white.png");$("#wgcnaMouseHelp").html("Click to download a PNG image of the current view.")}).on("mouseout",function(){d3.select(this).attr("src",contextRoot+"web/images/icons/savePic_dark.png");$("#wgcnaMouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")});
that.imageBar.append("span").attr("class","reset control").style("display","inline-block").attr("id","wgcnaresetImage").style("cursor","pointer").append("img").attr("src",contextRoot+"web/images/icons/reset_dark.png").attr("pointer-events","all").attr("cursor","pointer").on("click",function(){that.singleImage&&("eqtl"===that.viewType?that.singleImage.panZoomCircos.reset():"undefined"!==typeof that.singleImage&&that.singleImage.panZoom.reset());ga&&ga("send","event","resetWGCNAView","resetWGCNAView")}).on("mouseover",
...
ga&&ga("send","event","zoomInWGCNAView","zoomInWGCNAView")}).on("mouseover",function(){d3.select(this).attr("src",contextRoot+"web/images/icons/magPlus_light_32.png");$("#wgcnaMouseHelp").html("Click to zoom in.")}).on("mouseout",function(){d3.select(this).attr("src",contextRoot+"web/images/icons/magPlus_dark_32.png");$("#wgcnaMouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")});that.imageBar.append("span").attr("class","zoomOut control").style("display",
...
typeof that.singleImage&&"undefined"!==typeof that.singleImage.panZoom&&that.singleImage.panZoom.zoomOut();ga&&ga("send","event","zoomOutWGCNAView","zoomOutWGCNAView")}).on("mouseover",function(){d3.select(this).attr("src",contextRoot+"web/images/icons/magMinus_light_32.png");$("#wgcnaMouseHelp").html("Click to zoom out.")}).on("mouseout",function(){d3.select(this).attr("src",contextRoot+"web/images/icons/magMinus_dark_32.png");$("#wgcnaMouseHelp").html("Navigation Hints: Hold mouse over areas of the image for available actions.")});
...
"wgcnaViewRB").attr("value","gene").attr("checked","checked").style("margin-left","7px").style("margin-right","3px").on("click",function(){that.viewType="gene";that.createSingleWGCNAImage();ga&&ga("send","event","WGCNA","moduleView")});that.viewBar.append("text").text("Module");that.viewBar.append("span").attr("class","wgcnaControltooltip").attr("title",'View transcripts within the selected module and their connectivity based on correlation of expression.<BR><BR>Have a question about this view click the <img src="'+
contextRoot+'web/images/icons/help.png"> above for a detailed description of each view.').style("margin-left","5px").append("img").attr("src","/web/images/icons/info.gif");that.viewBar.append("br");that.viewBar.append("input").attr("type","radio").attr("id","wgcnaEQTLViewRB").attr("name","wgcnaViewRB").attr("value","eqtl").style("margin-left","7px").style("margin-right","3px").on("click",function(){that.viewType="eqtl";that.createSingleWGCNAImage();ga&&ga("send","event","WGCNA","eQTLView")});that.viewBar.append("text").text("Eigengene eQTL");
that.viewBar.append("span").attr("class","wgcnaControltooltip").attr("title",'View Circos plot of the module Eigengene eQTLs.<BR><BR>Have a question about this view click the <img src="'+contextRoot+'web/images/icons/help.png"> above for a detailed description of each view.').style("margin-left","5px").append("img").attr("src","/web/images/icons/info.gif");that.viewBar.append("br");that.viewBar.append("input").attr("type","radio").attr("id","wgcnaGOViewRB").attr("name","wgcnaViewRB").attr("value",
"go").style("margin-left","7px").style("margin-right","3px").attr("disabled",function(){return 10<that.wDSID?!0:!1}).on("click",function(){that.viewType="go";that.createSingleWGCNAImage();ga&&ga("send","event","WGCNA","goView")});that.viewBar.append("text").text("Gene Ontology");that.viewBar.append("span").attr("class","wgcnaControltooltip").attr("title",'TEMPORARILY DISABLED PLEASE CHECK BACK. View a summary of Gene Ontology terms assigned to transcripts in the selected module.<BR><BR>Have a question about this view click the <img src="'+
contextRoot+'web/images/icons/help.png"> above for a detailed description of each view.').style("margin-left","5px").append("img").attr("src","/web/images/icons/info.gif");that.viewBar.append("br");that.viewBar.append("input").attr("type","radio").attr("id","wgcnaMirViewRB").attr("name","wgcnaViewRB").attr("value","mir").style("margin-left","7px").style("margin-right","3px").on("click",function(){that.viewType="mir";that.createSingleWGCNAImage();ga&&ga("send","event","WGCNA","mirView")});that.viewBar.append("text").text("miRNA Targets");
that.viewBar.append("span").attr("class","wgcnaControltooltip").attr("title",'View a summary of miRNAs that target genes in this module.<BR><BR>Have a question about this view click the <img src="'+contextRoot+'web/images/icons/help.png"> above for a detailed description of each view.').style("margin-left","5px").append("img").attr("src","/web/images/icons/info.gif");that.viewBar.append("br");that.viewBar.append("input").attr("type","radio").attr("id","wgcnaMetaViewRB").attr("name","wgcnaViewRB").attr("value",
"meta").style("margin-left","7px").style("margin-right","3px").attr("disabled",function(){return 10<that.wDSID?!0:!1}).on("click",function(){that.viewType="meta";that.createSingleWGCNAImage();ga&&ga("send","event","WGCNA","metaView")});that.viewBar.append("text").text("Meta Module (nearest neighbors)");that.viewBar.append("span").attr("class","wgcnaControltooltip").attr("title",'View most closely correlated modules and browse those modules.<BR><BR>Have a question about this view click the <img src="'+
...
"px");return a};that.createMultiWGCNAImage=function(){that.multiImage=that.multiWGCNAImageGeneView();that.multiImage.draw();that.img=that.multiImage};that.multiWGCNAImage=function(){var a={maxWidth:200};a.totalWidth=$(window).width();a.modPerLine=Math.floor($(window).width()/a.maxWidth);a.calcWidth=Math.floor($(window).width()/a.modPerLine);a.data=[];if(0===d3.select("#multiWGCNASVG").size()){var b=d3.select("#wgcnaGeneImage").append("div").attr("id","multiWGCNAScroll").style("overflow","auto").style("max-height",
"430px");a.svg=b.append("svg").attr("id","multiWGCNASVG").attr("height","430px").attr("width","100%");b=a.svg.append("linearGradient").attr("id","lgrad").attr("x1","11%").attr("y1","0%").attr("x2","89%").attr("y2","100%");b.append("stop").attr("offset","0%").attr("style","stop-color:rgb(153,218,255);stop-opacity:1");b.append("stop").attr("offset","100%").attr("style","stop-color:rgb(0,128,128);stop-opacity:1");b=a.svg.append("linearGradient").attr("id","selectGrad").attr("x1","11%").attr("y1","0%").attr("x2",
"89%").attr("y2","100%");b.append("stop").attr("offset","0%").attr("style","stop-color:rgb(0,163,55);stop-opacity:1");b.append("stop").attr("offset","100%").attr("style","stop-color:rgb(0,75,20);stop-opacity:1")}else a.svg=d3.select("#multiWGCNASVG");a.modKey=function(a){return a.MOD_NAME};a.calcX=function(b,c){return c%a.modPerLine*a.calcWidth};a.calcY=function(b,c){return Math.floor(c/a.modPerLine)*a.maxWidth};a.sizing=function(b){b=a.size(b.TCList.length);b>a.maxWidth/2&&(b=a.maxWidth/2);return b};
a.zoomIn=function(){a.maxWidth<$(window).width()/2&&(a.maxWidth*=2,a.draw())};a.zoomOut=function(){var b=a.maxWidth;a.maxWidth=Math.floor(a.maxWidth/2);25>a.maxWidth?a.maxWidth=b:a.draw()};a.sortTCLenDesc=function(a,b){return b.TCList.length<a.TCList.length?-1:b.TCList.length>a.TCList.length?1:0};a.sortGeneInstanceDesc=function(b,c){return c.GeneCount<b.GeneCount?-1:c.GeneCount>b.GeneCount?1:a.sortTCLenDesc(b,c)};a.draw=function(){};a.redraw=function(){};return a};that.multiWGCNAImageGeneView=function(){var a=
that.multiWGCNAImage();a.createToolTip=function(a){var b="Module Name: "+a.MOD_NAME+"<BR>Transcript Size: "+a.TCList.length;"undefined"!==typeof a.GroupedGenes?(b=b+"<BR>Genes in Region/List: "+a.GroupedGenes,b=b+"<BR>Transcripts in Region/List: "+a.GeneCount):b=b+"<BR>Selected Gene Transcripts in Module: "+a.GeneCount;return b};a.draw=function(){"undefined"!==typeof that.selectedModule&&(a.maxWidth=85);a.svg.selectAll(".modules").remove();a.svg.selectAll(".moduleGradient").remove();a.totalWidth=
$(window).width();a.modPerLine=Math.floor($(window).width()/a.maxWidth);a.calcWidth=Math.floor($(window).width()/a.modPerLine);var b=[];a.dataList={};for(var c=0,e=0;e<that.moduleList.length;e++)if(console.log("multiModView:"+that.moduleList.length+":"+that.moduleList[e]),("grey"!==that.moduleList[e]||"grey"===that.moduleList[e]&&0===that.skipGrey)&&"undefined"!==typeof that.modules[that.moduleList[e]]){b[c]=that.modules[that.moduleList[e]];var f=b[c].ModRGB.split(","),h="";for(h=0;h<f.length;h++)f[h]-=
70,0>f[h]&&(f[h]=0);h=f[0]+","+f[1]+","+f[2];f=a.svg.append("linearGradient").attr("id","grad"+b[c].MOD_NAME).attr("class","moduleGradient").attr("x1","11%").attr("y1","0%").attr("x2","89%").attr("y2","100%");f.append("stop").attr("offset","0%").attr("style","stop-color:rgb("+b[c].ModRGB+");stop-opacity:1");f.append("stop").attr("offset","100%").attr("style","stop-color:rgb("+h+");stop-opacity:1");c++}c=a.maxWidth+15;b.length>a.modPerLine&&(e=Math.floor(b.length/a.modPerLine),0<b.length%a.modPerLine&&
e++,c*=e);a.svg.attr("height",c+"px");b.sort(a.sortGeneInstanceDesc);a.data=b;for(e=0;e<b.length;e++)a.dataList[b[e].MOD_NAME]=e;c=d3.min(b,function(a){return a.TCList.length});e=d3.max(b,function(a){return a.TCList.length});a.size=d3.scaleLinear().domain([c,e]).range([10,a.maxWidth/2]);b=a.svg.selectAll(".modules").data(b,a.modKey).attr("transform",function(b,c){return"translate("+a.calcX(b,c)+","+a.calcY(b,c)+")"});console.log("before append to image");b.enter().append("g").attr("class","modules").attr("id",
function(a){return a.MOD_NAME}).attr("transform",function(b,c){return"translate("+a.calcX(b,c)+","+a.calcY(b,c)+")"}).merge(b).each(function(b){var c=d3.select("g#"+b.MOD_NAME);c.append("circle").attr("cx",a.calcWidth/2).attr("cy",a.maxWidth/2).attr("r",a.sizing).attr("stroke",function(a){var b="#FFFFFF";"undefined"!==typeof that.selectedModule&&that.selectedModule===a&&(b="#000000");return b}).attr("stroke-width",function(a){var b="1px";"undefined"!==typeof that.selectedModule&&that.selectedModule===
a&&(b="3px");return b}).attr("fill",function(a){var b="url(#grad"+a.MOD_NAME+")";"undefined"!==typeof that.selectedModule&&that.selectedModule===a&&(b="url(#selectGrad)");return b}).on("click",function(){a.maxWidth=85;that.selectedModule=b;a.draw();d3.select("#multiWGCNAScroll").style("max-height","110px");a.svg.select("g#"+b.MOD_NAME).style("background","#CECECE");a.svg.select("g#"+b.MOD_NAME).select("circle").attr("fill","url(#selectGrad)").attr("stroke","#000000").attr("stroke-width","3px");a.svg.select("g#"+
b.MOD_NAME).select("text.txtLbl").style("font-weight","bold");that.selectedGene={};for(var c=0;c<b.TCList.length;c++)"undefined"===typeof that.selectedGene[b.TCList[c].Gene.ID]&&(that.selectedGene[b.TCList[c].Gene.ID]={},that.selectedGene[b.TCList[c].Gene.ID].geneSymbol=b.TCList[c].Gene.geneSymbol,that.selectedGene[b.TCList[c].Gene.ID].tcList=[]),that.selectedGene[b.TCList[c].Gene.ID].tcList.push(b.TCList[c]);setTimeout(that.createSingleWGCNAImage,20)}).on("mouseover",function(){$("#wgcnaMouseHelp").html("<B>Click</B> to select this module and see additional details.");
d3.select(this).style("fill","url(#selectGrad)");tt.transition().duration(200).style("opacity",1);tt.html(a.createToolTip(b)).style("left",function(){return that.positionTTLeft(d3.event.pageX)}).style("top",function(){return that.positionTTTop(d3.event.pageY)})}).on("mouseout",function(){var a=d3.select(this).data()[0];"undefined"!==typeof that.selectedModule&&a.MOD_NAME===that.selectedModule.MOD_NAME||d3.select(this).style("fill","url(#grad"+a.MOD_NAME+")");tt.transition().duration(500).style("opacity",
0)});"undefined"!==typeof that.selectedModule&&that.selectedModule===b?c.append("text").attr("class","txtLbl").attr("y",a.maxWidth+12).attr("x",function(b){return a.calcWidth/2-b.MOD_NAME.length/2*6.5}).style("font-weight","bold").text(replaceUnderscore(b.MOD_NAME)):6.5*b.MOD_NAME.length<a.calcWidth&&c.append("text").attr("class","txtLbl").attr("y",a.maxWidth+12).attr("x",function(b){return a.calcWidth/2-b.MOD_NAME.length/2*6.5}).text(replaceUnderscore(b.MOD_NAME));c.append("text").attr("y",a.maxWidth/
2+5).attr("x",a.calcWidth/2-3).attr("pointer-events","none").attr("fill",function(a){var b="#000000";a=a.ModRGB.split(",");360>a[0]+a[1]+a[2]&&(b="#FFFFFF");return b}).text(function(a){var b=a.GeneCount;"undefined"!==typeof a.GroupedGenes&&(b=a.GroupedGenes);return b})});console.log("end of draw")};a.backModule=function(){if(that.selectedModule){var b=a.dataList[that.selectedModule.MOD_NAME];if(0<b){b=a.data[b-1];var c=a.svg.select("g#"+that.selectedModule.MOD_NAME);c.select("circle").attr("fill",
"url(#grad"+that.selectedModule.MOD_NAME+")").attr("stroke","#FFFFFF").attr("stroke-width","1px");c.select("text.txtLbl").style("font-weight","normal");that.selectedModule=b;b=a.svg.select("g#"+b.MOD_NAME);b.select("circle").attr("fill","url(#selectGrad)").attr("stroke","#000000").attr("stroke-width","3px");b.select("text.txtLbl").style("font-weight","bold");setTimeout(that.createSingleWGCNAImage,20)}}};a.forwardModule=function(){if(that.selectedModule){var b=a.dataList[that.selectedModule.MOD_NAME];
if(b<a.data.length-1){b=a.data[b+1];var c=a.svg.select("g#"+that.selectedModule.MOD_NAME);c.select("circle").attr("fill","url(#grad"+that.selectedModule.MOD_NAME+")").attr("stroke","#FFFFFF").attr("stroke-width","1px");c.select("text.txtLbl").style("font-weight","normal");that.selectedModule=b;b=a.svg.select("g#"+b.MOD_NAME);b.select("circle").attr("fill","url(#selectGrad)").attr("stroke","#000000").attr("stroke-width","3px");b.select("text.txtLbl").style("font-weight","bold");setTimeout(that.createSingleWGCNAImage,
20)}}};return a};that.createSingleWGCNAImage=function(){d3.select("#viewGene").remove();d3.select("#circos").remove();$("#wgcnaresetImage").show();$("#wgcnazoomInImage").show();$("#wgcnazoomOutImage").show();"gene"===that.viewType?($("#linkSliderMin").slider("value",.01),$("span#minLabel").html(.01),$("#linkSliderMax").slider("value",1),$("span#maxLabel").html(1),$("#hideLinkExceptNode").prop("checked",!1),setTimeout(function(){that.singleImage=that.singleWGCNAImageGeneView(that.modules);that.singleImage.draw();
that.img=that.singleImage;that.singleWGCNATableGeneView();setTimeout(function(){that.singleImage.panZoom=svgPanZoom("#singleWGCNASVG",{panEnabled:!0,controlIconsEnabled:!1,zoomEnabled:!0,dblClickZoomEnabled:!0,zoomScaleSensitivity:.2,minZoom:.1,maxZoom:4,fit:!0,center:!0})},500)},50)):"go"===that.viewType?($("#wgcnaresetImage").hide(),$("#wgcnazoomInImage").hide(),$("#wgcnazoomOutImage").hide(),$("#goDomainSelect").val("mf"),$("#goSpinner").val(3),setTimeout(function(){that.singleImage=that.singleWGCNAImageGoView(that.modules);
that.singleImage.goDomain=$("#goDomainSelect").val();that.singleImage.draw();that.img=that.singleImage},50)):"eqtl"===that.viewType?($("#eqtlChr option").prop("selected",!0),$("#eqtlPval").val(2),setTimeout(function(){that.singleImage=that.singleWGCNAImageEQTLView(that.modules);that.singleImage.displayDefault();that.img=that.singleImage},50)):"mir"===that.viewType?($("#mirValidatedCBX").prop("checked",!1),$("#minMirGeneSlider").slider("value",1),$("span#minMirGeneLabel").html(1),$("#mirGeneFilterTxt").val(""),
$("#mirIDFilterTxt").val(""),$("#mirSortCBX").prop("checked",!1),$("#mirLinkCBX").prop("checked",!0),$("#mirgeneLinkCBX").prop("checked",!1),$("div#mirLinkColorSelect").hide(),setTimeout(function(){that.singleImage=that.singleWGCNAImageGeneView(that.modules);that.singleImage.draw();that.img=that.singleImage;setTimeout(function(){that.singleImage.panZoom=svgPanZoom("#singleWGCNASVG",{panEnabled:!0,controlIconsEnabled:!1,zoomEnabled:!0,dblClickZoomEnabled:!0,zoomScaleSensitivity:.2,minZoom:.1,maxZoom:4,
fit:!0,center:!0})},500)},50)):"meta"===that.viewType&&setTimeout(function(){that.singleImage=that.singleWGCNAImageMetaView(that.modules);that.singleImage.requestMeta();that.img=that.singleImage;setTimeout(function(){that.singleImage.panZoom=svgPanZoom("#singleWGCNASVG",{panEnabled:!0,controlIconsEnabled:!1,zoomEnabled:!0,dblClickZoomEnabled:!0,zoomScaleSensitivity:.2,minZoom:.1,maxZoom:4,fit:!0,center:!0})},500)},50);ga&&ga("send","event","changedWGCNAView",that.viewType)};that.singleWGCNAImage=
function(){var a={};a.width=$(window).width();a.height=Math.floor(.9*window.innerHeight);a.r=a.height>a.width?Math.floor(a.width/2*.95):Math.floor(a.height/2*.95);a.maxPerLevel=150;a.CorCutoff_min=.75;a.CorCutoff_max=1;a.showLinks=!0;a.data=[];a.maxNodeR=28;a.negColor="#DD0000";a.negDarkColor="#770000";a.posColor="#00DD00";a.posDarkColor="#007700";a.mirVal="#FFFF00";a.mirPred="#0000CC";0===d3.select("#singleWGCNASVG").size()?a.svg=d3.select("#wgcnaGeneImage").append("div").attr("id","viewGene").append("svg").attr("id",
"singleWGCNASVG").attr("height",a.height+"px").attr("width","100%"):a.svg=d3.select("#singleWGCNASVG");a.geneKey=function(a){return a.ID};a.linkKey=function(a){return that.removeInvalidIDChars(a.TC1)+that.removeInvalidIDChars(a.TC2)};a.calcX=function(b,c){return c%a.modPerLine*a.calcWidth};a.calcY=function(b,c){return Math.floor(c/a.modPerLine)*a.maxWidth};a.sizing=function(b){b=a.size(b.TCList.length);b>a.maxWidth/2&&(b=a.maxWidth/2);return b};a.colorCircle=function(a){a=a.Gene.ID;var b="#DFC184";
if(0==a.indexOf("PRN")||0==a.indexOf("PMM")||0==a.indexOf("Unannotated"))"Whole Brain"===that.tissue?b="#7EB5D6":"Heart"===that.tissue?b="#DC7252":"Liver"===that.tissue&&(b="#bbbedd");return b};a.colorLink=function(b){var c=a.negColor;0<b.Cor&&(c=a.posColor);return c};a.colorLinkHighlight=function(b){var c=a.negDarkColor;0<b.Cor&&(c=a.posDarkColor);return c};a.updateColor=function(b){b=$("#"+b).val();"Red_Green"===b?(a.posColor="#DD0000",a.posDarkColor="#770000",a.negColor="#00DD00",a.negDarkColor=
"#007700",a.mirVal="#FFFF00",a.mirPred="#0000CC"):"Blue_Yellow"===b?(a.posColor="#0000DD",a.posDarkColor="#000077",a.negColor="#ffef16",a.negDarkColor="#b7ae2a",a.mirVal="#FF9C2A",a.mirPred="#BA49FF"):(a.negColor="#DD0000",a.negDarkColor="#770000",a.posColor="#00DD00",a.posDarkColor="#007700",a.mirVal="#FFFF00",a.mirPred="#0000CC")};a.nodeRadiusSum=function(b,c){var d=3+20*b.LinkSum;d>a.maxNodeR&&(d=a.maxNodeR);return d};a.zoomIn=function(){a.maxWidth<$(window).width()/2&&(a.maxWidth*=2,a.draw())};
a.zoomOut=function(){var b=a.maxWidth;a.maxWidth=Math.floor(a.maxWidth/2);25>a.maxWidth?a.maxWidth=b:a.draw()};a.draw=function(){};a.redraw=function(){};a.setupLegend=function(){a.svg.select("#legend").remove();a.svg.select("#legendDisp").remove();a.legendG=a.svg.append("g").attr("id","legend").attr("transform","translate(10,60)").style("cursor","pointer").on("mouseover",function(){a.legendDispG.transition().duration(300).style("opacity",1);ga&&ga("send","event","wgcna","viewLegend")}).on("mouseleave",
