    ...
    <div style="border-color:#CCCCCC; border-width:1px; border-style:inset; text-align:center;">
        ...
        <div id="collapsableImage" class="geneimage" >
            ...
            <div id="geneImage" class="ucscImage"  style="display:inline-block;width:100%;">
                <!--<script src="javascript/gdb.2.9.0.min.js" type="text/javascript"></script>-->

            <script src="javascript/GenomeDataBrowser2.9.0.js" type="text/javascript"></script>
            <script src="javascript/GenomeReport2.7.0.js" type="text/javascript"></script>
