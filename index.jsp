...
<div id="index">
    ...
    <div id="welcome" style="height:1690px; width:996px;">
        ...
        <div id="survey" style="float:left;display:inline-block;width:600px;">
            ...
            <a style="font: 12px Helvetica, sans-serif; color: #999; text-decoration: none;"
               href=https://www.surveymonkey.com> Create your own user feedback survey </a>
        </div>
        <div style="float:right;display:inline-block;width:350px;" id="ack">
            ...
            <p>We would like to thank the National Institue on Alcohol Abuse and Alcoholism (<a
            ...
            <p>We would like acknowledge the UNLV National Supercomputing Institute (<a href="https://www.nscee.edu/">UNLV
                NSI</a>) for access to
                supercomputing resources to support analysis of sequencing data.</p>
            <h4 style="margin:10px;">Recombinant Inbred Panels</h4>
            <p>We are grateful to the following investigators for providing the recombinant inbred panels found on the
                site.<BR/>
                HXB/BXH Rat RI Panel was provided by <a href="http://pharmacology.ucsd.edu/faculty/printz.html">Morton
                    Printz</a>(UC San Diego).<BR/>
                ILSXISS Mouse RI Panel was provided by <a href="http://ibgwww.colorado.edu/tj-lab/">Thomas Johnson</a>(CU
                Boulder) and John DeFries (CU Boulder).</p>
        </div>
    </div>
