...
sub callCircosMod{
	my($module,$cutoff,$organism,$chromosomeString,$tissueString,$modulePath,$timeStampString,$modColor,$genomeVer,$rnaDSID,$level,$dsn,$usr,$passwd,$type)=@_;
	...
	prepCircosMod($module,$cutoff,$organism,$confDirectory,$dataDirectory,$chromosomeListRef,$tissueString,$genomeVer,$hostname,$dsn,$usr,$passwd,$type,$rnaDSID,$level);
